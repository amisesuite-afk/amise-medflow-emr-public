...
export const postOpWoundsProtocols: ManagementProtocol[] = [
  {
    ...
    guidelines: ['NICE NG125 (2019, updated 2020) surgical site infections', 'WSES 2017 management of intra-abdominal infections'],
    keyPoints: [
    ...
    management: [
      ...
      { phase: 'surgical', step: 'Organ/space SSI (intra-abdominal collection): source control — CT- or ultrasound-guided percutaneous drainage of a drainable collection, send pus for culture; relaparotomy for diffuse peritonitis, anastomotic leak with sepsis or failed drainage (WSES 2017).' },
  ...
  },
  {
    ...
    kind: 'bleeding',
    guidelines: ['DAS/BAETS/ENT UK multidisciplinary guideline on post-thyroidectomy haematoma (Iliff et al., Anaesthesia 2022) — SCOOP', 'BSH 2018 guideline on reversal of anticoagulation'],
    keyPoints: [
    ...
    investigations: [
      ...
      { label: 'USS wound — only if stable and after any neck haematoma has been decompressed / airway secured (confirm haematoma, guide aspiration of liquefied collections)', urgency: 'routine' },
    ],
    management: [
      { phase: 'immediate', step: 'Neck haematoma after thyroid, parathyroid or carotid surgery with any airway compromise: airway first — call for senior surgical and anaesthetic help, sit the patient up, oxygen, then SCOOP at the bedside (Skin exposure, Cut sutures, Open skin, Open muscles, Pack) before any imaging; then secure the airway and return to theatre (DAS/BAETS/ENT UK 2022).' },
      ...
      { phase: 'conservative', step: 'Reverse anticoagulation if safe (protamine for heparin; IV vitamin K + prothrombin complex concentrate for warfarin — FFP only if PCC is unavailable; idarucizumab for dabigatran) (BSH 2018).' },
    ...
    medications: [
      ...
      { drugName: 'Fresh Frozen Plasma (FFP)', dose: '15 mL/kg', frequency: 'Single infusion — repeat if INR not corrected', route: 'IV (intravenous) infusion', indication: 'Warfarin reversal only if prothrombin complex concentrate is unavailable (BSH 2018)', phase: 'immediate' },
  ...
  },
  {
    ...
    management: [
      { phase: 'immediate', step: 'Without strangulation (exclude strangulation first — CT, lactate, examination): NGT decompression, IV fluids, catheter (hourly UO), NBM; correct electrolytes.' },
      { phase: 'conservative', step: 'Water-soluble contrast (Gastrografin 100 mL oral / NGT) once, if not already given: contrast in the colon within 24 h predicts resolution; no contrast in the colon by 24 h, or no improvement by 48–72 h, means non-operative management has failed — surgery (WSES/Bologna 2017).' },

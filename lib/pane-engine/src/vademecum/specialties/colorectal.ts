...
registerModule({
  ...
  diseases: [
    ...
    },
    {
      ...
      features: { rlq_pain: 0.45, lif_pain: 0.15, change_bowel_habit: 0.75, diarrhoea: 0.75, weight_loss: 0.60, fever: 0.40, pr_bleeding: 0.30, anorexia: 0.50, perianal_swelling: 0.25, discharge_perianal: 0.25, anaemia: 0.40, abdominal_mass: 0.15 },
    },
    {
      id: 'ulcerative_colitis', label: 'Ulcerative Colitis', icd10: 'K51.90', prior: T.uncommon, course: 'chronic',
      features: { pr_bleeding: 0.90, bloody_diarrhoea: 0.80, diarrhoea: 0.85, mucus_pr: 0.65, tenesmus: 0.55, lif_pain: 0.40, change_bowel_habit: 0.80, fever: 0.35, weight_loss: 0.35, tachycardia: 0.30, anaemia: 0.35 },
    },
    {
    ...
    {
      id: 'rectal_prolapse', label: 'Rectal Prolapse', icd10: 'K62.3', prior: T.rare, course: 'chronic',
      features: { prolapse_pr: 0.95, pr_bleeding: 0.40, mucus_pr: 0.50, tenesmus: 0.35, faecal_incontinence: 0.45, worse_straining: 0.50 },
    },
    {

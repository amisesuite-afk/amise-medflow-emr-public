...
function buildMessage(template: Template, patientName: string, data: Record<string, unknown>): string {
  ...
  switch (template) {
    ...
    case 'result_ready':
      return `Hi ${first}, your results are ready. Please call Amise Medical Services on 758-284-0557 to discuss them with Dr Kabiye.`;
    case 'postop_checkin':
      return `Hi ${first}, we hope your recovery is going well. If you have any concerns after your procedure, please call us on 758-284-0557. For a medical emergency, call 911 or go to the nearest A&E. -- Amise Medical`;
    case 'general': {

    ...
    variants: [
      {
        ...
        detectKeywords: ['uncomplicated', 'simple appendicitis', 'without perforation', 'without abscess', 'without peritonitis'],
    ...
    variants: [
      {
        ...
        detectKeywords: ['mild cholecystitis', 'grade i', 'grade 1', 'uncomplicated cholecystitis', 'tokyo grade i', 'tokyo grade 1'],
        allowedPhases: ['immediate', 'surgical', 'followup'],
    ...
    variants: [
      {
        ...
        detectKeywords: ['mild cholangitis', 'grade i cholangitis', 'grade 1 cholangitis', 'ascending cholangitis grade i'],
        allowedPhases: ['immediate', 'conservative', 'followup'],
      ...
      },
      {
        ...
        detectKeywords: ['severe cholangitis', 'grade iii cholangitis', 'grade 3 cholangitis', 'reynold pentad', 'septic shock cholangitis'],
        allowedPhases: ['immediate', 'surgical'],
    ...
    variants: [
      {
        ...
        detectKeywords: ['uncomplicated diverticulitis', 'mild diverticulitis', 'diverticulitis without abscess', 'hinchey 0', 'hinchey ia'],
    ...
    variants: [
      {
        ...
        detectKeywords: ['peptic ulcer bleed', 'upper gi bleed', 'haematemesis', 'melena', 'non-variceal', 'nonvariceal', 'mallory-weiss', 'ulcer bleed'],
        allowedPhases: ['immediate', 'surgical', 'followup'],
    ...
    variants: [
      {
        ...
        detectKeywords: ['hemithyroidectomy', 'hemi-thyroidectomy', 'lobectomy thyroid', 'thyroid lobectomy', 'solitary nodule', 'bethesda iii', 'bethesda iv'],
        allowedPhases: ['immediate', 'surgical', 'followup'],

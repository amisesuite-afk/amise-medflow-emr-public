// SurgicalDrug+Formulary.swift
// Surgical formulary data split into sub-arrays to avoid Swift type-checker
// timeout on large array literals. Combined by allDrugs in SurgicalDrug.swift.

import Foundation

extension SurgicalDrug {

    static let _drugs1: [SurgicalDrug] = [
    ...
    static let _drugs2: [SurgicalDrug] = [
    ...
    static let _drugs3: [SurgicalDrug] = [
    ...
    static let _drugs4: [SurgicalDrug] = [
    ...
    static let _drugs5: [SurgicalDrug] = [

...
final class ClinicalPipelineOrchestrator: ObservableObject {
    ...
    private func run(patient: Patient, socratesSelections: [String: Set<String>]) async {
        ...
        sequentialEngine.seed(
            ...
            fourTScore:                  patient.fourTScore,
            oaklandScore:                patient.oaklandScore,
            kingsCriteriaScore:          patient.kingsCriteriaScore,
            childPughScore:              patient.childPughScore,
            meldScore:                   patient.meldScore,
            asaScore:                    patient.asaScore,
            ecogScore:                   patient.ecogScore,
            rtsScore:                    patient.rtsScore,
            kdigoStage:                  patient.kdigoStage,
            bauxScore:                   patient.bauxScore,
            issScore:                    patient.issScore,
            nutricScore:                 patient.nutricScore,
            spesiScore:                  patient.spesiScore,
            decafScore:                  patient.decafScore,
            hincheyGrade:                patient.hincheyGrade,
            airScore:                    patient.airScore,
            percViolations:              patient.percViolations,
            shockIndex:                  patient.shockIndex,
            parklandVolume:              patient.parklandVolume,
            pasScore:                    patient.pasScore,
            revisedGenevaScore:          patient.revisedGenevaScore,
            cciScore:                    patient.cciScore,
            mfi5Score:                   patient.mfi5Score,
            hapsScore:                   patient.hapsScore,
            glasgowImrieScore:           patient.glasgowImrieScore,
            albiScore:                   patient.albiScore,
            auditCScore:                 patient.auditCScore,
            phq9Score:                   patient.phq9Score,
            sapsIIScore:                 patient.sapsIIScore,
            stoneScore:                  patient.stoneScore,
            losAngelesGrade:             patient.losAngelesGrade,
            meld3Score:                  patient.meld3Score,
            bradenScore:                 patient.bradenScore,
            centorScore:                 patient.centorScore,
            ipssScore:                   patient.ipssScore,
            trueloveWittsScore:          patient.trueloveWittsScore,
            harveyBradshawScore:         patient.harveyBradshawScore,
            maddreyScore:                patient.maddreyScore,
            manningScore:                patient.manningScore,
            laceScore:                   patient.laceScore,
            findRiscScore:               patient.findRiscScore,
            mirelsScore:                 patient.mirelsScore,
            ckdEpiEgfr:                  patient.ckdEpiEgfr,
            ariscatScore:                patient.ariscatScore,
            fongCrsScore:                patient.fongCrsScore,
            berlinPFRatio:               patient.berlinPFRatio,
            cageScore:                   patient.cageScore,
            dukeIEScore:                 patient.dukeIEScore,
            mmrcGrade:                   patient.mmrcGrade,
            ptsScore:                    patient.ptsScore,
            ripasaScore:                 patient.ripasaScore,
            fgsiScore:                   patient.fgsiScore,
            sirsScore:                   patient.sirsScore,
            mewsScore:                   patient.mewsScore,
            independentNews2:            patient.independentNews2,
            gcsScore:                    patient.gcsScore,
            rcriScore:                   patient.rcriScore,
            stopBangScore:               patient.stopBangScore,
            cha2ds2vascScore:            patient.cha2ds2vascScore,
            hasBledScore:                patient.hasBledScore,
            stoneUretericScore:          patient.stoneUretericScore,
            ottawaAnkleScore:            patient.ottawaAnkleScore,
            ottawaKneeScore:             patient.ottawaKneeScore,
            canadianCTHeadScore:         patient.canadianCTHeadScore,
            nexusScore:                  patient.nexusScore,
            canadianCSpineScore:         patient.canadianCSpineScore,
            sfSyncopeScore:              patient.sfSyncopeScore,
            canadianSyncopeScore:        patient.canadianSyncopeScore,

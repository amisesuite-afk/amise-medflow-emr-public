// SurgeryNoteView+Sections.swift
// Pre-op labs, AI generate, form sections for operative note.
...
extension SurgeryNoteView {
    ...
    @ViewBuilder
    var preOpLabsSection: some View {
    ...
    func surgLabRow(_ name: String, value: String, flag: String?, critical: Bool) -> some View {
        HStack {
    ...
    var whoChecklistSection: some View {
    ...
    var bloodFluidSection: some View {

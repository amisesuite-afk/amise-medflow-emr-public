// ColonoscopyFormView+Sections.swift
// ColonoscopyFormView section views and helpers.

import SwiftUI
import SwiftData


extension ColonoscopyFormView {
    ...
    func colonLabRow(_ name: String, value: String, flag: String?, critical: Bool) -> some View {
        HStack {
    ...
    var bowelPrepSection: some View {
    ...
    @ViewBuilder
    func bbpsStepper(_ label: String, value: Binding<Int>) -> some View {
        HStack {

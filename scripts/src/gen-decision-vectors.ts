...
export const VECTOR_DEFS: VectorDef[] = [
  ...
  { id: 'pancreatitis-named-severe', description: 'Confirmed "severe acute biliary pancreatitis" without a severity score: same-admission cholecystectomy deferred (revised Atlanta).',
    input: { patient: { ...FIT, asa: 2, egfr: 85, news2: 5, sbp: 104 },
      diagnoses: [dx('Severe acute biliary pancreatitis', null, 'K85.1', null, true)], scores: [], labs: {} } },
  { id: 'confirmed-suppresses-differential', description: 'A confirmed diagnosis wins: the engine\'s sepsis differential (30%) gives no decision.',
    input: { patient: { ...FIT, asa: 1, egfr: 95, bmi: 26, news2: 3, sbp: 120 },
      diagnoses: [CHOLE, dx('Sepsis', 'sepsis', 'A41.9', 0.3, false)], scores: [], labs: {} } },

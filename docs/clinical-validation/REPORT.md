...
Generated 2026-09-25T14:22:22.296Z.
...
- Web: 170 vignette results from `docs/clinical-validation/results/web-latest.json` (generated 2026-09-25T14:22:20.408Z, clinval-web/1).
...
- `ami-embolic-af` / **mgmt-revascularisation** (web, FAIL (known gap)): no management item matched among 47 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: Ischaemic colitis protocol has no revascularisation or vascular-surgery step.]
- `ami-infarction-septic-shock` / **mnm-mesenteric** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Inguinal / Femoral Hernia \| 2. Acute Cholecystitis \| 3. Acute Cholangitis [known gap: Web: PANE has no acute mesenteric ischaemia disease node, so it can never appear in the PANE top 3 (inguinal/femoral hernia, cholecystitis, cholangitis).]
- `ami-infarction-septic-shock` / **mgmt-revascularisation** (web, FAIL (known gap)): no management item matched among 62 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No revascularisation step; only laparotomy/resection templates.]
- `ami-venous-thrombosis-ocp` / **mnm-mesenteric** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Acute Appendicitis \| 3. Bowel Obstruction; also in web.symptomInference#4, web.passive#3 [known gap: Web: PANE has no mesenteric ischaemia / venous thrombosis disease node, so it can never appear in the PANE top 3 (cholecystitis, appendicitis, bowel obstruction).]
- `ami-venous-thrombosis-ocp` / **level-at-least-urgent** (web, FAIL (known gap)): web.triage: priority (acuity=review, action=priority_24_48h, score=20); expected ≥ urgent [known gap: Web: adaptiveTriage: 'priority_24_48h' (score 20); the only reasons are 'Pregnancy mentioned' (from 'pregnancy test negative') and pain score. iOS: ClinicalPathwayEngine reads only CC/PMH keywords; CC 'Abdominal pain for five days' gives 'routine'.]
- `anal-cancer-red-flags` / **mnm-anal-cancer** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Haemorrhoids \| 2. Anal Fissure \| 3. Colorectal Cancer; also in web.symptomInference#2, web.passive#1 [known gap: Anal cancer is not a PANE disease (top 3: haemorrhoids, fissure, colorectal cancer); symptom inference ranks anal SCC #2 but PANE is the primary differential.]
- `anal-cancer-red-flags` / **inv-biopsy** (web, FAIL (known gap)): no investigation matched among 20 (web.pane.seeded, web.clinicalPrompts) [known gap: No output asks for EUA/biopsy of the anal lesion: C21.0 has no protocol; the plan shown is the haemorrhoids protocol (PANE top) and colonoscopy + biopsy from colorectal_cancer seeding.]
- `anal-fissure-atypical-lateral-hiv` / **mnm-anal-cancer** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Anal Fissure \| 2. Haemorrhoids \| 3. Inguinal / Femoral Hernia; also in web.symptomInference#5, web.passive#5 [known gap: Anal cancer is not a PANE disease (no disease, no ulcer feature used); symptom inference ranks anal SCC only #5.]
- `anal-fissure-atypical-lateral-hiv` / **inv-eua-biopsy** (web, FAIL (known gap)): no investigation matched among 11 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: The anal_fissure protocol has no EUA/biopsy investigation (only "biopsy if non-healing after 8 weeks" in red flags), and the atypical/lateral red flag does not change the plan.]
...
- `crc-fit-positive-abdominal-pain` / **mgmt-suspected-cancer-pathway** (web, FAIL (known gap)): no management item matched among 10 (web.clinicalPrompts) [known gap: No engine reads a FIT result: the lab is recorded but neither the triage cancer screen, clinical prompts nor PANE/CDS use it, and no rule implements the NICE DG56 threshold (≥ 10 µg Hb/g).]
- `crc-ida-no-gi-symptoms` / **mnm-crc** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. GORD / Reflux Oesophagitis \| 3. Acute Diverticulitis [known gap: PANE has no anaemia/IDA feature and reads no labs; with fatigue/breathlessness only, the top 3 is the default cholecystitis/GORD/diverticulitis. Symptom inference ranks heart failure, anaemia, COPD.]
- `crc-ida-no-gi-symptoms` / **flag-ida** (web, FAIL (known gap)): no red flag matched among 13 (web.triage.reasons, web.clinicalPrompts.safety, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: No output mentions iron deficiency: the triage cancer screen’s IDA criterion looks for "anaemia/pale/unusually tired" in symptom chips (no such chip exists) and never reads Hb/ferritin; the prompts fire on Hb only below 8 g/dL.]
- `crc-ida-no-gi-symptoms` / **inv-colonoscopy** (web, FAIL (known gap)): no investigation matched among 22 (web.pane.seeded, web.clinicalPrompts) [known gap: No colonoscopy requested for IDA (D50.9 has no protocol; no lab-driven IDA rule).]
- `crc-lynch-surveillance-overdue` / **flag-lynch** (web, FAIL (unverified)): no red flag matched among 6 (web.triage.reasons, web.clinicalPrompts.safety, web.triage.emergency)
- `crc-lynch-surveillance-overdue` / **inv-colonoscopy** (web, FAIL (unverified)): no investigation matched among 13 (web.pane.seeded, web.clinicalPrompts)
- `crc-rectal-mass-fit-negative` / **dx-rectal-cancer-top3** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Inguinal / Femoral Hernia \| 2. GORD / Reflux Oesophagitis \| 3. Acute Cholecystitis [known gap: PANE top 3 is inguinal hernia/GORD/cholecystitis: the "Change in bowel habit" template has no CC_HINTS entry, the "Rectum" site chip does not match the \brectal\b rule, and a DRE mass is not a PANE feature. Symptom inference ranks rectal prolapse, IBD, haemorrhoids.]
...
- `fistula-in-ano-simple-low` / **mgmt-fistulotomy** (web, FAIL (known gap)): no management item matched among 22 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: getProtocolByIcd("K60.3") returns the anal_fissure protocol (prefix K60 covers fissure K60.0–K60.2 and fistula K60.3–K60.5); there is no fistula-in-ano protocol, and the perianal_abscess protocol (which has fistula steps) is keyed to K61.]
...
- `fournier-gangrene` / **dx-nsti-top3** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Acute Cholangitis \| 2. Perianal Abscess / Fistula \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#1 [known gap: PANE’s necrotising_fasciitis disease is not reached from perineal presentations (the only anorectal features are anal_pain/perianal_swelling; the CC template is generic; crepitus/erythema answers do not outweigh the anorectal priors); symptom inference does rank Fournier’s first, but it is a secondary view.]
- `fournier-gangrene` / **mgmt-debridement** (web, FAIL (known gap)): no management item matched among 27 (web.clinicalPrompts) [known gap: N49.3 (Fournier gangrene) has no protocol (necrotising_fasciitis is keyed to M72.6), so no plan contains debridement; the sepsis prompt gives antibiotics only.]
- `fournier-sglt2-early-mimic` / **mnm-nsti** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Perianal Abscess / Fistula \| 2. Acute Cholecystitis \| 3. Pilonidal Disease; also in web.symptomInference#1, web.passive#1 [known gap: PANE’s necrotising_fasciitis disease is not reached from perineal presentations (the only anorectal features are anal_pain/perianal_swelling; the CC template is generic; crepitus/erythema answers do not outweigh the anorectal priors); symptom inference does rank Fournier’s first, but it is a secondary view. The confirmed "perianal abscess" label (K61.0) sends the plan to the perianal_abscess protocol, whose only NSTI mention is a red flag.]
- `fournier-sglt2-early-mimic` / **mgmt-exploration** (web, FAIL (known gap)): no management item matched among 45 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No output recommends surgical exploration/debridement: the plan is incision and drainage of a perianal abscess.]
...
- `infective-colitis-bloody-diarrhoea` / **inv-stool-culture** (web, FAIL (known gap)): no investigation matched among 34 (web.pane.seeded, web.clinicalPrompts) [known gap: No stool culture/STEC testing output (A09 has no protocol; PANE-seeded tests are for appendicitis/biliary disease).]
- `infective-colitis-bloody-diarrhoea` / **mgmt-no-appendicectomy** (web, FAIL (known gap)): forbidden management item present in web.clinicalPrompts: "laparoscopic appendicectomy - operative plan ───────────────────────────────────────────── pre-operative: •..." [known gap: Web computeClinicalPrompts fires "Appendicitis — emergency surgical indication" and adds the full "LAPAROSCOPIC APPENDICECTOMY — OPERATIVE PLAN" whenever examAbdomen contains "guarding" or "rebound" — including negated text ("no guarding") and localised guarding from other causes.]
...
- `mimic-aaa-symptomatic-renal-colic-label` / **mnm-aaa** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Renal Colic / Urolithiasis \| 2. Inguinal / Femoral Hernia \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE top 3: renal colic, inguinal/femoral hernia, cholecystitis (pulsatile_mass answered yes). Symptom inference ranks AAA #1.]
- `mimic-aaa-symptomatic-renal-colic-label` / **inv-cta** (web, FAIL (known gap)): no investigation matched among 24 (web.pane.seeded, web.clinicalPrompts) [known gap: Web: ICD I71.4 has no protocol (only 'I71.9' is mapped), so no CT angiography is suggested.]
- `mimic-aaa-symptomatic-renal-colic-label` / **mgmt-vascular-referral** (web, FAIL (known gap)): no management item matched among 10 (web.clinicalPrompts) [known gap: Web: No vascular referral: no protocol for I71.4.]
- `mimic-dka-abdominal-pain` / **mnm-dka** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Peptic Ulcer Disease \| 3. Acute Pancreatitis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE has no DKA disease node, so it can never appear in the PANE top 3 (appendicitis, peptic ulcer, pancreatitis). Symptom inference ranks DKA #1.]
- `mimic-dka-abdominal-pain` / **mgmt-no-laparotomy-for-dka-pain** (web, FAIL (known gap)): forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." [known gap: Web: 'no rigidity, no rebound' triggers the peritonism prompt ('Emergency laparotomy consent — source control') and 'guarding' triggers the appendicectomy template in DKA.]
- `mimic-ectopic-pregnancy` / **dx-ectopic-top3** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Acute Appendicitis \| 3. Choledocholithiasis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE top 3: cholecystitis, appendicitis, choledocholithiasis. The template's 'lmp' answer ('7 weeks ago — missed period') is not mapped to missed_period, and amenorrhoea/spotting are not SOCRATES-extracted. Symptom inference ranks ectopic #1.]
- `mimic-ectopic-pregnancy` / **mgmt-no-assumed-negative-hcg** (web, FAIL (known gap)): forbidden management item present in web.clinicalPrompts: "...ak (< 1%), hartmann's pouch if appendix not identifiable. • β-hcg confirmed negative (female of reproductive age). • group & screen available; cross-match if perfor..." [known gap: Web: Guarding triggers the appendicectomy operative-plan prompt, which states 'β-HCG confirmed negative' before any test has been done.]
- `mimic-ectopic-ruptured-shock` / **dx-ectopic-top3** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Acute Appendicitis \| 3. Choledocholithiasis; also in web.symptomInference#2 [known gap: Web: PANE top 3: cholecystitis, appendicitis, choledocholithiasis despite a positive pregnancy test and haemoperitoneum.]
...
- `mimic-inferior-mi-ecg-confirmed` / **mnm-acs** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Peptic Ulcer Disease \| 3. GORD / Reflux Oesophagitis [known gap: Web: PANE has no cardiac (ACS/MI) disease node, so it can never appear in the PANE top 3 (cholecystitis, peptic ulcer, GORD).]
- `mimic-inferior-mi-ecg-confirmed` / **level-emergency** (web, FAIL (known gap)): web.triage: urgent (acuity=priority, action=same_day_call, score=30); expected ≥ emergency [known gap: Web: adaptiveTriage: 'same_day_call' (score 30); the resulted ECG (ST elevation) and troponin 412 are not triage inputs, and HR 48/SBP 92 are inside the vital thresholds. iOS: ClinicalPathwayEngine reads only CC/PMH keywords; CC 'Upper abdominal discomfort and nausea' gives 'routine'.]
- `mimic-inferior-mi-ecg-confirmed` / **alarm-stemi** (web, FAIL (known gap)): no alarm matched among 4 (web.clinicalPrompts.safety) [known gap: Web: No prompt reads ECG results or troponin; the only safety prompt is bradycardia.]
- `mimic-inferior-mi-ecg-confirmed` / **mgmt-reperfusion** (web, FAIL (known gap)): no management item matched among 16 (web.clinicalPrompts) [known gap: Web: No reperfusion/PCI action; ICD I21.19 has no protocol.]
- `mimic-inferior-mi` / **mnm-acs** (web, FAIL (known gap)): not in top 3 of web.pane: 1. GORD / Reflux Oesophagitis \| 2. Acute Cholecystitis \| 3. Peptic Ulcer Disease [known gap: Web: PANE has no cardiac (ACS/MI) disease node, so it can never appear in the PANE top 3 (GORD, cholecystitis, peptic ulcer).]
- `mimic-inferior-mi` / **inv-ecg** (web, FAIL (known gap)): no investigation matched among 25 (web.pane.seeded, web.clinicalPrompts) [known gap: Web: No ECG suggested; the bradycardia prompt needs HR <50 (HR 52 here).]
- `mimic-inferior-mi` / **inv-troponin** (web, FAIL (known gap)): no investigation matched among 25 (web.pane.seeded, web.clinicalPrompts) [known gap: Web: No troponin suggested.]
- `mimic-ruptured-aaa` / **dx-aaa-top3** (web, FAIL (known gap)): not in top 3 of web.pane: 1. Inguinal / Femoral Hernia \| 2. Renal Colic / Urolithiasis \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE top 3: inguinal/femoral hernia, renal colic, cholecystitis — even with the PANE answer pulsatile_mass = yes. Symptom inference ranks ruptured AAA #1.]
...
- `uc-steroid-refractory-cmv` / **inv-cmv** (web, FAIL (known gap)): no investigation matched among 36 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: The CMV-positive biopsy result is not read and no output mentions CMV.]
...
- `uc-toxic-megacolon` / **inv-no-colonoscopy** (web, FAIL (known gap)): forbidden investigation present in web.plan.investigations: "flexible sigmoidoscopy / colonoscopy + biopsies" [known gap: The ulcerative_colitis protocol lists "Flexible sigmoidoscopy / colonoscopy + biopsies" as an urgent investigation with no severity condition, so the documented plan orders a colonoscopy in toxic megacolon.]
...
|---|---|---|---|---|---|---|
| mnm-malignancy | mustNotMiss | critical | not run | FAIL (known gap) | European guidelines on achalasia 2020; NICE NG12 2015 | socrates-to-features.ts: CC hint /dysphag\|swallow/ → dysphagia_progressive. |
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2015 |  |
| flag-dysphagia-cancer | redFlags | critical | not run | PASS | NICE NG12 2015 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | European guidelines on achalasia 2020; NICE NG12 2015 |  |
| inv-ct | investigationInclude | quality | not run | PASS | European guidelines on achalasia 2020 |  |
| mgmt-no-myotomy-before-malignancy-excluded | managementExclude | quality | not run | PASS | European guidelines on achalasia 2020 |  |
...
|---|---|---|---|---|---|---|
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2015 |  |
| flag-dysphagia | redFlags | critical | not run | PASS | NICE NG12 2015 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | European guidelines on achalasia 2020; NICE NG12 2015 |  |
| dx-achalasia-top3 | mustRankTopK | quality | not run | FAIL (known gap) | European guidelines on achalasia 2020 | socrates-to-features.ts: CC hint /dysphag\|swallow/ → dysphagia_progressive. |
| inv-manometry | investigationInclude | quality | not run | PASS | European guidelines on achalasia 2020 |  |
| inv-barium-swallow | investigationInclude | quality | not run | PASS | European guidelines on achalasia 2020 |  |
| mgmt-definitive-options | managementInclude | quality | not run | PASS | European guidelines on achalasia 2020 |  |
...
#### `ami-embolic-af` — Embolic, AF off anticoagulation, normal lactate (base case)

76-year-old woman with AF (warfarin stopped), sudden severe central pain 4 h, vomiting and loose stool, soft abdomen — pain out of proportion; WBC 18.2, lactate 1.6 (normal).

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-mesenteric-ischaemia | mustNotMiss | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 | Add an acute mesenteric ischaemia disease node to PANE (features: sudden onset, pain out of proportion, AF/embolic source, vomiting/diarrhoea, age) and a CC_HINTS entry. |
| level-emergency | emergencyLevel | critical | not run | PASS | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 |  |
| alarm-mesenteric | mustAlarm | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 | Add a prompt: abdominal pain + AF (or other embolic source) + soft abdomen/severe pain → 'Exclude acute mesenteric ischaemia — CT angiography now; normal lactate does not exclude'. |
| inv-cta | investigationInclude | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 | Map K55.0 to a dedicated acute mesenteric ischaemia protocol (CTA, heparin, vascular surgery, revascularisation) instead of ischaemic colitis. |
| mgmt-heparin | managementInclude | critical | not run | PASS | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 |  |
| mgmt-revascularisation | managementInclude | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 | As above: AMI protocol with revascularisation and damage-control steps. |
| mnm-mesenteric-ischaemia-symptom-engine | mustNotMiss | quality | not run | PASS |  |  |
| inv-lactate | investigationInclude | quality | not run | PASS | WSES updated guidelines 2022 |  |
| mgmt-antibiotics | managementInclude | quality | not run | PASS | WSES updated guidelines 2022 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |

Failure details:

- **mnm-mesenteric-ischaemia** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Acute Appendicitis \| 3. GORD / Reflux Oesophagitis; also in web.symptomInference#2, web.passive#2 [known gap: Web: PANE has no acute mesenteric ischaemia disease node, so it can never appear in the PANE top 3 (cholecystitis, appendicitis, GORD). Symptom inference ranks it #2.]
- **alarm-mesenteric** (web): no alarm matched among 7 (web.triage.emergency, web.clinicalPrompts.safety) [known gap: Web: No prompt or triage rule for 'pain out of proportion', AF + abdominal pain, or mesenteric ischaemia.]
- **inv-cta** (web): no investigation matched among 36 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: Web: K55.0 maps to the ischaemic colitis protocol: 'CT abdomen/pelvis with IV contrast' (portal venous), not CT angiography.]
- **mgmt-revascularisation** (web): no management item matched among 47 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: Ischaemic colitis protocol has no revascularisation or vascular-surgery step.]

Guidelines:

- **esvs-2017** — ESVS clinical practice guidelines — diseases of the mesenteric arteries and veins (2017), Acute mesenteric ischaemia: suspicion (pain out of proportion, AF), lactate not sensitive/specific enough to exclude, immediate CT angiography, heparin, revascularisation, resection of non-viable bowel; mesenteric venous thrombosis: anticoagulation. Björck M, Koelemay M, Acosta S, et al. Management of the diseases of mesenteric arteries and veins: clinical practice guidelines of the European Society of Vascular Surgery (ESVS). Eur J Vasc Endovasc Surg. 2017;53:460–510. *(statement wording/numbering not yet verified against the source)*
- **wses-ami-2022** — WSES updated guidelines — acute mesenteric ischaemia (2022), High index of suspicion; normal lactate does not exclude AMI; CT angiography without delay; systemic anticoagulation; revascularisation; damage control / second look; antibiotics. Bala M, Catena F, Kashuk J, et al. Acute mesenteric ischemia: updated guidelines of the World Society of Emergency Surgery. World J Emerg Surg. 2022;17:54. *(statement wording/numbering not yet verified against the source)*

#### `ami-infarction-septic-shock` — Late: transmural infarction with septic shock

71-year-old man with un-anticoagulated AF and PAD, 30 h after sudden pain: peritonitis, PR blood, T 38.4 °C, HR 134, BP 84/52, lactate 6.8; CTA: SMA occlusion with pneumatosis and portal venous gas.

Permutation of `ami-embolic-af`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-mesenteric | mustNotMiss | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 |  |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES updated guidelines 2022; Surviving Sepsis Campaign 2021 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| alarm-shock | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-emergency-laparotomy | managementInclude | critical | not run | PASS | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 |  |
| mgmt-revascularisation | managementInclude | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017; WSES updated guidelines 2022 | As above: AMI protocol with revascularisation before/with resection. |
| mgmt-heparin | managementInclude | quality | not run | PASS | ESVS clinical practice guidelines 2017 |  |
| mgmt-second-look | managementInclude | quality | not run | PASS | WSES updated guidelines 2022 |  |
| mgmt-icu | managementInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
...
#### `ami-venous-thrombosis-ocp` — Mesenteric venous thrombosis, young woman on the combined pill

36-year-old smoker on the combined oral contraceptive, 5 days of progressive central pain, nausea, loose stools; CT: SMV thrombosis with jejunal wall thickening, no infarction.

Permutation of `ami-embolic-af`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-mesenteric | mustNotMiss | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017 | Let triage read resulted imaging (thrombosis, ischaemia) and D-dimer; do not treat 'pregnancy test negative' as a pregnancy mention (negation). |
| inv-pregnancy-test | investigationInclude | critical | not run | PASS | NICE NG126 2019 |  |
| mgmt-anticoagulation | managementInclude | critical | not run | PASS | ESVS clinical practice guidelines 2017 |  |
| inv-thrombophilia | investigationInclude | quality | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017 |  |
| mgmt-stop-cocp | managementInclude | quality | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017 |  |
| mgmt-no-laparotomy-without-peritonitis | managementExclude | quality | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017 |  |

Failure details:

- **mnm-mesenteric** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Acute Appendicitis \| 3. Bowel Obstruction; also in web.symptomInference#4, web.passive#3 [known gap: Web: PANE has no mesenteric ischaemia / venous thrombosis disease node, so it can never appear in the PANE top 3 (cholecystitis, appendicitis, bowel obstruction).]
- **level-at-least-urgent** (web): web.triage: priority (acuity=review, action=priority_24_48h, score=20); expected ≥ urgent [known gap: Web: adaptiveTriage: 'priority_24_48h' (score 20); the only reasons are 'Pregnancy mentioned' (from 'pregnancy test negative') and pain score. iOS: ClinicalPathwayEngine reads only CC/PMH keywords; CC 'Abdominal pain for five days' gives 'routine'.]
- **inv-thrombophilia** (web): no investigation matched among 34 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: Web: No thrombophilia work-up.]
- **mgmt-stop-cocp** (web): no management item matched among 38 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No prompt to stop the oestrogen-containing pill.]
- **mgmt-no-laparotomy-without-peritonitis** (web): forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." [known gap: Web: 'no guarding or peritonism' triggers the peritonism prompt ('Emergency laparotomy consent') in a patient to be treated with anticoagulation.]
...
62-year-old woman with previous CIN3, three months of an anal lump with bleeding, pain and pruritus, and a hard left inguinal node. NICE NG12 (unexplained anal mass or ulceration) → suspected cancer referral; EUA and biopsy; MRI pelvis, CT; HIV test; chemoradiotherapy is first-line (not abdominoperineal resection).

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-anal-cancer | mustNotMiss | critical | not run | FAIL (known gap) | NICE NG12 2023; ASCRS clinical practice guidelines 2018 | Add anal squamous cell carcinoma to PANE and a C21 protocol (EUA + biopsy, MRI pelvis, CT, HIV test, chemoradiotherapy — ASCRS 2018); NG12 anal-mass/ulcer prompt. |
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2023 |  |
| flag-malignancy | redFlags | critical | not run | PASS | NICE NG12 2023 |  |
| inv-biopsy | investigationInclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2018 |  |
| mgmt-no-haemorrhoid-treatment | managementExclude | critical | not run | PASS | ASCRS clinical practice guidelines 2018 |  |
| inv-mri-pelvis | investigationInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2018 |  |
| inv-hiv-test | investigationInclude | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2018 |  |
| mgmt-chemoradiotherapy | managementInclude | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2018 |  |
...
- **mgmt-chemoradiotherapy** (web): no management item matched among 22 (web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No chemoradiotherapy/oncology output (no anal cancer protocol); the management panel shows the haemorrhoid protocol.]

Guidelines:

- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Anal cancer: consider a suspected cancer pathway referral for an unexplained anal mass or unexplained anal ulceration. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*
- **ascrs-anal-scc-2018** — ASCRS clinical practice guidelines — anal squamous cell cancers (revised 2018) (2018), Biopsy; MRI pelvis and CT staging; HIV testing; chemoradiation as primary treatment; abdominoperineal resection for persistent/recurrent disease. Stewart DB, Gaertner WB, Glasgow SC, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for anal squamous cell cancers (revised 2018). Dis Colon Rectum. 2018;61:755–774. *(statement wording/numbering not yet verified against the source)*

### Anal fissure — acute, posterior midline

#### `anal-fissure-acute-posterior` — 

27-year-old woman with three weeks of tearing pain on defaecation and bright red blood on the paper; posterior midline fissure. ASCRS 2023: fibre, sitz baths, topical calcium-channel blocker or nitrate first-line.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-fissure-top3 | mustRankTopK | quality | not run | PASS | ASCRS clinical practice guidelines 2023 |  |
| level-routine | emergencyLevel | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2023 |  |
| mgmt-topical | managementInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2023 |  |
| mgmt-fibre | managementInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2023 |  |
| mgmt-no-resuscitation | managementExclude | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2023 |  |

Failure details:

- **level-routine** (web): web.triage: emergency (acuity=urgent, action=emergency_now, score=123); expected ≤ priority [known gap: Web adaptiveTriage has no negation handling and treats any "bleed/bleeding" as an urgent red flag (RED_FLAGS "GI or other bleeding" → emergency_now), so every rectal bleed — including minor outlet bleeding — is "emergency".]
...
- **ascrs-fissure-2023** — ASCRS clinical practice guidelines — management of anal fissures (2023), Acute fissure: fibre, sitz baths; topical calcium-channel blockers or nitrates; botulinum toxin or lateral internal sphincterotomy for chronic refractory fissure. Davids JS, Hawkins AT, Bhama AR, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of anal fissures. Dis Colon Rectum. 2023;66:190–199. *(statement wording/numbering not yet verified against the source)*

### Atypical (lateral) anal ulcer — exclude Crohn’s, syphilis, HSV, TB, HIV-related ulcer and anal cancer

#### `anal-fissure-atypical-lateral-hiv` — Atypical: lateral, painless, indurated; HIV

35-year-old man living with HIV (MSM) with a broad, indurated, relatively painless lateral anal ulcer and inguinal lymphadenopathy. Atypical fissure: EUA and biopsy, syphilis/HSV/TB testing, Crohn’s assessment. No sphincterotomy before a diagnosis.

Permutation of `anal-fissure-acute-posterior`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-anal-cancer | mustNotMiss | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2023; ASCRS clinical practice guidelines 2018 | Add anal squamous cell carcinoma to PANE (features: anal mass/ulcer, bleeding, HIV/HPV/CIN history, inguinal nodes) and a C21 protocol. |
| flag-atypical | redFlags | critical | not run | PASS | ASCRS clinical practice guidelines 2023 |  |
| inv-eua-biopsy | investigationInclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2023; ASCRS clinical practice guidelines 2018 | Add an "atypical fissure" dx-variant (lateral, multiple, painless, indurated, HIV/IBD) that replaces the treatment phases with EUA + biopsy, syphilis/HSV/HIV/TB testing and Crohn’s assessment (ASCRS 2023). |
| mgmt-no-sphincterotomy | managementExclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2023 |  |
| mnm-sti-crohn | mustNotMiss | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2023 |  |

Failure details:

- **mnm-anal-cancer** (web): not in top 3 of web.pane: 1. Anal Fissure \| 2. Haemorrhoids \| 3. Inguinal / Femoral Hernia; also in web.symptomInference#5, web.passive#5 [known gap: Anal cancer is not a PANE disease (no disease, no ulcer feature used); symptom inference ranks anal SCC only #5.]
- **mnm-sti-crohn** (web): not in top 3 of web.pane: 1. Anal Fissure \| 2. Haemorrhoids \| 3. Inguinal / Femoral Hernia [known gap: Syphilis/HSV/TB/Crohn’s are not in the PANE top 3 for an atypical fissure (the protocol red flag mentions them).]
- **inv-eua-biopsy** (web): no investigation matched among 11 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: The anal_fissure protocol has no EUA/biopsy investigation (only "biopsy if non-healing after 8 weeks" in red flags), and the atypical/lateral red flag does not change the plan.]
- **mgmt-no-sphincterotomy** (web): forbidden management item present in web.plan: "[surgical] lateral internal sphincterotomy (lis) - highly effective but 1-2% incontinence risk." (+2 more) [known gap: The anal_fissure plan is phase-unfiltered (no fissure dx-variant), so lateral internal sphincterotomy and botulinum toxin are in the documented plan for an undiagnosed atypical ulcer.]

Guidelines:

- **ascrs-fissure-2023** — ASCRS clinical practice guidelines — management of anal fissures (2023), Atypical fissures (lateral, multiple, painless, large, indurated): evaluate for Crohn’s disease, HIV, syphilis, tuberculosis, malignancy — EUA and biopsy. Davids JS, Hawkins AT, Bhama AR, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of anal fissures. Dis Colon Rectum. 2023;66:190–199. *(statement wording/numbering not yet verified against the source)*
- **ascrs-anal-scc-2018** — ASCRS clinical practice guidelines — anal squamous cell cancers (revised 2018) (2018), Biopsy suspicious anal lesions; people with HIV are at high risk of anal cancer. Stewart DB, Gaertner WB, Glasgow SC, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for anal squamous cell cancers (revised 2018). Dis Colon Rectum. 2018;61:755–774. *(statement wording/numbering not yet verified against the source)*

### Anal fissure — chronic, refractory to topical therapy

#### `anal-fissure-chronic-refractory` — Chronic (> 8 weeks), failed diltiazem; female, two vaginal deliveries

42-year-old woman with a chronic posterior fissure despite 8 weeks of topical diltiazem; two vaginal deliveries. ASCRS 2023: botulinum toxin or lateral internal sphincterotomy; in women after vaginal delivery, assess continence risk (botulinum first, or anal physiology/EAUS before LIS).

Permutation of `anal-fissure-acute-posterior`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mgmt-botox-or-lis | managementInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2023 |  |
| mgmt-continence-assessment | managementInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2023 |  |

Guidelines:

- **ascrs-fissure-2023** — ASCRS clinical practice guidelines — management of anal fissures (2023), Chronic fissure after failed topical therapy: botulinum toxin or lateral internal sphincterotomy; tailor to continence risk. Davids JS, Hawkins AT, Bhama AR, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of anal fissures. Dis Colon Rectum. 2023;66:190–199. *(statement wording/numbering not yet verified against the source)*
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-dissection | mustNotMiss | critical | not run | FAIL (known gap) | 2014 ESC Guidelines on the diagnosis and treatment of aortic diseases 2014 | Add a dissection rule/prompt: abrupt/tearing pain to back + BP/pulse differential or hypertension → "Acute aortic syndrome: CT angiography; avoid antithrombotics" (ESC 2014). |
| level-emergency | emergencyLevel | critical | not run | PASS | 2014 ESC Guidelines on the diagnosis and treatment of aortic diseases 2014 |  |
| alarm-dissection | mustAlarm | critical | not run | PASS | 2014 ESC Guidelines on the diagnosis and treatment of aortic diseases 2014 |  |
| inv-ct-angiography | investigationInclude | critical | not run | FAIL (known gap) | 2014 ESC Guidelines on the diagnosis and treatment of aortic diseases 2014 | As mnm-dissection. |
| mgmt-no-antithrombotic | managementExclude | critical | not run | PASS | 2014 ESC Guidelines on the diagnosis and treatment of aortic diseases 2014 |  |
| mnm-dissection-symptom-inference | mustNotMiss | quality | not run | FAIL (known gap) | 2014 ESC Guidelines on the diagnosis and treatment of aortic diseases 2014 |  |
| mgmt-bp-heart-rate-control | managementInclude | quality | not run | FAIL (known gap) | 2014 ESC Guidelines on the diagnosis and treatment of aortic diseases 2014 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-aortoenteric-fistula | mustNotMiss | critical | not run | FAIL (known gap) | ESVS 2020 Clinical Practice Guidelines 2020 | Add a rule/prompt: GI bleeding + aortic graft/AAA repair in surgical history → "Aorto-enteric fistula until proven otherwise: CT angiography, vascular surgery" (ESVS 2020). |
| level-emergency | emergencyLevel | critical | not run | PASS | ESVS 2020 Clinical Practice Guidelines 2020 |  |
| flag-aortic-graft | redFlags | critical | not run | FAIL (known gap) | ESVS 2020 Clinical Practice Guidelines 2020 | Same rule as mnm-aortoenteric-fistula, surfaced as a safety prompt. |
| inv-ct-angiography | investigationInclude | critical | not run | FAIL (known gap) | ESVS 2020 Clinical Practice Guidelines 2020 | Same rule; add "CT angiography" as the first investigation. |
| mgmt-vascular-surgery | managementInclude | critical | not run | FAIL (known gap) | ESVS 2020 Clinical Practice Guidelines 2020 | Same rule. |
| inv-blood-cultures | investigationInclude | quality | not run | PASS | ESVS 2020 Clinical Practice Guidelines 2020 |  |
| mgmt-no-tranexamic-acid | managementExclude | quality | not run | PASS | HALT-IT randomised trial 2020 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-appendicitis-top3 | mustRankTopK | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| score-alvarado-calculator | scoreValue | critical | not run | PASS | Alvarado score (MANTRELS) 1986 |  |
| score-air-calculator | scoreValue | critical | not run | n/a | Appendicitis Inflammatory Response (AIR) score 2008 |  |
| mgmt-lap-appendicectomy | managementInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| dx-appendicitis-top1 | mustRankTopK | quality | not run | PASS |  |  |
| score-rec-alvarado | scoreRecommended | quality | not run | PASS | Alvarado score (MANTRELS) 1986 |  |
| score-rec-air | scoreRecommended | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020; Appendicitis Inflammatory Response (AIR) score 2008 |  |
| score-alvarado-autofill | scoreValue | quality | not run | n/a |  |  |
| inv-fbc | investigationInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| inv-crp | investigationInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| inv-imaging-us-or-ct | investigationInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| inv-urinalysis | investigationInclude | quality | not run | PASS |  |  |
| mgmt-antibiotics | managementInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-analgesia | managementInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-no-routine-postop-antibiotics | managementExclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-uncomplicated | dxVariant | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
...
#### `appendicitis-antibiotics-first-coda` — Woman, CT-confirmed uncomplicated, no appendicolith (antibiotics-first candidate)

28-year-old woman, 20 h migratory RIF pain, urine hCG negative, US non-diagnostic, CT uncomplicated appendicitis without appendicolith; she asks to avoid surgery.
...
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| score-air-calculator | scoreValue | critical | not run | n/a | Appendicitis Inflammatory Response (AIR) score 2008 |  |
| inv-pregnancy-test | investigationInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mnm-gynaecological | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| inv-ultrasound-first | investigationInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-lap-appendicectomy-offered | managementInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-antibiotics-first-option | managementInclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020; CODA trial 2020 | Add a 'conservative' step to the appendicitis protocol: antibiotics-first for CT-confirmed uncomplicated appendicitis without appendicolith after shared decision (WSES 2020, CODA), with the recurrence figure. |
| variant-uncomplicated | dxVariant | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |

Failure details:

- **mnm-gynaecological** (web): not in top 5 of web.symptomInference: 1. Acute appendicitis \| 2. Acute appendicitis (paediatric) \| 3. Acute alcoholic pancreatitis \| 4. Acute gastroenteritis \| 5. Typhoid fever [known gap: Web: Symptom inference top 5: appendicitis ×2, alcoholic pancreatitis, gastroenteritis, typhoid; no gynaecological cause for a 28-year-old woman.]
...
- **wses-2020** — WSES Jerusalem guidelines — diagnosis and treatment of acute appendicitis (2020 update) (2020), Clinical scores (AIR/AAS over Alvarado), imaging by age/sex/pregnancy, antibiotic-first option, complicated appendicitis (abscess), antibiotic duration. Di Saverio S, Podda M, De Simone B, et al. Diagnosis and treatment of acute appendicitis: 2020 update of the WSES Jerusalem guidelines. World J Emerg Surg. 2020;15:27. *(statement wording/numbering not yet verified against the source)*
- **coda-2020** — CODA trial — antibiotics versus appendectomy for acute appendicitis (2020), Non-inferiority of antibiotics-first for health status at 30 days; ~3 in 10 had appendicectomy by 90 days; appendicolith associated with more appendicectomies and complications. CODA Collaborative. A randomized trial comparing antibiotics with appendectomy for appendicitis. N Engl J Med. 2020;383:1907–19. *(statement wording/numbering not yet verified against the source)*
- **air-2008** — Appendicitis Inflammatory Response (AIR) score (2008), Items and weights; 0–4 low, 5–8 intermediate, 9–12 high probability. Andersson M, Andersson RE. The appendicitis inflammatory response score: a tool for the diagnosis of acute appendicitis that outperforms the Alvarado score. World J Surg. 2008;32:1843–9. *(statement wording/numbering not yet verified against the source)*

#### `appendicitis-appendicolith` — Appendicolith on CT (antibiotics-first caution)

34-year-old man, 30 h migratory RIF pain, rebound, WBC 14.1; CT shows appendicitis with a 7 mm appendicolith. He asks about antibiotics instead of surgery.
...
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-lap-appendicectomy | managementInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-appendicolith-caution | managementInclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020; CODA trial 2020 |  |
| mgmt-no-antibiotics-first-despite-appendicolith | managementExclude | quality | not run | PASS | CODA trial 2020; WSES Jerusalem guidelines 2020 |  |
| mgmt-no-routine-postop-antibiotics | managementExclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 |  |
| variant-uncomplicated | dxVariant | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |

Failure details:

- **mgmt-appendicolith-caution** (web): no management item matched among 47 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: Appendicolith appears only as a CT finding to look for; no statement links it to antibiotic-first failure.]
- **mgmt-no-routine-postop-antibiotics** (web): forbidden management item present in web.clinicalPrompts: "...l: [x] ml. swab count correct × 2. post-operative orders: • simple appendicitis: iv amoxiclav 1.2g tds × 24h → oral co-amoxiclav × 5 days. • perforated appendicitis: iv pip-tazo 4.5g tds + metronidazole 500mg tds × 5 ..." [known gap: Web: Appendicectomy operative-plan prompt prescribes 5 days of co-amoxiclav after simple appendicitis.]
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-appendicitis-top5 | mustRankTopK | critical | not run | PASS | SIFIPAC/WSES/SICG/SIMEU guidelines 2020 |  |
| mnm-mesenteric-ischaemia | mustNotMiss | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2017 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | SIFIPAC/WSES/SICG/SIMEU guidelines 2020 |  |
| score-alvarado-calculator | scoreValue | critical | not run | PASS | Alvarado score (MANTRELS) 1986 |  |
| score-air-calculator | scoreValue | critical | not run | n/a | Appendicitis Inflammatory Response (AIR) score 2008 |  |
| inv-ct-abdomen-pelvis | investigationInclude | critical | not run | PASS | SIFIPAC/WSES/SICG/SIMEU guidelines 2020 |  |
| mnm-caecal-neoplasm | mustNotMiss | quality | not run | FAIL (known gap) | SIFIPAC/WSES/SICG/SIMEU guidelines 2020 |  |
| mnm-diverticulitis | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| flag-anticoagulant | redFlags | quality | not run | PASS |  |  |
| flag-elderly-atypical | redFlags | quality | not run | PASS |  |  |
| score-rec-alvarado | scoreRecommended | quality | not run | PASS |  |  |
| inv-renal-function | investigationInclude | quality | not run | PASS |  |  |
| inv-lactate-or-cta | investigationInclude | quality | not run | PASS | ESVS clinical practice guidelines 2017 |  |
| mgmt-anticoagulant-plan | managementInclude | quality | not run | PASS |  |  |
| mgmt-lap-appendicectomy | managementInclude | quality | not run | PASS | SIFIPAC/WSES/SICG/SIMEU guidelines 2020 |  |
| mgmt-no-discharge-on-low-score | managementExclude | quality | not run | PASS |  |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-uncomplicated | dxVariant | quality | not run | PASS |  |  |
...
#### `appendicitis-generalised-peritonitis-sepsis` — Perforated, generalised peritonitis with sepsis

31-year-old man, 3 days of RIF pain now generalised, T 39.1 °C, HR 126, BP 92/58, RR 24, lactate 3.4; CT shows perforated appendicitis with free fluid throughout.
...
|---|---|---|---|---|---|---|
| dx-appendicitis-top3 | mustRankTopK | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES Jerusalem guidelines 2020; Surviving Sepsis Campaign 2021 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| inv-blood-cultures | investigationInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-emergency-source-control | managementInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020; Surviving Sepsis Campaign 2021 |  |
| score-qsofa-calculator | scoreValue | quality | not run | n/a | Third international consensus definitions for sepsis and septic shock (Sepsis-3) 2016 |  |
| inv-lactate | investigationInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-fluids | managementInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-postop-antibiotics-short-course | managementInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| variant-generalised-peritonitis | dxVariant | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 | Same as the abscess fix: specific-first ordering; uncomplicated as fallback. |

Failure details:

- **variant-generalised-peritonitis** (web): detected appendicitis_uncomplicated in group Acute Appendicitis; expected appendicitis_generalised_peritonitis [known gap: Web: Same first-match problem: 'appendicitis' in the uncomplicated variant wins over 'generalised peritonitis'; the plan header says 'ideally within 12 h' instead of the emergency note.]

Guidelines:

- **wses-2020** — WSES Jerusalem guidelines — diagnosis and treatment of acute appendicitis (2020 update) (2020), Clinical scores (AIR/AAS over Alvarado), imaging by age/sex/pregnancy, antibiotic-first option, complicated appendicitis (abscess), antibiotic duration. Di Saverio S, Podda M, De Simone B, et al. Diagnosis and treatment of acute appendicitis: 2020 update of the WSES Jerusalem guidelines. World J Emerg Surg. 2020;15:27. *(statement wording/numbering not yet verified against the source)*
- **ssc-2021** — Surviving Sepsis Campaign — international guidelines for sepsis and septic shock 2021 (2021), Screening (do not use qSOFA alone), antibiotics within 1 h of shock, blood cultures, lactate, 30 mL/kg crystalloid for hypoperfusion, vasopressors, source control. Evans L, Rhodes A, Alhazzani W, et al. Surviving Sepsis Campaign: international guidelines for management of sepsis and septic shock 2021. Crit Care Med. 2021;49:e1063–e1143. *(statement wording/numbering not yet verified against the source)*
- **sepsis-3** — Third international consensus definitions for sepsis and septic shock (Sepsis-3) (2016), qSOFA: RR ≥22, altered mentation, SBP ≤100. Singer M, Deutschman CS, Seymour CW, et al. JAMA. 2016;315:801–10. *(statement wording/numbering not yet verified against the source)*

#### `appendicitis-immunosuppressed-transplant` — Immunosuppressed (renal transplant, steroids), diabetic

52-year-old renal transplant recipient on tacrolimus, mycophenolate and prednisolone, 2 days of mild RIF/flank ache, T 37.4 °C, WBC 10.2, CRP 96; CT shows perforated retrocaecal appendicitis with a 2 cm collection.
...
| dx-appendicitis-top3 | mustRankTopK | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| inv-ct | investigationInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| flag-immunosuppression | redFlags | quality | not run | FAIL (known gap) |  |  |
| mgmt-surgery | managementInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-steroid-cover | managementInclude | quality | not run | FAIL (known gap) |  |  |

Failure details:

- **flag-immunosuppression** (web): no red flag matched among 24 (web.triage.reasons, web.protocol.redFlags, web.dxVariant.urgencyNote, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: Web: Triage scores 'Higher-risk comorbidity present' but no red flag, prompt or protocol text names immunosuppression or steroids as masking the signs.]
- **mgmt-steroid-cover** (web): no management item matched among 59 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No peri-operative steroid-cover prompt for a patient on long-term prednisolone.]

Guidelines:

- **wses-2020** — WSES Jerusalem guidelines — diagnosis and treatment of acute appendicitis (2020 update) (2020), Clinical scores (AIR/AAS over Alvarado), imaging by age/sex/pregnancy, antibiotic-first option, complicated appendicitis (abscess), antibiotic duration. Di Saverio S, Podda M, De Simone B, et al. Diagnosis and treatment of acute appendicitis: 2020 update of the WSES Jerusalem guidelines. World J Emerg Surg. 2020;15:27. *(statement wording/numbering not yet verified against the source)*

#### `appendicitis-paediatric-9y` — Child (9 years), ultrasound-confirmed

9-year-old boy, 30 h migratory RIF pain, vomiting, fever 38.2 °C, RIF peritonism, WBC 15.9, CRP 38; ultrasound shows an 8 mm non-compressible appendix. Uncomplicated appendicitis in a child.
...
| score-alvarado-calculator | scoreValue | critical | not run | PASS | Alvarado score (MANTRELS) 1986 |  |
| mgmt-lap-appendicectomy | managementInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-no-adult-fixed-doses | managementExclude | critical | not run | FAIL (known gap) |  | Give protocol medications and prompt templates an age/weight branch (mg/kg with adult maximum) and suppress fixed adult doses when age < 16 or weight < 50 kg. |
| mnm-mesenteric-adenitis | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| score-rec-pas | scoreRecommended | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020; Pediatric Appendicitis Score (PAS) 2002 |  |
| inv-ultrasound | investigationInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-antibiotics | managementInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-no-unqualified-ct-child | managementExclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 | Keep the investigation 'conditional' text in PlanTab.buildPlanText and add a paediatric qualifier (US first; CT only if US non-diagnostic). |
| mgmt-no-routine-postop-antibiotics | managementExclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-uncomplicated | dxVariant | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
...
- **mnm-mesenteric-adenitis** (web): not in top 5 of web.symptomInference: 1. Acute appendicitis (paediatric) \| 2. Acute appendicitis \| 3. Acute alcoholic pancreatitis \| 4. Acute gastroenteritis \| 5. Acute cholecystitis [known gap: Web: Symptom inference has a mesenteric adenitis entry but ranks it outside the top 5 (appendicitis ×2, pancreatitis, gastroenteritis, cholecystitis).]
...
- **mgmt-no-routine-postop-antibiotics** (web): forbidden management item present in web.clinicalPrompts: "...l: [x] ml. swab count correct × 2. post-operative orders: • simple appendicitis: iv amoxiclav 1.2g tds × 24h → oral co-amoxiclav × 5 days. • perforated appendicitis: iv pip-tazo 4.5g tds + metronidazole 500mg tds × 5 ..." [known gap: Web: Appendicectomy operative-plan prompt prescribes IV then oral co-amoxiclav for 5 days after simple appendicitis.]

Guidelines:

- **wses-2020** — WSES Jerusalem guidelines — diagnosis and treatment of acute appendicitis (2020 update) (2020), Clinical scores (AIR/AAS over Alvarado), imaging by age/sex/pregnancy, antibiotic-first option, complicated appendicitis (abscess), antibiotic duration. Di Saverio S, Podda M, De Simone B, et al. Diagnosis and treatment of acute appendicitis: 2020 update of the WSES Jerusalem guidelines. World J Emerg Surg. 2020;15:27. *(statement wording/numbering not yet verified against the source)*
- **alvarado-1986** — Alvarado score (MANTRELS) (1986), Items and weights; ≤4 unlikely, 5–6 possible, 7–8 probable, 9–10 very probable. Alvarado A. A practical score for the early diagnosis of acute appendicitis. Ann Emerg Med. 1986;15:557–64. *(statement wording/numbering not yet verified against the source)*
- **pas-2002** — Pediatric Appendicitis Score (PAS) (2002), Items and weights for children. Samuel M. Pediatric appendicitis score. J Pediatr Surg. 2002;37:877–81. *(statement wording/numbering not yet verified against the source)*

#### `appendicitis-perforated-abscess` — Complicated: perforated with 5.5 cm abscess

46-year-old man, 6 days of RIF pain with a tender mass, fever 38.3 °C, WBC 16, CRP 210; CT shows perforated appendicitis with a 5.5 cm pericaecal abscess. Haemodynamically stable.
...
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| inv-ct | investigationInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| inv-blood-cultures | investigationInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-percutaneous-drainage | managementInclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 | When the confirmed ICD is K35.3x or the assessment names an abscess/phlegmon, use the appendix_mass protocol for the Plan tab instead of the converged PANE disease. |
| mgmt-interval-colon-evaluation | managementInclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 |  |
| variant-abscess | dxVariant | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 | Order the appendicitis variants from most to least specific (generalised peritonitis, abscess, phlegmon, localised peritonitis, uncomplicated) and remove the bare 'appendicitis' keyword from the uncomplicated variant (make it the fallback when no other variant matches). |

Failure details:

- **mgmt-percutaneous-drainage** (web): no management item matched among 58 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: PANE converges on 'Acute Appendicitis' (≥0.85), so PlanTab uses the appendicitis protocol, which has no drainage step; the appendix_mass protocol (with drainage) is used only if PANE picks it.]
- **mgmt-interval-colon-evaluation** (web): no management item matched among 58 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: Appendicitis protocol has no interval colonoscopy/CT; only the appendix_mass protocol does.]
- **variant-abscess** (web): detected appendicitis_uncomplicated in group Acute Appendicitis; expected appendicitis_abscess [known gap: Web: detectDxVariants: 'appendicitis_uncomplicated' is checked first and its keyword list contains the bare word 'appendicitis', so any assessment mentioning appendicitis (here 'perforated appendicitis with a 5.5 cm pericaecal abscess') selects the uncomplicated variant.]
...
| dx-appendicitis-top3 | mustRankTopK | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| flag-pregnancy | redFlags | critical | not run | PASS | ACOG Committee Opinion No. 723 2017 |  |
| inv-mri-after-inconclusive-us | investigationInclude | critical | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020; ACOG Committee Opinion No. 723 2017 |  |
| mgmt-no-nsaid-after-20-weeks | managementExclude | critical | not run | FAIL (known gap) | US FDA Drug Safety Communication 2020 |  |
| mnm-obstetric-cause | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| mnm-pyelonephritis | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| inv-ultrasound-first | investigationInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020; ACOG Committee Opinion No. 723 2017 |  |
| inv-no-unqualified-ct | investigationExclude | quality | not run | FAIL (known gap) |  |  |
| inv-no-gadolinium | investigationExclude | quality | not run | PASS | ACOG Committee Opinion No. 723 2017 |  |
| mgmt-lap-appendicectomy | managementInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020; SAGES guidelines for the use of laparoscopy during pregnancy 2017 |  |
| mgmt-obstetric-involvement | managementInclude | quality | not run | FAIL (known gap) | SAGES guidelines for the use of laparoscopy during pregnancy 2017 |  |
| mgmt-no-bhcg-negative-assumption | managementExclude | quality | not run | FAIL (known gap) |  |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-uncomplicated | dxVariant | quality | not run | PASS |  |  |
...
#### `appendicitis-score-intermediate-band` — Intermediate score band (Alvarado 6, AIR 5): imaging needed

38-year-old man, 30 h migratory RIF pain with nausea, afebrile, RIF tenderness without guarding, WBC 11.8, CRP 32. Intermediate probability.
...
| score-alvarado-calculator | scoreValue | critical | not run | PASS | Alvarado score (MANTRELS) 1986 |  |
| score-air-calculator | scoreValue | critical | not run | n/a | Appendicitis Inflammatory Response (AIR) score 2008 |  |
| inv-imaging | investigationInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| score-rec-air | scoreRecommended | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020; Appendicitis Inflammatory Response (AIR) score 2008 |  |
| score-rec-aas | scoreRecommended | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020; Adult Appendicitis Score (AAS) 2014 |  |
| mgmt-no-direct-theatre-before-imaging | managementExclude | quality | not run | PASS |  |  |
...
- **alvarado-1986** — Alvarado score (MANTRELS) (1986), Items and weights; ≤4 unlikely, 5–6 possible, 7–8 probable, 9–10 very probable. Alvarado A. A practical score for the early diagnosis of acute appendicitis. Ann Emerg Med. 1986;15:557–64. *(statement wording/numbering not yet verified against the source)*
- **air-2008** — Appendicitis Inflammatory Response (AIR) score (2008), Items and weights; 0–4 low, 5–8 intermediate, 9–12 high probability. Andersson M, Andersson RE. The appendicitis inflammatory response score: a tool for the diagnosis of acute appendicitis that outperforms the Alvarado score. World J Surg. 2008;32:1843–9. *(statement wording/numbering not yet verified against the source)*
- **aas-2014** — Adult Appendicitis Score (AAS) (2014), Items and weights; <11 low, 11–15 intermediate, ≥16 high probability. Sammalkorpi HE, Mentula P, Leppäniemi A. A new adult appendicitis score improves diagnostic accuracy of acute appendicitis — a prospective study. BMC Gastroenterol. 2014;14:114. *(statement wording/numbering not yet verified against the source)*

#### `appendicitis-score-low-band` — Low-risk score band (Alvarado 3, AIR 1), woman

22-year-old woman, 12 h dull RIF pain, no migration, no anorexia, afebrile, mild RIF tenderness without peritonism, WBC 8.9, CRP 6. Low probability of appendicitis.
...
| score-alvarado-calculator | scoreValue | critical | not run | PASS | Alvarado score (MANTRELS) 1986 |  |
| score-air-calculator | scoreValue | critical | not run | n/a | Appendicitis Inflammatory Response (AIR) score 2008 |  |
| inv-pregnancy-test | investigationInclude | critical | not run | PASS | WSES Jerusalem guidelines 2020; NICE NG126 2019 |  |
| mnm-gynaecological | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| level-not-emergency | emergencyLevel | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 | Add negation handling to scanRedFlags (skip matches preceded within a few words by 'no', 'denies', 'without', 'negative'). |
| score-rec-air | scoreRecommended | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020; Appendicitis Inflammatory Response (AIR) score 2008 |  |
| mgmt-observe-or-safety-net | managementInclude | quality | not run | PASS | WSES Jerusalem guidelines 2020 |  |
| mgmt-no-appendicectomy-at-low-risk | managementExclude | quality | not run | FAIL (known gap) | WSES Jerusalem guidelines 2020 | Negation-aware exam() matching in computeClinicalPrompts; gate the operative template on a confirmed appendicitis diagnosis, not on exam substrings. |
...
- **level-not-emergency** (web): web.triage: emergency (acuity=urgent, action=emergency_now, score=67); expected ≤ urgent [known gap: Web: adaptiveTriage returns emergency_now because the HPI negative 'No vaginal bleeding' matches the 'GI or other bleeding' red flag (no negation handling).]
- **score-rec-air** (web): air not recommended; recommended: alvarado, ranson, news2 [known gap: Web: Web CDS has no AIR rule.]
- **mgmt-no-appendicectomy-at-low-risk** (web): forbidden management item present in web.clinicalPrompts: "• emergency laparoscopic appendicectomy - consent obtained, theatre booked." [known gap: Web: The appendicitis prompt fires on the substrings 'guarding'/'rebound' in 'No guarding, no rebound' and adds 'Emergency laparoscopic appendicectomy — consent obtained, theatre booked' for an AIR 1 patient.]
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-perforation-top3 | mustRankTopK | critical | not run | FAIL (known gap) | WSES guidelines 2019 | socrates-to-features.ts: site "Retrosternal"/"Chest" → chest_pain_oesophageal; "surgical emphysema\|crepitus" (exam chip) → subcutaneous_emphysema; seed PANE from exam chips. |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES guidelines 2019 |  |
| alarm-perforation-or-sepsis | mustAlarm | critical | not run | PASS | WSES guidelines 2019 |  |
| inv-ct-oral-contrast | investigationInclude | critical | not run | PASS | WSES guidelines 2019 |  |
| mgmt-nil-by-mouth | managementInclude | critical | not run | PASS | WSES guidelines 2019 |  |
| mgmt-broad-spectrum-antibiotics | managementInclude | critical | not run | PASS | WSES guidelines 2019 |  |
| mgmt-surgical-referral | managementInclude | critical | not run | PASS | WSES guidelines 2019 |  |
| mnm-acs | mustNotMiss | quality | not run | PASS | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 |  |
| inv-blood-cultures | investigationInclude | quality | not run | PASS | WSES guidelines 2019 |  |
| mgmt-antifungal | managementInclude | quality | not run | FAIL (known gap) | WSES guidelines 2019 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-perforation | mustNotMiss | critical | not run | FAIL (known gap) | WSES guidelines 2019 | As boerhaave-classic-mackler dx gap; add an oesophageal-perforation entry to symptom inference (vomiting then chest pain, odynophagia, crepitus). |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES guidelines 2019; 2023 ESC Guidelines for the management of acute coronary syndromes 2023 |  |
| inv-ecg | investigationInclude | critical | not run | FAIL (known gap) | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 | computeClinicalPrompts: chest pain (chip or CC/HPI text) → safety prompt "12-lead ECG within 10 min + hs-troponin" (ESC 2023). |
| inv-ct-oral-contrast | investigationInclude | critical | not run | PASS | WSES guidelines 2019 |  |
| mgmt-no-anticoagulation-before-ct | managementExclude | quality | not run | PASS | 2023 ESC Guidelines for the management of acute coronary syndromes 2023; WSES guidelines 2019 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-perforation | mustNotMiss | critical | not run | FAIL (known gap) | WSES guidelines 2019 | As boerhaave-classic-mackler dx gap. |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES guidelines 2019 |  |
| inv-ct-oral-contrast | investigationInclude | critical | not run | PASS | WSES guidelines 2019 |  |
| mgmt-nil-by-mouth | managementInclude | quality | not run | PASS | WSES guidelines 2019 |  |
...
44-year-old woman, 24 h colicky pain, distension and vomiting; CT: caecum 11 cm in the left upper quadrant with a whirl sign, no ischaemia.

Permutation of `sigmoid-volvulus-base`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | ASCRS clinical practice guidelines 2021 |  |
| inv-pregnancy-test | investigationInclude | critical | not run | PASS | NICE NG126 2019 |  |
| mgmt-resection | managementInclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2021 | Separate caecal-volvulus variant with right hemicolectomy/ileocaecal resection (ASCRS 2021). |
| mgmt-no-endoscopic-reduction-caecal | managementExclude | quality | not run | PASS | ASCRS clinical practice guidelines 2021 |  |
| variant-lbo-volvulus | dxVariant | quality | not run | PASS | ASCRS clinical practice guidelines 2021 |  |

Failure details:

- **mgmt-resection** (web): no management item matched among 44 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No right hemicolectomy/ileocaecal resection in any output; the volvulus variant reuses the generic bowel-obstruction steps.]
...
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | PASS | WSES guidelines 2019 |  |
| alarm-caustic-airway | mustAlarm | critical | not run | PASS | WSES guidelines 2019 |  |
| flag-self-harm | redFlags | critical | not run | PASS | WSES guidelines 2019 |  |
| mgmt-no-emesis-or-neutralisation | managementExclude | critical | not run | PASS | WSES guidelines 2019 |  |
| inv-ct-or-endoscopy | investigationInclude | quality | not run | PASS | WSES guidelines 2019 |  |
| inv-airway-assessment | investigationInclude | quality | not run | FAIL (known gap) | WSES guidelines 2019 | Add a caustic-ingestion protocol/prompt (WSES 2019: airway first, no emesis/neutralisation/blind NG tube, CT ± endoscopy, psychiatry). |
| mgmt-psychiatric-assessment | managementInclude | quality | not run | FAIL (known gap) | WSES guidelines 2019 | As inv-airway-assessment. |
| mgmt-nil-by-mouth | managementInclude | quality | not run | FAIL (known gap) | WSES guidelines 2019 | As inv-airway-assessment. |
| mgmt-no-blind-ng-tube | managementExclude | quality | not run | PASS | WSES guidelines 2019 |  |
...
#### `cdiff-fulminant-colitis` — Fulminant CDI (hypotension, ileus, WBC 32, lactate 3.2) after antibiotics

76-year-old care-home resident after a course of co-amoxiclav: profuse diarrhoea that has now slowed, distension, WBC 32, creatinine 210, lactate 3.2, hypotension. Fulminant CDI: oral (± rectal) vancomycin plus IV metronidazole, early surgical consultation, subtotal colectomy or loop ileostomy with colonic lavage if deteriorating.

Permutation of `infective-colitis-bloody-diarrhoea`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-cdiff | mustNotMiss | critical | not run | FAIL (known gap) | IDSA/SHEA clinical practice guidelines for Clostridium difficile infection (2017 update) 2018; WSES guidelines 2019 | Add a C. difficile disease/protocol (triggers: recent antibiotics, hospital/care-home exposure, toxin-positive result): oral vancomycin or fidaxomicin; fulminant: oral/rectal vancomycin + IV metronidazole, surgical consultation (IDSA/SHEA 2017/2021, WSES 2019). Read a toxin-positive lab result. |
| level-emergency | emergencyLevel | critical | not run | PASS | IDSA/SHEA clinical practice guidelines for Clostridium difficile infection (2017 update) 2018 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | IDSA/SHEA clinical practice guidelines for Clostridium difficile infection (2017 update) 2018 |  |
| mgmt-vancomycin-metronidazole | managementInclude | critical | not run | FAIL (known gap) | IDSA/SHEA clinical practice guidelines for Clostridium difficile infection (2017 update) 2018; WSES guidelines 2019 | Add a C. difficile disease/protocol (triggers: recent antibiotics, hospital/care-home exposure, toxin-positive result): oral vancomycin or fidaxomicin; fulminant: oral/rectal vancomycin + IV metronidazole, surgical consultation (IDSA/SHEA 2017/2021, WSES 2019). Read a toxin-positive lab result. |
| mgmt-surgical-consult | managementInclude | critical | not run | FAIL (known gap) | IDSA/SHEA clinical practice guidelines for Clostridium difficile infection (2017 update) 2018; WSES guidelines 2019 | Add a C. difficile disease/protocol (triggers: recent antibiotics, hospital/care-home exposure, toxin-positive result): oral vancomycin or fidaxomicin; fulminant: oral/rectal vancomycin + IV metronidazole, surgical consultation (IDSA/SHEA 2017/2021, WSES 2019). Read a toxin-positive lab result. |
| mgmt-no-antimotility | managementExclude | critical | not run | PASS | IDSA/SHEA clinical practice guidelines for Clostridium difficile infection (2017 update) 2018 |  |
| score-qsofa-calculator | scoreValue | quality | not run | n/a | IDSA/SHEA clinical practice guidelines for Clostridium difficile infection (2017 update) 2018 |  |
...
- **mgmt-surgical-consult** (web): no management item matched among 39 (web.clinicalPrompts) [known gap: No surgical consultation/colectomy output for fulminant CDI (no protocol; prompts cover sepsis only).]

Guidelines:

- **idsa-cdi-2017** — IDSA/SHEA clinical practice guidelines for Clostridium difficile infection (2017 update) — fulminant CDI (2018), Fulminant CDI (hypotension/shock, ileus, megacolon): oral/rectal vancomycin + IV metronidazole; surgical management (subtotal colectomy or diverting loop ileostomy with colonic lavage). McDonald LC, Gerding DN, Johnson S, et al. Clinical practice guidelines for Clostridium difficile infection in adults and children: 2017 update by the IDSA and SHEA. Clin Infect Dis. 2018;66:e1–e48. *(statement wording/numbering not yet verified against the source)*
- **wses-cdi-2019** — WSES guidelines — Clostridioides difficile infection in surgical patients (2019 update) (2019), Surgical patients: early surgical consultation in severe/complicated CDI; indications for colectomy. Sartelli M, Di Bella S, McFarland LV, et al. 2019 update of the WSES guidelines for management of Clostridioides (Clostridium) difficile infection in surgical patients. World J Emerg Surg. 2019;14:8. *(statement wording/numbering not yet verified against the source)*
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-cholangitis-top3 | mustRankTopK | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | Tokyo Guidelines 2018 2018; Surviving Sepsis Campaign guidelines 2021 2021 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign guidelines 2021 2021; Tokyo Guidelines 2018 2018 |  |
| score-tg18-calculator | scoreValue | critical | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| inv-blood-cultures | investigationInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018; Surviving Sepsis Campaign guidelines 2021 2021 |  |
| mgmt-biliary-drainage | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018; Tokyo Guidelines 2018 2018 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018; Surviving Sepsis Campaign guidelines 2021 2021 |  |
| dx-cholangitis-top1 | mustRankTopK | quality | not run | PASS |  |  |
| mnm-choledocholithiasis | mustNotMiss | quality | not run | PASS |  |  |
| flag-charcot | redFlags | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| score-rec-tg18-cholangitis | scoreRecommended | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| score-tg18-autofill | scoreValue | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| score-qsofa-calculator | scoreValue | quality | not run | n/a | Sepsis-3 consensus definitions 2016 |  |
| score-qsofa-autofill | scoreValue | quality | not run | n/a | Sepsis-3 consensus definitions 2016 |  |
| inv-lfts | investigationInclude | quality | not run | PASS |  |  |
| inv-coagulation | investigationInclude | quality | not run | PASS |  |  |
| inv-mrcp-or-eus | investigationInclude | quality | not run | PASS |  |  |
| mgmt-drainage-in-generated-plan | managementInclude | quality | not run | FAIL (known gap) |  |  |
| mgmt-iv-fluids | managementInclude | quality | not run | PASS |  |  |
| mgmt-interval-cholecystectomy | managementInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-grade2 | dxVariant | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
...
|---|---|---|---|---|---|---|
| dx-cholangitis-top3 | mustRankTopK | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018; Tokyo Guidelines 2018 2018 |  |
| mnm-malignant-obstruction | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| no-sepsis-alarm-mild | mustNotAlarm | quality | not run | PASS |  |  |
| score-rec-tg18-cholangitis | scoreRecommended | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| score-tg18-calculator | scoreValue | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| score-tg18-autofill | scoreValue | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| inv-lfts | investigationInclude | quality | not run | PASS |  |  |
| inv-mrcp-or-eus | investigationInclude | quality | not run | PASS |  |  |
| inv-blood-cultures | investigationInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-drainage-plan | managementInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-grade1 | dxVariant | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
...
|---|---|---|---|---|---|---|
| dx-cholangitis-top3 | mustRankTopK | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| level-emergency | emergencyLevel | critical | not run | PASS | Tokyo Guidelines 2018 2018; Surviving Sepsis Campaign guidelines 2021 2021 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign guidelines 2021 2021 |  |
| alarm-haemodynamic | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign guidelines 2021 2021 |  |
| score-tg18-calculator | scoreValue | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| score-tg18-autofill | scoreValue | critical | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| inv-blood-cultures | investigationInclude | critical | not run | PASS | Surviving Sepsis Campaign guidelines 2021 2021; Tokyo Guidelines 2018 2018 |  |
| mgmt-urgent-biliary-drainage | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018; Tokyo Guidelines 2018 2018 |  |
| mgmt-organ-support | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018; Surviving Sepsis Campaign guidelines 2021 2021 |  |
| mgmt-broad-spectrum-antibiotics | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018; Surviving Sepsis Campaign guidelines 2021 2021 |  |
| mnm-septic-shock | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| flag-anticoagulant | redFlags | quality | not run | PASS |  |  |
| flag-reynolds | redFlags | quality | not run | PASS |  |  |
| score-rec-tg18-cholangitis | scoreRecommended | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| score-qsofa-autofill | scoreValue | quality | not run | n/a | Sepsis-3 consensus definitions 2016 |  |
| inv-lactate | investigationInclude | quality | not run | PASS | Surviving Sepsis Campaign guidelines 2021 2021 |  |
| inv-coagulation | investigationInclude | quality | not run | PASS |  |  |
| mgmt-vasopressor-fluids | managementInclude | quality | not run | PASS | Surviving Sepsis Campaign guidelines 2021 2021 |  |
| mgmt-anticoagulant-plan | managementInclude | quality | not run | PASS |  |  |
| mgmt-no-surgery-first | managementExclude | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-grade3 | dxVariant | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-cholecystitis-top3 | mustRankTopK | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| score-tg18-calculator | scoreValue | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-lap-cholecystectomy | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mnm-cbd-stone-or-cholangitis | mustNotMiss | quality | not run | PASS |  |  |
| no-sepsis-alarm-grade1 | mustNotAlarm | quality | not run | PASS |  |  |
| score-rec-tg18-cholecystitis | scoreRecommended | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| score-tg18-autofill | scoreValue | quality | not run | FAIL (known gap) |  |  |
| inv-ultrasound | investigationInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| inv-lfts | investigationInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| inv-fbc-crp | investigationInclude | quality | not run | PASS |  |  |
| mgmt-early-timing | managementInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-antibiotics | managementInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-analgesia | managementInclude | quality | not run | PASS |  |  |
| mgmt-no-drainage-first-line-grade1 | managementExclude | quality | not run | PASS |  |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-grade1 | dxVariant | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
...
| score-tg18-calculator | scoreValue | critical | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| mgmt-lap-cholecystectomy | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| flag-diabetes | redFlags | quality | not run | PASS |  |  |
| score-rec-tg18-cholecystitis | scoreRecommended | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| inv-blood-cultures | investigationInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| inv-glucose | investigationInclude | quality | not run | PASS |  |  |
| mgmt-gb-drainage-option | managementInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-antibiotics | managementInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-diabetes-plan | managementInclude | quality | not run | PASS |  |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-grade2 | dxVariant | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
...
|---|---|---|---|---|---|---|
| dx-cholecystitis-top3 | mustRankTopK | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| level-emergency | emergencyLevel | critical | not run | PASS | Tokyo Guidelines 2018 2018; Surviving Sepsis Campaign 2021 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021; Third International Consensus Definitions for Sepsis and Septic Shock (Sepsis-3) 2016 |  |
| alarm-haemodynamic | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| flag-penicillin-allergy | redFlags | critical | not run | PASS |  |  |
| score-tg18-calculator | scoreValue | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| score-tg18-autofill | scoreValue | critical | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| inv-blood-cultures | investigationInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021; Tokyo Guidelines 2018 2018 |  |
| mgmt-gb-drainage | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-organ-support | managementInclude | critical | not run | PASS | Tokyo Guidelines 2018 2018; Surviving Sepsis Campaign 2021 |  |
| mgmt-no-penicillin-in-anaphylaxis | managementExclude | critical | not run | FAIL (known gap) |  |  |
| mnm-cholangitis | mustNotMiss | quality | not run | PASS |  |  |
| flag-organ-support | redFlags | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| score-rec-tg18-cholecystitis | scoreRecommended | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| score-rec-news2 | scoreRecommended | quality | not run | PASS | Surviving Sepsis Campaign 2021; Royal College of Physicians 2017 |  |
| score-qsofa-autofill | scoreValue | quality | not run | n/a | Third International Consensus Definitions for Sepsis and Septic Shock (Sepsis-3) 2016 |  |
| inv-lactate | investigationInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| inv-coagulation | investigationInclude | quality | not run | PASS |  |  |
| mgmt-gb-drainage-in-generated-plan | managementInclude | quality | not run | FAIL (known gap) |  |  |
| mgmt-non-penicillin-antibiotic | managementInclude | quality | not run | PASS | Tokyo Guidelines 2018 2018 |  |
| mgmt-no-early-cholecystectomy-in-shock | managementExclude | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-grade3 | dxVariant | quality | not run | FAIL (known gap) | Tokyo Guidelines 2018 2018 |  |
...
### Colorectal cancer — symptomatic, FIT positive

#### `crc-cibh-fit-positive-older` — 

67-year-old man with 10 weeks of looser stools, dark blood mixed with stool, 4 kg weight loss, iron-deficiency anaemia (Hb 10.2, ferritin 9) and FIT 186 µg Hb/g: suspected colorectal cancer pathway (colonoscopy) under NICE NG12/DG56.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-crc-top3 | mustRankTopK | critical | not run | PASS | NICE NG12 2023 |  |
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2023 |  |
| flag-crc | redFlags | critical | not run | PASS | NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | not run | PASS | NICE NG12 2023; ACPGBI/BSG joint guideline 2022 |  |
| mgmt-suspected-cancer-pathway | managementInclude | critical | not run | PASS | NICE NG12 2023; NICE DG56 2023 |  |
| flag-ng12-cancer-screen | redFlags | quality | not run | PASS | NICE NG12 2023 |  |
| flag-fit-read | redFlags | quality | not run | FAIL (known gap) | NICE DG56 2023; ACPGBI/BSG joint guideline 2022 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
| inv-ct-staging | investigationInclude | quality | not run | PASS | NICE NG12 2023 |  |
| mgmt-iron | managementInclude | quality | not run | FAIL (known gap) | BSG guideline 2021 |  |

Failure details:

- **flag-fit-read** (web): no red flag matched among 27 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: No engine reads a FIT result: the lab is recorded but neither the triage cancer screen, clinical prompts nor PANE/CDS use it, and no rule implements the NICE DG56 threshold (≥ 10 µg Hb/g).]
- **mgmt-iron** (web): no management item matched among 36 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No iron replacement output for iron-deficiency anaemia (Hb 10.2, ferritin 9); the colorectal_cancer protocol lists FBC only.]

Guidelines:

- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI (updated 2023): refer on the suspected cancer pathway if FIT ≥ 10 µg Hb/g; offer FIT to adults with symptoms such as change in bowel habit, IDA, weight loss. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*
- **nice-dg56** — NICE DG56 — quantitative FIT to guide colorectal cancer pathway referral in primary care (2023), FIT threshold 10 µg Hb/g faeces for suspected colorectal cancer referral. National Institute for Health and Care Excellence. Quantitative faecal immunochemical testing to guide colorectal cancer pathway referral in primary care (DG56). 2023. *(statement wording/numbering not yet verified against the source)*
- **bsg-acpgbi-fit-2022** — ACPGBI/BSG joint guideline — FIT in patients with signs or symptoms of suspected colorectal cancer (2022), Symptomatic FIT ≥ 10 µg Hb/g → urgent colorectal investigation (colonoscopy or CT colonography). Monahan KJ, Davies MM, Abulafi M, et al. Faecal immunochemical testing (FIT) in patients with signs or symptoms of suspected colorectal cancer (CRC): a joint guideline from the Association of Coloproctology of Great Britain and Ireland (ACPGBI) and the British Society of Gastroenterology (BSG). Gut. 2022;71:1939–1962. *(statement wording/numbering not yet verified against the source)*
- **bsg-ida-2021** — BSG guideline — management of iron deficiency anaemia in adults (2021), Iron replacement alongside investigation. Snook J, Bhala N, Beales ILP, et al. British Society of Gastroenterology guidelines for the management of iron deficiency anaemia in adults. Gut. 2021;70:2030–2051. *(statement wording/numbering not yet verified against the source)*

### Colorectal cancer — FIT-positive, non-specific abdominal pain

#### `crc-fit-positive-abdominal-pain` — FIT ≥ 10 is the only red flag

56-year-old woman with six weeks of vague lower abdominal discomfort, no bleeding, normal bowel habit and normal Hb; FIT 42 µg Hb/g. Under NICE DG56 the FIT alone mandates a suspected cancer referral.

Permutation of `crc-cibh-fit-positive-older`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-crc | mustNotMiss | critical | not run | FAIL (known gap) | NICE DG56 2023 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2023; NICE DG56 2023 |  |
| flag-fit-positive | redFlags | critical | not run | FAIL (known gap) | NICE DG56 2023; ACPGBI/BSG joint guideline 2022 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
| inv-colonoscopy | investigationInclude | critical | not run | FAIL (known gap) | ACPGBI/BSG joint guideline 2022 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
| mgmt-suspected-cancer-pathway | managementInclude | critical | not run | FAIL (known gap) | NICE DG56 2023 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |

Failure details:

- **mnm-crc** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. GORD / Reflux Oesophagitis \| 3. Peptic Ulcer Disease; also in web.symptomInference#3 [known gap: PANE top 3 is cholecystitis/GORD/PUD (the "Acute abdominal pain" template with a suprapubic site gives no colorectal features); the FIT result is not a PANE input. Symptom inference ranks colorectal carcinoma #3.]
- **flag-fit-positive** (web): no red flag matched among 13 (web.triage.reasons, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: No engine reads a FIT result: the lab is recorded but neither the triage cancer screen, clinical prompts nor PANE/CDS use it, and no rule implements the NICE DG56 threshold (≥ 10 µg Hb/g).]
- **inv-colonoscopy** (web): no investigation matched among 23 (web.pane.seeded, web.clinicalPrompts) [known gap: Nothing requests colonoscopy: R19.5 has no protocol and no rule reads the FIT. No engine reads a FIT result: the lab is recorded but neither the triage cancer screen, clinical prompts nor PANE/CDS use it, and no rule implements the NICE DG56 threshold (≥ 10 µg Hb/g).]
- **mgmt-suspected-cancer-pathway** (web): no management item matched among 10 (web.clinicalPrompts) [known gap: No engine reads a FIT result: the lab is recorded but neither the triage cancer screen, clinical prompts nor PANE/CDS use it, and no rule implements the NICE DG56 threshold (≥ 10 µg Hb/g).]

Guidelines:

- **nice-dg56** — NICE DG56 — quantitative FIT to guide colorectal cancer pathway referral in primary care (2023), FIT ≥ 10 µg Hb/g → suspected cancer pathway referral. National Institute for Health and Care Excellence. Quantitative faecal immunochemical testing to guide colorectal cancer pathway referral in primary care (DG56). 2023. *(statement wording/numbering not yet verified against the source)*
- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI (updated 2023): refer adults with FIT ≥ 10 µg Hb/g. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*
- **bsg-acpgbi-fit-2022** — ACPGBI/BSG joint guideline — FIT in patients with signs or symptoms of suspected colorectal cancer (2022), FIT ≥ 10 µg Hb/g → urgent colonic investigation. Monahan KJ, Davies MM, Abulafi M, et al. Faecal immunochemical testing (FIT) in patients with signs or symptoms of suspected colorectal cancer (CRC): a joint guideline from the Association of Coloproctology of Great Britain and Ireland (ACPGBI) and the British Society of Gastroenterology (BSG). Gut. 2022;71:1939–1962. *(statement wording/numbering not yet verified against the source)*

### Iron-deficiency anaemia — occult colorectal cancer

#### `crc-ida-no-gi-symptoms` — Iron-deficiency anaemia, post-menopausal, no GI symptoms

64-year-old post-menopausal woman with fatigue, Hb 9.4, MCV 71, ferritin 5 and no GI symptoms. BSG 2021: bidirectional endoscopy (OGD + colonoscopy) and coeliac serology, regardless of FIT.

Permutation of `crc-cibh-fit-positive-older`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-crc | mustNotMiss | critical | not run | FAIL (known gap) | BSG guideline 2021; NICE NG12 2023 | Add an IDA rule reading Hb + MCV/ferritin (lab results): man or post-menopausal woman → bidirectional endoscopy + coeliac serology (BSG 2021), and age ≥ 60 → suspected colorectal cancer pathway (NG12). |
| flag-ida | redFlags | critical | not run | FAIL (known gap) | BSG guideline 2021; NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | not run | FAIL (known gap) | BSG guideline 2021 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | BSG guideline 2021 |  |
| inv-coeliac | investigationInclude | quality | not run | FAIL (known gap) | BSG guideline 2021 |  |
| mgmt-iron | managementInclude | quality | not run | FAIL (known gap) | BSG guideline 2021 |  |

Failure details:

- **mnm-crc** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. GORD / Reflux Oesophagitis \| 3. Acute Diverticulitis [known gap: PANE has no anaemia/IDA feature and reads no labs; with fatigue/breathlessness only, the top 3 is the default cholecystitis/GORD/diverticulitis. Symptom inference ranks heart failure, anaemia, COPD.]
- **flag-ida** (web): no red flag matched among 13 (web.triage.reasons, web.clinicalPrompts.safety, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: No output mentions iron deficiency: the triage cancer screen’s IDA criterion looks for "anaemia/pale/unusually tired" in symptom chips (no such chip exists) and never reads Hb/ferritin; the prompts fire on Hb only below 8 g/dL.]
...
- **inv-coeliac** (web): no investigation matched among 22 (web.pane.seeded, web.clinicalPrompts) [known gap: No coeliac serology for IDA.]
- **mgmt-iron** (web): no management item matched among 9 (web.clinicalPrompts) [known gap: No iron replacement output.]

Guidelines:

- **bsg-ida-2021** — BSG guideline — management of iron deficiency anaemia in adults (2021), IDA in men and post-menopausal women: bidirectional endoscopy; coeliac serology; iron replacement. Snook J, Bhala N, Beales ILP, et al. British Society of Gastroenterology guidelines for the management of iron deficiency anaemia in adults. Gut. 2021;70:2030–2051. *(statement wording/numbering not yet verified against the source)*
- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI: age ≥ 60 with iron-deficiency anaemia. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*
- **bsg-acpgbi-fit-2022** — ACPGBI/BSG joint guideline — FIT in patients with signs or symptoms of suspected colorectal cancer (2022), IDA is referred irrespective of the FIT result. Monahan KJ, Davies MM, Abulafi M, et al. Faecal immunochemical testing (FIT) in patients with signs or symptoms of suspected colorectal cancer (CRC): a joint guideline from the Association of Coloproctology of Great Britain and Ireland (ACPGBI) and the British Society of Gastroenterology (BSG). Gut. 2022;71:1939–1962. *(statement wording/numbering not yet verified against the source)*

### Lynch syndrome — colonoscopic surveillance

#### `crc-lynch-surveillance-overdue` — 

38-year-old man with MLH1 Lynch syndrome, asymptomatic, last colonoscopy 3 years ago. BSG/ACPGBI/UKCGG 2020: 2-yearly colonoscopy from age 25 (MLH1/MSH2) — he is overdue; aspirin chemoprevention to be discussed.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| flag-lynch | redFlags | critical | not run | FAIL (unverified) | BSG/ACPGBI/UKCGG guidelines 2020 |  |
| inv-colonoscopy | investigationInclude | critical | not run | FAIL (unverified) | BSG/ACPGBI/UKCGG guidelines 2020 |  |
| mgmt-2-yearly | managementInclude | quality | not run | FAIL (known gap) | BSG/ACPGBI/UKCGG guidelines 2020 | Add a hereditary-CRC rule (Lynch/MLH1/MSH2/MSH6/PMS2/FAP in PMH or family history) → colonoscopy every 2 years from 25/35 per gene; aspirin discussion (BSG/ACPGBI/UKCGG 2020). |
| mgmt-aspirin-discussion | managementInclude | quality | not run | FAIL (known gap) | BSG/ACPGBI/UKCGG guidelines 2020 |  |

Failure details:

- **flag-lynch** (web): no red flag matched among 6 (web.triage.reasons, web.clinicalPrompts.safety, web.triage.emergency)
- **inv-colonoscopy** (web): no investigation matched among 13 (web.pane.seeded, web.clinicalPrompts)
- **mgmt-2-yearly** (web): no management item output on web [known gap: No Lynch-specific rule: Z15.09 has no protocol, and the only colorectal family-history prompt (age 35–49, dashboard Family History field) says "colonoscopy 10 years before youngest affected relative, or at 40" with no 2-yearly Lynch interval.]
- **mgmt-aspirin-discussion** (web): no management item output on web [known gap: No aspirin chemoprevention output for Lynch syndrome on any path.]

Guidelines:

- **bsg-hereditary-2020** — BSG/ACPGBI/UKCGG guidelines — management of hereditary colorectal cancer (2020), Lynch syndrome: 2-yearly colonoscopy from age 25 (MLH1, MSH2) or 35 (MSH6, PMS2); aspirin chemoprevention. Monahan KJ, Bradshaw N, Dolwani S, et al. Guidelines for the management of hereditary colorectal cancer from the British Society of Gastroenterology (BSG)/Association of Coloproctology of Great Britain and Ireland (ACPGBI)/United Kingdom Cancer Genetics Group (UKCGG). Gut. 2020;69:411–444. *(statement wording/numbering not yet verified against the source)*

### Colorectal cancer — rectal bleeding with abdominal pain and weight loss, age 52

#### `crc-rectal-bleeding-weight-loss-52` — Age 50–59, no change in bowel habit

52-year-old man with two months of unexplained rectal bleeding mixed with stool, left-sided abdominal pain and 5 kg weight loss; normal bowel habit. NICE NG12: suspected cancer pathway (FIT per DG56).
...
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2023 |  |
| flag-crc | redFlags | critical | not run | PASS | NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | not run | PASS | NICE NG12 2023 |  |
| mgmt-suspected-cancer-pathway | managementInclude | critical | not run | PASS | NICE NG12 2023; NICE DG56 2023 |  |
| flag-ng12-cancer-screen | redFlags | quality | not run | FAIL (known gap) | NICE NG12 2023 | Rewrite cancer-screening.ts lower-GI criteria to current NG12/DG56 (FIT-first; ≥ 50 rectal bleeding; ≥ 40 weight loss + abdominal pain; < 50 rectal bleeding + CIBH/weight loss/IDA; rectal/abdominal mass; IDA ≥ 60). |

Failure details:

- **flag-ng12-cancer-screen** (web): no red flag matched among 3 (web.triage.reasons) [known gap: The triage cancer screen has no "age ≥ 50 with unexplained rectal bleeding" or "age ≥ 40 with weight loss + abdominal pain" rule; its rectal-bleeding rule needs a change in bowel habit (≥ 40, CG27-era wording mislabelled "NICE NG12 1.3.1").]

Guidelines:

- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI: suspected cancer pathway — age ≥ 50 with unexplained rectal bleeding; age ≥ 40 with unexplained weight loss and abdominal pain (2015 criteria; FIT-first since 2023). National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*
- **nice-dg56** — NICE DG56 — quantitative FIT to guide colorectal cancer pathway referral in primary care (2023), FIT to guide referral in symptomatic adults. National Institute for Health and Care Excellence. Quantitative faecal immunochemical testing to guide colorectal cancer pathway referral in primary care (DG56). 2023. *(statement wording/numbering not yet verified against the source)*

### Rectal cancer — palpable rectal mass with a negative FIT

#### `crc-rectal-mass-fit-negative` — FIT < 10 but rectal mass on DRE

71-year-old man with tenesmus and a hard irregular rectal mass 6 cm from the anal verge; FIT 6 µg Hb/g. A rectal mass is referred regardless of the FIT (BSG/ACPGBI 2022); MRI pelvis for local staging.

Permutation of `crc-cibh-fit-positive-older`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-rectal-cancer-top3 | mustRankTopK | critical | not run | FAIL (known gap) | NICE NG12 2023 | Add CC_HINTS for "Change in bowel habit" (change_bowel_habit) and "Rectal bleeding" (pr_bleeding), map the "Rectum"/"Anal canal" site chips, and add a rectal-mass feature fed by the examination. |
| level-at-least-priority | emergencyLevel | critical | not run | PASS | ACPGBI/BSG joint guideline 2022 |  |
| flag-rectal-mass | redFlags | critical | not run | PASS | ACPGBI/BSG joint guideline 2022; NICE NG12 2023 |  |
| inv-mri-pelvis | investigationInclude | critical | not run | PASS | NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | quality | not run | PASS | ACPGBI/BSG joint guideline 2022 |  |
| mgmt-mdt | managementInclude | quality | not run | PASS | NICE NG12 2023 |  |

Failure details:

- **dx-rectal-cancer-top3** (web): not in top 3 of web.pane: 1. Inguinal / Femoral Hernia \| 2. GORD / Reflux Oesophagitis \| 3. Acute Cholecystitis [known gap: PANE top 3 is inguinal hernia/GORD/cholecystitis: the "Change in bowel habit" template has no CC_HINTS entry, the "Rectum" site chip does not match the \brectal\b rule, and a DRE mass is not a PANE feature. Symptom inference ranks rectal prolapse, IBD, haemorrhoids.]

Guidelines:

- **bsg-acpgbi-fit-2022** — ACPGBI/BSG joint guideline — FIT in patients with signs or symptoms of suspected colorectal cancer (2022), Patients with a rectal or abdominal mass, anal ulceration or IDA are referred irrespective of the FIT result. Monahan KJ, Davies MM, Abulafi M, et al. Faecal immunochemical testing (FIT) in patients with signs or symptoms of suspected colorectal cancer (CRC): a joint guideline from the Association of Coloproctology of Great Britain and Ireland (ACPGBI) and the British Society of Gastroenterology (BSG). Gut. 2022;71:1939–1962. *(statement wording/numbering not yet verified against the source)*
- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI: consider suspected cancer pathway referral for a rectal or abdominal mass. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*

### Colorectal cancer screening — average-to-moderate risk, African-Caribbean

#### `crc-screening-african-caribbean-fhx` — No symptoms; father CRC at 58; no national programme

47-year-old St Lucian man of African-Caribbean descent, asymptomatic, father had colorectal cancer at 58, asks about screening. There is no national bowel screening programme in Saint Lucia; USPSTF 2021 starts average-risk screening at 45; ACG 2021 recommends colonoscopy from 40, 5-yearly, for one FDR diagnosed < 60. BSG 2020 would not add colonoscopy for one FDR diagnosed ≥ 50.

Permutation of `crc-lynch-surveillance-overdue`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-routine | emergencyLevel | quality | not run | FAIL (known gap) | USPSTF recommendation statement 2021 |  |
| mgmt-screening-offered | managementInclude | quality | not run | FAIL (unverified) | USPSTF recommendation statement 2021; ACG clinical guidelines 2021 |  |
...
- **mgmt-screening-offered** (web): no management item matched among 4 (web.clinicalPrompts)

Guidelines:

- **uspstf-2021** — USPSTF recommendation statement — screening for colorectal cancer (2021), Screen adults aged 45–49 (grade B) and 50–75 (grade A). US Preventive Services Task Force. Screening for colorectal cancer: US Preventive Services Task Force recommendation statement. JAMA. 2021;325:1965–1977. *(statement wording/numbering not yet verified against the source)*
- **acg-screen-2021** — ACG clinical guidelines — colorectal cancer screening (2021), Average risk: start at 45; one FDR with CRC or advanced adenoma diagnosed < 60, or two FDRs: colonoscopy from 40 (or 10 years before the youngest affected relative) every 5 years. Shaukat A, Kahi CJ, Burke CA, et al. ACG clinical guidelines: colorectal cancer screening 2021. Am J Gastroenterol. 2021;116:458–479. *(statement wording/numbering not yet verified against the source)*
- **bsg-hereditary-2020** — BSG/ACPGBI/UKCGG guidelines — management of hereditary colorectal cancer (2020), Moderate-risk family history thresholds (one FDR < 50, or two FDRs) for UK colonoscopic surveillance. Monahan KJ, Bradshaw N, Dolwani S, et al. Guidelines for the management of hereditary colorectal cancer from the British Society of Gastroenterology (BSG)/Association of Coloproctology of Great Britain and Ireland (ACPGBI)/United Kingdom Cancer Genetics Group (UKCGG). Gut. 2020;69:411–444. *(statement wording/numbering not yet verified against the source)*

### Young-onset colorectal cancer

#### `crc-young-onset-34` — Age 34, attributed to piles

34-year-old man with four months of blood mixed with stool, looser stools, 6 kg weight loss and Hb 11.1, previously told he had piles. NICE NG12 (under 50 with rectal bleeding plus CIBH, weight loss or IDA): consider suspected cancer referral; colonoscopy.

Permutation of `crc-cibh-fit-positive-older`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-crc | mustNotMiss | critical | not run | PASS | NICE NG12 2023 |  |
| flag-crc | redFlags | critical | not run | PASS | NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | not run | PASS | NICE NG12 2023 |  |
| mnm-ibd | mustNotMiss | quality | not run | PASS | NICE NG12 2023 |  |
| mgmt-suspected-cancer-pathway | managementInclude | quality | not run | PASS | NICE NG12 2023 |  |

Guidelines:

- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI: consider suspected cancer referral in adults under 50 with rectal bleeding and any of abdominal pain, change in bowel habit, weight loss, IDA. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*
- **bsg-acpgbi-fit-2022** — ACPGBI/BSG joint guideline — FIT in patients with signs or symptoms of suspected colorectal cancer (2022), FIT is not a rule-out in patients with persisting concerning symptoms. Monahan KJ, Davies MM, Abulafi M, et al. Faecal immunochemical testing (FIT) in patients with signs or symptoms of suspected colorectal cancer (CRC): a joint guideline from the Association of Coloproctology of Great Britain and Ireland (ACPGBI) and the British Society of Gastroenterology (BSG). Gut. 2022;71:1939–1962. *(statement wording/numbering not yet verified against the source)*

### Crohn’s disease with ileocaecal abscess

#### `crohns-ileocaecal-abscess` — 

24-year-old man with ileocolonic Crohn’s on adalimumab and azathioprine: 5 days RIF pain, fever 38.7, tender mass; CT 4.5 cm ileocaecal abscess. IV antibiotics and percutaneous drainage, hold the biologic, avoid systemic steroids with an undrained abscess, then plan (delayed) ileocaecal resection.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-admit | emergencyLevel | critical | not run | PASS | ECCO guidelines on therapeutics in Crohn’s disease 2020 |  |
| mgmt-drainage | managementInclude | critical | not run | FAIL (known gap) | ECCO guidelines on therapeutics in Crohn’s disease 2020 | Add "intra-abdominal abscess: IV antibiotics + percutaneous drainage, then delayed resection; wean steroids" to the crohns_disease protocol (ECCO 2020). |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | ECCO guidelines on therapeutics in Crohn’s disease 2020 |  |
| mgmt-no-appendicectomy | managementExclude | critical | not run | FAIL (known gap) | ECCO guidelines on therapeutics in Crohn’s disease 2020 | Gate the appendicectomy operative-plan prompt on the confirmed working diagnosis (appendicitis) or imaging, not on the words "guarding"/"rebound"; add negation handling (no/without/absent) to exam() matching. |
| mgmt-no-steroids | managementExclude | critical | not run | FAIL (known gap) | ECCO guidelines on therapeutics in Crohn’s disease 2020 | Condition the Crohn’s steroid medications on "no abscess/sepsis" and add an explicit caution (ECCO 2020). |
| dx-crohn-top3 | mustRankTopK | quality | not run | PASS | ECCO guidelines on therapeutics in Crohn’s disease 2020 |  |
| no-alarm-pneumoperitoneum | mustNotAlarm | quality | not run | FAIL (known gap) | ECCO guidelines on therapeutics in Crohn’s disease 2020 | Add negation handling to hasRadResult (no/without/absent … free gas/free air). |
| flag-immunosuppressed | redFlags | quality | not run | FAIL (known gap) | ECCO guidelines on therapeutics in Crohn’s disease 2020 |  |
| mgmt-resection-plan | managementInclude | quality | not run | PASS | ECCO guidelines on therapeutics in Crohn’s disease 2020 |  |

Failure details:

- **no-alarm-pneumoperitoneum** (web): forbidden alarm present in web.clinicalPrompts.safety: "pneumoperitoneum on imaging - pneumoperitoneum → emergency laparotomy" [known gap: computeClinicalPrompts "Pneumoperitoneum on imaging → emergency laparotomy" fires on the CT text "No free gas" (hasRadResult substring match, no negation).]
- **flag-immunosuppressed** (web): no red flag matched among 24 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety, web.triage.emergency) [known gap: Adalimumab/azathioprine are not surfaced as immunosuppression (the triage comorbidity regex looks for "immunosuppressed/steroid/chemotherapy" in the comorbidity text only).]
...
- **ecco-cd-surg-2020** — ECCO guidelines on therapeutics in Crohn’s disease — surgical treatment (2020), Intra-abdominal abscess: antibiotics + percutaneous drainage, then delayed resection; steroids increase post-operative complications and should be weaned before surgery. Adamina M, Bonovas S, Raine T, et al. ECCO guidelines on therapeutics in Crohn’s disease: surgical treatment. J Crohns Colitis. 2020;14:155–168. *(statement wording/numbering not yet verified against the source)*
- **bsg-ibd-2019** — BSG consensus guidelines — management of inflammatory bowel disease in adults (2019), Exclude abscess before starting or continuing anti-TNF; drain sepsis first. Lamb CA, Kennedy NA, Raine T, et al. British Society of Gastroenterology consensus guidelines on the management of inflammatory bowel disease in adults. Gut. 2019;68(Suppl 3):s1–s106. *(statement wording/numbering not yet verified against the source)*

### Perianal Crohn’s disease — complex fistula with abscess

#### `crohns-perianal-complex-fistula` — Perianal disease, complex fistula

31-year-old woman with Crohn’s colitis, perianal pain and purulent discharge from two external openings with a fluctuant posterior swelling. EUA, drainage and loose seton; MRI pelvis; then anti-TNF. No fistulotomy of a complex Crohn’s fistula and no sphincterotomy.

Permutation of `crohns-ileocaecal-abscess`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-same-day | emergencyLevel | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| inv-mri-pelvis | investigationInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022; BSG consensus guidelines 2019 |  |
| mgmt-eua-seton | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022; BSG consensus guidelines 2019 |  |
| mgmt-drainage | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-no-fistulotomy | managementExclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022; BSG consensus guidelines 2019 |  |
| mgmt-no-sphincterotomy | managementExclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| dx-perianal-sepsis-top3 | mustRankTopK | quality | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-biologic | managementInclude | quality | not run | PASS | BSG consensus guidelines 2019 |  |

Guidelines:

- **ascrs-abscess-2022** — ASCRS clinical practice guidelines — anorectal abscess, fistula-in-ano and rectovaginal fistula (2022), Abscess: prompt drainage. Crohn’s fistula: loose seton for complex disease; MRI or EUS to define anatomy; fistulotomy only for simple, low fistulas. Gaertner WB, Burgess PL, Davids JS, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of anorectal abscess, fistula-in-ano, and rectovaginal fistula. Dis Colon Rectum. 2022;65:964–985. *(statement wording/numbering not yet verified against the source)*
- **bsg-ibd-2019** — BSG consensus guidelines — management of inflammatory bowel disease in adults (2019), Perianal Crohn’s: MRI pelvis; EUA, drainage and seton; anti-TNF after sepsis control. Lamb CA, Kennedy NA, Raine T, et al. British Society of Gastroenterology consensus guidelines on the management of inflammatory bowel disease in adults. Gut. 2019;68(Suppl 3):s1–s106. *(statement wording/numbering not yet verified against the source)*

### Acute diverticulitis

#### `diverticulitis-uncomplicated-outpatient` — Uncomplicated, immunocompetent, outpatient (base case)

54-year-old man, 2 days of LIF pain, T 37.8 °C, tolerating oral intake, WBC 12.4, CRP 88; CT: uncomplicated sigmoid diverticulitis. Colonoscopy 3 years ago.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-diverticulitis-top3 | mustRankTopK | critical | not run | FAIL (known gap) | WSES guidelines 2020 |  |
| level-same-day-not-emergency | emergencyLevel | quality | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| inv-ct | investigationInclude | quality | not run | PASS | WSES guidelines 2020 |  |
| mgmt-selective-antibiotics | managementInclude | quality | not run | FAIL (known gap) | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 | Update the uncomplicated step to WSES 2020 / AGA 2021: antibiotics selectively; observation without antibiotics in immunocompetent patients without systemic features. |
| mgmt-no-routine-antibiotics | managementExclude | quality | not run | FAIL (known gap) | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-uncomplicated | dxVariant | quality | not run | FAIL (known gap) | WSES guidelines 2020 |  |

Failure details:

- **dx-diverticulitis-top3** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Inguinal / Femoral Hernia \| 3. Acute Appendicitis; also in web.symptomInference#2, web.triageSurgical#1 [known gap: Web: PANE top 3: cholecystitis (0.13), inguinal/femoral hernia, appendicitis, with lif_pain, nausea_vomiting and fever all extracted — LIF pain does not bring diverticulitis into the top 3. Symptom inference ranks diverticulitis #2.]
- **mgmt-selective-antibiotics** (web): no management item matched among 43 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No antibiotic-free option; protocol and variant prescribe co-amoxiclav for 5–7 days.]
...
- **wses-diverticulitis-2020** — WSES guidelines — acute colonic diverticulitis in the emergency setting (2020 update) (2020), CT staging (WSES CT classification); uncomplicated: antibiotics not always needed in immunocompetent patients, outpatient care; abscess >4–5 cm: percutaneous drainage + antibiotics; generalised peritonitis: emergency surgery (Hartmann's or resection with primary anastomosis ± stoma); immunocompromised: high risk, antibiotics, low threshold for surgery. Sartelli M, Weber DG, Kluger Y, et al. 2020 update of the WSES guidelines for the management of acute colonic diverticulitis in the emergency setting. World J Emerg Surg. 2020;15:32. *(statement wording/numbering not yet verified against the source)*
- **aga-2021** — AGA clinical practice update — medical management of colonic diverticulitis (2021), Antibiotics used selectively rather than routinely in immunocompetent patients with mild uncomplicated diverticulitis; CT when diagnosis uncertain; colonoscopy after complicated diverticulitis or if not recently done. Peery AF, Shaukat A, Strate LL. AGA clinical practice update on medical management of colonic diverticulitis: expert review. Gastroenterology. 2021;160:906–11.e1. *(statement wording/numbering not yet verified against the source)*
- **ascrs-diverticulitis-2020** — ASCRS clinical practice guidelines — left-sided colonic diverticulitis (2020), Selective antibiotics for uncomplicated disease; percutaneous drainage for large abscess; urgent colectomy for diffuse peritonitis; immunocompromised patients; colonoscopy after complicated disease. Hall J, Hardiman K, Lee S, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the treatment of left-sided colonic diverticulitis. Dis Colon Rectum. 2020;63:728–47. *(statement wording/numbering not yet verified against the source)*

#### `diverticulitis-abscess-drainage` — Complicated: 6 cm pericolic abscess (modified Hinchey Ib)

63-year-old man, 5 days of LIF pain with fever 38.3 °C, tender LIF mass, WBC 17.8, CRP 212; CT: 6 × 5 cm pericolic abscess, no free gas.

Permutation of `diverticulitis-uncomplicated-outpatient`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-diverticulitis-top3 | mustRankTopK | critical | not run | PASS | WSES guidelines 2020 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| mgmt-iv-antibiotics | managementInclude | critical | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| mgmt-drainage | managementInclude | critical | not run | PASS | WSES guidelines 2020; ASCRS clinical practice guidelines 2020 |  |
| mgmt-drainage-in-documented-plan | managementInclude | critical | not run | FAIL (known gap) | WSES guidelines 2020 | Use the modified Hinchey scale in dx-variants: move 'hinchey ib' to the abscess variant, use word-boundary matching (so 'hinchey i' does not match 'hinchey ii/iii/iv') and check peritonitis → abscess → uncomplicated. |
| inv-blood-cultures | investigationInclude | quality | not run | PASS |  |  |
| inv-colonoscopy-after | investigationInclude | quality | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021 |  |
| variant-abscess | dxVariant | quality | not run | FAIL (known gap) | WSES guidelines 2020; Modified Hinchey classification 1999 |  |

Failure details:

- **mgmt-drainage-in-documented-plan** (web): no management item matched among 13 (web.plan) [known gap: Web: Assessment says 'modified Hinchey Ib'; the uncomplicated variant lists 'hinchey ib' (in the modified Hinchey scale Ib is a pericolic abscess) and is checked first, so the documented plan is the outpatient oral co-amoxiclav plan with no drainage.]
- **variant-abscess** (web): detected diverticulitis_uncomplicated in group Diverticulitis; expected diverticulitis_abscess [known gap: Web: 'hinchey ib' is a keyword of diverticulitis_uncomplicated.]
...
#### `diverticulitis-faecal-peritonitis-shock` — Hinchey IV with septic shock (elderly, diabetic)

71-year-old diabetic woman found collapsed, T 38.9 °C, HR 132, BP 78/44 on noradrenaline, lactate 6.1, WBC 2.8; CT: faecal peritonitis from a perforated sigmoid.

Permutation of `diverticulitis-uncomplicated-outpatient`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | PASS | Surviving Sepsis Campaign 2021; WSES guidelines 2020 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| alarm-shock | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| inv-blood-cultures | investigationInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-hartmanns-or-damage-control | managementInclude | critical | not run | PASS | WSES guidelines 2020 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-icu | managementInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-no-primary-anastomosis-in-shock | managementExclude | quality | not run | PASS | WSES guidelines 2020 |  |
| variant-peritonitis | dxVariant | quality | not run | FAIL (known gap) | WSES guidelines 2020; Modified Hinchey classification 1999 |  |

Failure details:

- **variant-peritonitis** (web): detected diverticulitis_abscess in group Diverticulitis; expected diverticulitis_peritonitis [known gap: Web: Substring 'hinchey i' ⊂ 'hinchey iv' selects diverticulitis_abscess.]
...
#### `diverticulitis-immunosuppressed` — Immunosuppressed (renal transplant, steroids), mild symptoms

67-year-old renal transplant recipient on tacrolimus, mycophenolate and prednisolone, 2 days of mild LIF discomfort, T 37.5 °C, WBC 9.8, CRP 74; CT: pericolic gas bubbles, no abscess.
...
| dx-diverticulitis-top3 | mustRankTopK | critical | not run | PASS | WSES guidelines 2020 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| mgmt-no-antibiotic-free-outpatient | managementExclude | critical | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| flag-immunosuppression | redFlags | quality | not run | FAIL (known gap) | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| mgmt-admit-iv | managementInclude | quality | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| mgmt-no-oral-outpatient-plan | managementExclude | quality | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |

Failure details:

- **flag-immunosuppression** (web): no red flag matched among 21 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative) [known gap: Web: Triage counts 'Higher-risk comorbidity' but no red flag or prompt names immunosuppression as a reason not to treat as an outpatient.]
...
#### `diverticulitis-purulent-peritonitis` — Perforated, purulent peritonitis (Hinchey III)

59-year-old man, sudden generalised peritonitis after 3 days of LIF pain, T 38.7 °C, HR 116, BP 118/70; CT: free gas and generalised fluid, no faecal contamination.
...
|---|---|---|---|---|---|---|
| dx-diverticulitis-top3 | mustRankTopK | critical | not run | FAIL (known gap) | WSES guidelines 2020 |  |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES guidelines 2020; AGA clinical practice update 2021; ASCRS clinical practice guidelines 2020 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| alarm-perforation | mustAlarm | critical | not run | PASS | WSES guidelines 2020 |  |
| mgmt-emergency-surgery | managementInclude | critical | not run | PASS | WSES guidelines 2020 |  |
| mgmt-emergency-surgery-in-documented-plan | managementInclude | critical | not run | FAIL (known gap) | WSES guidelines 2020 | Word-boundary Hinchey matching and specific-first variant order (peritonitis before abscess). |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | WSES guidelines 2020 |  |
| inv-blood-cultures | investigationInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-primary-anastomosis-option | managementInclude | quality | not run | PASS | WSES guidelines 2020 |  |
| variant-peritonitis | dxVariant | quality | not run | FAIL (known gap) | WSES guidelines 2020; Modified Hinchey classification 1999 |  |

Failure details:

- **dx-diverticulitis-top3** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Inguinal / Femoral Hernia \| 3. Acute Appendicitis; also in web.symptomInference#2, web.triageSurgical#1 [known gap: Web: PANE top 3: cholecystitis, inguinal/femoral hernia, appendicitis (features lif_pain, nausea_vomiting, fever) — the same likelihood problem as the base case.]
- **mgmt-emergency-surgery-in-documented-plan** (web): no management item matched among 14 (web.plan) [known gap: Web: 'hinchey iii' contains the abscess keyword 'hinchey i', and the abscess variant is checked before the peritonitis variant, so the documented plan (immediate/conservative/follow-up phases) has no emergency operation — only 'interval sigmoid colectomy 6–8 weeks'.]
- **variant-peritonitis** (web): detected diverticulitis_abscess in group Diverticulitis; expected diverticulitis_peritonitis [known gap: Web: Substring 'hinchey i' ⊂ 'hinchey iii' selects diverticulitis_abscess.]
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-dyspepsia-causes-top3 | mustRankTopK | quality | not run | PASS | NICE CG184 2014 |  |
| level-routine | emergencyLevel | quality | not run | FAIL (known gap) | NICE CG184 2014 | adaptive-triage: negation handling (see gord-no-alarm-empirical-ppi). |
| no-cancer-alarm | mustNotAlarm | quality | not run | PASS | NICE NG12 2015 |  |
| inv-hpylori-non-invasive | investigationInclude | quality | not run | FAIL (known gap) | NICE CG184 2014; Maastricht VI/Florence consensus report 2022 | Add a dyspepsia (K30/R10.13) protocol: CG184 test-and-treat or 4-week PPI; NG12 alarm check. |
| inv-no-urgent-ogd | investigationExclude | quality | not run | PASS | NICE CG184 2014; NICE NG12 2015 |  |
| mgmt-test-and-treat-or-ppi | managementInclude | quality | not run | PASS | NICE CG184 2014; Maastricht VI/Florence consensus report 2022 |  |
| mgmt-lifestyle | managementInclude | quality | not run | PASS | NICE CG184 2014 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-oesophageal-cancer-top3 | mustRankTopK | critical | not run | FAIL (known gap) | NICE NG12 2015 | socrates-to-features.ts: CC hint /dysphag\|swallow/ → dysphagia_progressive; pane-engine: age ≥55 modifier for oesophageal/gastric carcinoma. |
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2015 |  |
| flag-dysphagia-cancer | redFlags | critical | not run | PASS | NICE NG12 2015 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | NICE NG12 2015 |  |
| flag-weight-loss | redFlags | quality | not run | PASS | NICE NG12 2015 |  |
| inv-staging-ct | investigationInclude | quality | not run | PASS | NICE NG12 2015 |  |
| mgmt-urgent-two-week-ogd | managementInclude | quality | not run | PASS | NICE NG12 2015 |  |
| mgmt-no-empirical-ppi-only | managementExclude | quality | not run | PASS | NICE CG184 2014 |  |
...
| flag-dysphagia | redFlags | critical | not run | PASS | NICE NG12 2015 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | NICE NG12 2015 |  |
| dx-stricture-or-gord-top3 | mustRankTopK | quality | not run | PASS | NICE CG184 2014 |  |
| mnm-malignancy | mustNotMiss | quality | not run | FAIL (known gap) | NICE NG12 2015 | socrates-to-features.ts: CC hint /dysphag\|swallow/ → dysphagia_progressive (and dysphagia). |
| mgmt-no-age-gated-ogd | managementExclude | quality | not run | PASS | NICE NG12 2015 |  |
...
|---|---|---|---|---|---|---|
| flag-dysphagia | redFlags | critical | not run | PASS | NICE NG12 2015 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | BSG/BSPGHAN joint consensus guidelines 2022; NICE NG12 2015 |  |
| inv-oesophageal-biopsies | investigationInclude | critical | not run | FAIL (known gap) | BSG/BSPGHAN joint consensus guidelines 2022 | Add a K20 (EoE) protocol; add "biopsies (≥6, two levels)" to every dysphagia OGD line. |
| mnm-eoe | mustNotMiss | quality | not run | FAIL (known gap) | BSG/BSPGHAN joint consensus guidelines 2022 | Add an EoE node (young, atopy, intermittent solid dysphagia, bolus episodes) and a K20.0 protocol (≥6 biopsies from ≥2 levels; PPI / budesonide / diet; dilatation). |
| level-priority-not-emergency | emergencyLevel | quality | not run | FAIL (known gap) | NICE NG12 2015 | cancer-screening.ts: parenthesise the colorectal cancerType condition (c.met && (… \|\| … )); dysphagia should give priority, not emergency_now, when the patient is swallowing. |
| inv-six-biopsies-two-levels | investigationInclude | quality | not run | FAIL (known gap) | BSG/BSPGHAN joint consensus guidelines 2022 |  |
| mgmt-eoe-treatment-options | managementInclude | quality | not run | FAIL (known gap) | BSG/BSPGHAN joint consensus guidelines 2022 |  |
...
#### `fistula-in-ano-complex-anterior-female` — Complex: anterior, female, high transsphincteric, obstetric injury

38-year-old woman with an anterior fistula after two vaginal deliveries (one third-degree tear); probe suggests a high transsphincteric tract. MRI pelvis to map the tract; loose seton / sphincter-preserving repair; no primary fistulotomy.

Permutation of `fistula-in-ano-simple-low`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| inv-mri-pelvis | investigationInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-seton-or-sparing | managementInclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2022 |  |
| mgmt-no-primary-fistulotomy | managementExclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-no-sphincterotomy | managementExclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2022 |  |
...
- **ascrs-abscess-2022** — ASCRS clinical practice guidelines — anorectal abscess, fistula-in-ano and rectovaginal fistula (2022), Complex fistula (anterior in women, high transsphincteric, pre-existing incontinence): imaging and sphincter-preserving repair; avoid fistulotomy. Gaertner WB, Burgess PL, Davids JS, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of anorectal abscess, fistula-in-ano, and rectovaginal fistula. Dis Colon Rectum. 2022;65:964–985. *(statement wording/numbering not yet verified against the source)*

### Fistula-in-ano — simple, low intersphincteric

#### `fistula-in-ano-simple-low` — 

45-year-old man with recurrent discharge from an external opening 2 cm from the anal verge six months after a drained abscess; palpable cord to 7 o’clock. Simple low (Parks intersphincteric) fistula: fistulotomy. Not an anal fissure.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mgmt-fistulotomy | managementInclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2022 | Add a fistula-in-ano protocol keyed to K60.3–K60.5 (simple → fistulotomy; complex → MRI, loose seton, sphincter-preserving repair; Parks classification) and narrow anal_fissure to K60.0–K60.2. |
| mgmt-no-fissure-plan | managementExclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2022 |  |
| dx-fistula-top3 | mustRankTopK | quality | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
...
- **ascrs-abscess-2022** — ASCRS clinical practice guidelines — anorectal abscess, fistula-in-ano and rectovaginal fistula (2022), Parks classification (Parks AG, Gordon PH, Hardcastle JD. Br J Surg 1976;63:1–12): inter-, trans-, supra-, extrasphincteric. Simple fistula-in-ano: fistulotomy; complex fistula: sphincter-preserving options; MRI/EUS for complex or recurrent disease. Gaertner WB, Burgess PL, Davids JS, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of anorectal abscess, fistula-in-ano, and rectovaginal fistula. Dis Colon Rectum. 2022;65:964–985. *(statement wording/numbering not yet verified against the source)*
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | FAIL (known gap) | ESGE Clinical Guideline 2016 | rules.ts RED_FLAGS: add /(can.?t\|unable to\|cannot) swallow (saliva\|spit\|anything)\|drooling\|food (stuck\|bolus)/ → urgent (emergency_now). |
| inv-emergency-ogd | investigationInclude | critical | not run | PASS | ESGE Clinical Guideline 2016; WSES guidelines 2019 |  |
| mgmt-endoscopic-removal | managementInclude | critical | not run | FAIL (known gap) | ESGE Clinical Guideline 2016 | Add a food-bolus protocol (ESGE 2016: emergent OGD ≤6 h if complete obstruction; push/retrieve; biopsies; no barium). |
| flag-complete-obstruction | redFlags | quality | not run | FAIL (known gap) | ESGE Clinical Guideline 2016 |  |
| mgmt-biopsies-underlying-cause | managementInclude | quality | not run | FAIL (known gap) | ESGE Clinical Guideline 2016; BSG/BSPGHAN joint consensus guidelines 2022 |  |
| mgmt-no-barium | managementExclude | quality | not run | PASS | ESGE Clinical Guideline 2016 |  |
...
### Fournier’s gangrene (necrotising soft-tissue infection of the perineum)

#### `fournier-gangrene` — 

61-year-old man with diabetes: 3 days of perineal and scrotal pain and swelling, crepitus, dusky skin, T 38.9, HR 118, BP 94/60, glucose 24, WBC 24, Na 131, creatinine 160, CRP 280. Must not miss: resuscitation, broad-spectrum IV antibiotics and emergency radical debridement.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-nsti-top3 | mustRankTopK | critical | not run | FAIL (known gap) | WSES/SIS-E consensus 2018 | Add Fournier’s gangrene as a PANE disease (or map perineal site + crepitus/necrosis/pain-out-of-proportion + SIRS to necrotising_fasciitis) and give N49.3/perineal NSTI the necrotising_fasciitis protocol; add a safety prompt for "perianal/perineal infection + pain out of proportion or spreading to scrotum/perineum + SIRS" → emergency surgical exploration. |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES/SIS-E consensus 2018 |  |
| alarm-nsti-or-sepsis | mustAlarm | critical | not run | PASS | WSES/SIS-E consensus 2018 |  |
| mgmt-debridement | managementInclude | critical | not run | FAIL (known gap) | WSES/SIS-E consensus 2018 | Add Fournier’s gangrene as a PANE disease (or map perineal site + crepitus/necrosis/pain-out-of-proportion + SIRS to necrotising_fasciitis) and give N49.3/perineal NSTI the necrotising_fasciitis protocol; add a safety prompt for "perianal/perineal infection + pain out of proportion or spreading to scrotum/perineum + SIRS" → emergency surgical exploration. |
| mgmt-broad-abx | managementInclude | critical | not run | PASS | WSES/SIS-E consensus 2018 |  |
| score-rec-lrinec | scoreRecommended | quality | not run | FAIL (known gap) | LRINEC score (Laboratory Risk Indicator for Necrotizing Fasciitis) 2004; WSES/SIS-E consensus 2018 |  |
| score-qsofa-calculator | scoreValue | quality | not run | n/a | WSES/SIS-E consensus 2018 |  |

Failure details:

- **dx-nsti-top3** (web): not in top 3 of web.pane: 1. Acute Cholangitis \| 2. Perianal Abscess / Fistula \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#1 [known gap: PANE’s necrotising_fasciitis disease is not reached from perineal presentations (the only anorectal features are anal_pain/perianal_swelling; the CC template is generic; crepitus/erythema answers do not outweigh the anorectal priors); symptom inference does rank Fournier’s first, but it is a secondary view.]
- **score-rec-lrinec** (web): lrinec not recommended; recommended: qsofa, gcs, child-pugh, web:wagner, news2, caprini, asa, web:audit, rcri, stop-bang, cfs [known gap: No LRINEC calculator or CDS rule on web (Wagner and AUDIT are suggested instead).]
- **mgmt-debridement** (web): no management item matched among 27 (web.clinicalPrompts) [known gap: N49.3 (Fournier gangrene) has no protocol (necrotising_fasciitis is keyed to M72.6), so no plan contains debridement; the sepsis prompt gives antibiotics only.]

Guidelines:

- **wses-ssti-2018** — WSES/SIS-E consensus — management of skin and soft-tissue infections (incl. necrotising soft-tissue infection, Fournier’s gangrene) (2018), Necrotising soft-tissue infection/Fournier’s gangrene: early aggressive surgical debridement, broad-spectrum antibiotics, resuscitation; LRINEC should not be used to rule out. Sartelli M, Guirao X, Hardcastle TC, et al. 2018 WSES/SIS-E consensus conference: recommendations for the management of skin and soft-tissue infections. World J Emerg Surg. 2018;13:58. *(statement wording/numbering not yet verified against the source)*
- **wong-lrinec-2004** — LRINEC score (Laboratory Risk Indicator for Necrotizing Fasciitis) (2004), LRINEC items: CRP, WBC, Hb, Na, creatinine, glucose. Wong CH, Khin LW, Heng KS, Tan KC, Low CO. The LRINEC score: a tool for distinguishing necrotizing fasciitis from other soft tissue infections. Crit Care Med. 2004;32:1535–1541. *(statement wording/numbering not yet verified against the source)*

### Early Fournier’s gangrene presenting as a perianal abscess (SGLT2 inhibitor)

#### `fournier-sglt2-early-mimic` — Early, no crepitus, on empagliflozin — dangerous mimic of a perianal abscess

57-year-old man with diabetes on empagliflozin referred as a "perianal abscess": pain out of proportion, erythema spreading onto the scrotum within 12 h, T 38.3, HR 114, CRP 240, Na 132. No crepitus yet. Early NSTI must be suspected; surgical exploration, not simple drainage in clinic.

Permutation of `fournier-gangrene`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-nsti | mustNotMiss | critical | not run | FAIL (known gap) | WSES/SIS-E consensus 2018 | Add Fournier’s gangrene as a PANE disease (or map perineal site + crepitus/necrosis/pain-out-of-proportion + SIRS to necrotising_fasciitis) and give N49.3/perineal NSTI the necrotising_fasciitis protocol; add a safety prompt for "perianal/perineal infection + pain out of proportion or spreading to scrotum/perineum + SIRS" → emergency surgical exploration. |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES/SIS-E consensus 2018 |  |
| mgmt-exploration | managementInclude | critical | not run | FAIL (known gap) | WSES/SIS-E consensus 2018 | Add Fournier’s gangrene as a PANE disease (or map perineal site + crepitus/necrosis/pain-out-of-proportion + SIRS to necrotising_fasciitis) and give N49.3/perineal NSTI the necrotising_fasciitis protocol; add a safety prompt for "perianal/perineal infection + pain out of proportion or spreading to scrotum/perineum + SIRS" → emergency surgical exploration. |
| flag-sglt2 | redFlags | quality | not run | FAIL (known gap) | MHRA Drug Safety Update 2019 | Add an SGLT2-inhibitor medication flag for perineal/genital infection (MHRA 2019). |
...
- **wses-ssti-2018** — WSES/SIS-E consensus — management of skin and soft-tissue infections (incl. necrotising soft-tissue infection, Fournier’s gangrene) (2018), Early NSTI: clinical suspicion (pain out of proportion, rapid spread, systemic toxicity) → surgical exploration without waiting for imaging. Sartelli M, Guirao X, Hardcastle TC, et al. 2018 WSES/SIS-E consensus conference: recommendations for the management of skin and soft-tissue infections. World J Emerg Surg. 2018;13:58. *(statement wording/numbering not yet verified against the source)*
- **mhra-sglt2-2019** — MHRA Drug Safety Update — SGLT2 inhibitors: reports of Fournier’s gangrene (2019), Fournier’s gangrene reported with SGLT2 inhibitors: stop the drug and treat urgently. Medicines and Healthcare products Regulatory Agency. SGLT2 inhibitors: reports of Fournier’s gangrene (necrotising fasciitis of the genitalia or perineum). Drug Safety Update, February 2019 (also US FDA Drug Safety Communication, August 2018). *(statement wording/numbering not yet verified against the source)*
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-goo-top3 | mustRankTopK | critical | not run | FAIL (known gap) | NICE NG12 2015 | socrates-to-features.ts: map "projectile\|undigested\|succussion" → vomiting_effortless; feed symptomDetails (vomiting: Projectile) to PANE. |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | NICE NG12 2015 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | NICE NG12 2015 |  |
| mgmt-ng-decompression | managementInclude | critical | not run | PASS | NICE NG12 2015 |  |
| mgmt-iv-saline-potassium | managementInclude | critical | not run | PASS | NICE NG12 2015 |  |
| mnm-malignancy | mustNotMiss | quality | not run | FAIL (known gap) | NICE NG12 2015 |  |
| flag-electrolytes | redFlags | quality | not run | PASS | NICE NG12 2015 |  |
| inv-ct | investigationInclude | quality | not run | PASS | NICE NG12 2015 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-gord-top3 | mustRankTopK | quality | not run | PASS | NICE CG184 2014 |  |
| level-routine | emergencyLevel | quality | not run | FAIL (known gap) | NICE CG184 2014 | adaptive-triage: strip negated clauses ("no/denies/without X") before RED_FLAGS, GI_BLEED_TERMS and vomiting rules. |
| no-cancer-alarm | mustNotAlarm | quality | not run | PASS | NICE NG12 2015 |  |
| inv-no-urgent-ogd | investigationExclude | quality | not run | PASS | NICE CG184 2014 |  |
| mgmt-empirical-ppi | managementInclude | quality | not run | PASS | NICE CG184 2014 |  |
| mgmt-lifestyle | managementInclude | quality | not run | PASS | NICE CG184 2014 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-malignancy | mustNotMiss | critical | not run | FAIL (known gap) | NICE NG12 2015 | pane-engine modifiers: age ≥55 multiplier for oesophageal/gastric carcinoma; weight_loss + age ≥55 should surface a malignancy. |
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2015 |  |
| flag-weight-loss-cancer | redFlags | critical | not run | PASS | NICE NG12 2015 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | NICE NG12 2015 |  |
| mgmt-urgent-two-week-ogd | managementInclude | quality | not run | FAIL (known gap) | NICE NG12 2015 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| flag-penicillin-allergy | redFlags | critical | not run | PASS | Maastricht VI/Florence consensus report 2022 |  |
| mgmt-no-amoxicillin | managementExclude | critical | not run | FAIL (known gap) | Maastricht VI/Florence consensus report 2022 | buildPlanText / protocol medications: filter or flag drugs that match a recorded allergy class (penicillins); same finding as the seed appendicitis/cholangitis vignettes. |
| mgmt-bismuth-quadruple | managementInclude | quality | not run | FAIL (known gap) | Maastricht VI/Florence consensus report 2022 | As h-pylori-positive-eradication; add the bismuth quadruple (tetracycline + metronidazole) regimen. |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mgmt-eradication | managementInclude | quality | not run | PASS | Maastricht VI/Florence consensus report 2022 |  |
| mgmt-14-day-or-bismuth | managementInclude | quality | not run | FAIL (known gap) | Maastricht VI/Florence consensus report 2022 | Gastritis / peptic_ulcer / gastric_carcinoma protocols: align H. pylori regimens with Maastricht VI (14 days; bismuth quadruple first-line where clarithromycin resistance is high or unknown). The three protocols currently disagree (7, 7–14 and 14 days). |
| mgmt-test-of-cure | managementInclude | quality | not run | PASS | Maastricht VI/Florence consensus report 2022 |  |
| mgmt-no-7-day-clarithromycin-triple | managementExclude | quality | not run | FAIL (known gap) | Maastricht VI/Florence consensus report 2022 | As mgmt-14-day-or-bismuth. |
...
#### `haemorrhoids-bleeding-warfarin-71` — Anticoagulated (warfarin), age 71

71-year-old woman with AF on warfarin (INR 3.4) and intermittent fresh bleeding with grade II haemorrhoids. Colonic evaluation first (age); check INR; rubber band ligation carries a higher risk of delayed bleeding on anticoagulation — plan with the anticoagulant prescriber.

Permutation of `haemorrhoids-grade3-over-50`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| flag-warfarin | redFlags | critical | not run | PASS | ASCRS clinical practice guidelines 2024 |  |
| inv-colonic-evaluation | investigationInclude | critical | not run | PASS | NICE NG12 2023; ASCRS clinical practice guidelines 2024 |  |
| inv-inr | investigationInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2024 |  |
| mgmt-anticoag-plan | managementInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2024 |  |

Guidelines:

- **ascrs-haem-2024** — ASCRS clinical practice guidelines — management of hemorrhoids (2024), Anticoagulated patients: higher risk of post-banding bleeding; colonic evaluation where indicated. Hawkins AT, Davis BR, Bhama AR, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of hemorrhoids. Dis Colon Rectum. 2024;67:614–623. *(statement wording/numbering not yet verified against the source)*
- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI: rectal bleeding at ≥ 50. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*

### Haemorrhoids — grade III, age 58

#### `haemorrhoids-grade3-over-50` — 

58-year-old man with prolapsing haemorrhoids needing manual reduction and bright red bleeding, never had a colonoscopy. ASCRS 2024: grade III → rubber band ligation or excisional haemorrhoidectomy; the bleeding must not be attributed to haemorrhoids without colonic evaluation at this age.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| inv-colonic-evaluation | investigationInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2024; NICE NG12 2023 |  |
| dx-haemorrhoids-top3 | mustRankTopK | quality | not run | PASS | ASCRS clinical practice guidelines 2024 |  |
| mnm-crc | mustNotMiss | quality | not run | FAIL (known gap) | NICE NG12 2023 |  |
| mgmt-grade3-treatment | managementInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2024 |  |

Failure details:

- **mnm-crc** (web): not in top 3 of web.pane: 1. Haemorrhoids \| 2. Inguinal / Femoral Hernia \| 3. Anal Fissure; also in web.symptomInference#4 [known gap: PANE top 3 (haemorrhoids, hernia, fissure) does not keep colorectal cancer visible in a 58-year-old with bleeding; the haemorrhoid protocol does request colonoscopy (> 40).]

Guidelines:

- **ascrs-haem-2024** — ASCRS clinical practice guidelines — management of hemorrhoids (2024), Grade III: office procedures (rubber band ligation) or excisional haemorrhoidectomy; colonic evaluation when bleeding is not typical or the patient is at risk of colorectal neoplasia. Hawkins AT, Davis BR, Bhama AR, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of hemorrhoids. Dis Colon Rectum. 2024;67:614–623. *(statement wording/numbering not yet verified against the source)*
- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI: rectal bleeding at ≥ 50 on the colorectal pathway (FIT-first since 2023). National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*

### Thrombosed external haemorrhoid (< 72 h)

#### `haemorrhoids-thrombosed-external-48h` — Acutely thrombosed external haemorrhoid at 48 h

33-year-old man with 48 h of severe perianal pain and a tense blue lump at the anal verge after heavy lifting. ASCRS 2024: early surgical excision (within about 72 h of onset) gives faster relief; after that, conservative care. Not an abscess.
...
|---|---|---|---|---|---|---|
| dx-haemorrhoids-top3 | mustRankTopK | quality | not run | PASS | ASCRS clinical practice guidelines 2024 |  |
| mgmt-excision-72h | managementInclude | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2024 | Add a thrombosed-external-haemorrhoid dx-variant: < 72 h → excision under LA; > 72 h → conservative (ASCRS 2024). |
...
- **ascrs-haem-2024** — ASCRS clinical practice guidelines — management of hemorrhoids (2024), Thrombosed external haemorrhoids: early surgical excision (≈ within 72 h of onset) offers faster symptom resolution and lower recurrence. Hawkins AT, Davis BR, Bhama AR, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of hemorrhoids. Dis Colon Rectum. 2024;67:614–623. *(statement wording/numbering not yet verified against the source)*
...
#### `infective-colitis-bloody-diarrhoea` — 

24-year-old man with three days of fever, cramps and bloody diarrhoea after a barbecue. IDSA 2017: stool culture including STEC/Shiga toxin; avoid antimotility agents and empirical antibiotics until STEC is excluded (HUS risk); first presentation of IBD is the differential.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| inv-stool-culture | investigationInclude | critical | not run | FAIL (known gap) | IDSA clinical practice guidelines 2017 | Add an infective-colitis rule (bloody diarrhoea ± fever): stool culture incl. STEC/Shiga toxin, C. difficile if antibiotics/healthcare exposure; avoid antimotility agents and empirical antibiotics until STEC excluded (IDSA 2017). |
| mgmt-no-appendicectomy | managementExclude | critical | not run | FAIL (known gap) | IDSA clinical practice guidelines 2017 | Gate the appendicectomy operative-plan prompt on the confirmed working diagnosis (appendicitis) or imaging, not on the words "guarding"/"rebound"; add negation handling (no/without/absent) to exam() matching. |
| mgmt-no-antimotility | managementExclude | critical | not run | PASS | IDSA clinical practice guidelines 2017 |  |
| dx-infective-top3 | mustRankTopK | quality | not run | FAIL (known gap) | IDSA clinical practice guidelines 2017 |  |
| mnm-ibd | mustNotMiss | quality | not run | FAIL (known gap) | IDSA clinical practice guidelines 2017 |  |
| mgmt-no-empirical-antibiotics-stec | managementExclude | quality | not run | FAIL (known gap) | IDSA clinical practice guidelines 2017 |  |

Failure details:

- **dx-infective-top3** (web): not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Acute Cholecystitis \| 3. Acute Cholangitis; also in web.symptomInference#1, web.passive#1 [known gap: PANE has no infective colitis/gastroenteritis disease; top 3 is appendicitis/cholecystitis/cholangitis. Symptom inference ranks gastroenteritis #1.]
- **mnm-ibd** (web): not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Acute Cholecystitis \| 3. Acute Cholangitis; also in web.symptomInference#5, web.passive#4 [known gap: IBD is not in the PANE top 3 (the "Change in bowel habit" template has no CC hint).]
- **inv-stool-culture** (web): no investigation matched among 34 (web.pane.seeded, web.clinicalPrompts) [known gap: No stool culture/STEC testing output (A09 has no protocol; PANE-seeded tests are for appendicitis/biliary disease).]
- **mgmt-no-appendicectomy** (web): forbidden management item present in web.clinicalPrompts: "laparoscopic appendicectomy - operative plan ───────────────────────────────────────────── pre-operative: •..." [known gap: Web computeClinicalPrompts fires "Appendicitis — emergency surgical indication" and adds the full "LAPAROSCOPIC APPENDICECTOMY — OPERATIVE PLAN" whenever examAbdomen contains "guarding" or "rebound" — including negated text ("no guarding") and localised guarding from other causes.]
- **mgmt-no-empirical-antibiotics-stec** (web): forbidden management item present in web.clinicalPrompts: "• iv pip-tazo 4.5g + metronidazole 500mg - antibiotic prophylaxis at induction." [known gap: The appendicectomy operative-plan prompt adds "IV Pip-Tazo + metronidazole" (see mgmt-no-appendicectomy).]

Guidelines:

- **idsa-diarrhoea-2017** — IDSA clinical practice guidelines — diagnosis and management of infectious diarrhoea (2017), Bloody diarrhoea/fever: stool culture and STEC testing; avoid antimotility agents in inflammatory diarrhoea; avoid antibiotics in STEC O157/Shiga toxin 2 infection. Shane AL, Mody RK, Crump JA, et al. 2017 Infectious Diseases Society of America clinical practice guidelines for the diagnosis and management of infectious diarrhea. Clin Infect Dis. 2017;65:e45–e80. *(statement wording/numbering not yet verified against the source)*
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2015; BSG guidelines 2021 |  |
| flag-ida | redFlags | critical | not run | FAIL (known gap) | BSG guidelines 2021; NICE NG12 2015 | clinical-inference.ts: add an IDA prompt from labs (low Hb for sex + low ferritin or MCV) → "BSG 2021: bidirectional endoscopy, coeliac serology; NG12 ≥60 urgent referral". |
| inv-ogd | investigationInclude | critical | not run | PASS | BSG guidelines 2021 |  |
| inv-colonoscopy | investigationInclude | critical | not run | FAIL (known gap) | BSG guidelines 2021; NICE NG12 2015 | Same IDA prompt. |
| mnm-gi-malignancy | mustNotMiss | quality | not run | PASS | BSG guidelines 2021 |  |
| inv-coeliac-serology | investigationInclude | quality | not run | FAIL (known gap) | BSG guidelines 2021 |  |
| inv-urinalysis | investigationInclude | quality | not run | FAIL (known gap) | BSG guidelines 2021 |  |
| mgmt-iron-replacement | managementInclude | quality | not run | FAIL (known gap) | BSG guidelines 2021 |  |
...
### Ischaemic colitis (left-sided, non-gangrenous)

#### `ischaemic-colitis-left` — 

74-year-old woman with vascular disease: sudden crampy left-sided abdominal pain followed within hours by bloody diarrhoea; CT shows thickened splenic flexure/descending colon. ACG 2015: CT with IV contrast, supportive care, colonoscopy within 48 h; antibiotics for moderate/severe disease; surgery for peritonitis/gangrene.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-ischaemic-colitis-top3 | mustRankTopK | critical | not run | PASS | ACG clinical guideline 2015 |  |
| level-admit | emergencyLevel | critical | not run | PASS | ACG clinical guideline 2015 |  |
| mgmt-no-appendicectomy | managementExclude | critical | not run | FAIL (known gap) | ACG clinical guideline 2015 | Gate the appendicectomy operative-plan prompt on the confirmed working diagnosis (appendicitis) or imaging, not on the words "guarding"/"rebound"; add negation handling (no/without/absent) to exam() matching. |
| inv-ct-contrast | investigationInclude | quality | not run | PASS | ACG clinical guideline 2015 |  |
| inv-colonoscopy-48h | investigationInclude | quality | not run | PASS | ACG clinical guideline 2015 |  |
| inv-stool-culture | investigationInclude | quality | not run | PASS | ACG clinical guideline 2015 |  |
| mgmt-no-therapeutic-heparin | managementExclude | quality | not run | PASS | ACG clinical guideline 2015 |  |
...
- **acg-ci-2015** — ACG clinical guideline — colon ischaemia (2015), Colon ischaemia: CT with IV contrast; colonoscopy within 48 h; antibiotics for moderate or severe disease; surgery for peritonitis, gangrene, perforation. Brandt LJ, Feuerstadt P, Longstreth GF, Boley SJ. ACG clinical guideline: epidemiology, risk factors, patterns of presentation, diagnosis, and management of colon ischemia (CI). Am J Gastroenterol. 2015;110:18–44. *(statement wording/numbering not yet verified against the source)*

### Right-sided colon ischaemia — acute mesenteric ischaemia to be excluded

#### `ischaemic-colitis-right-af-ami` — Isolated right colon ischaemia, AF off anticoagulation, lactate 4.1

79-year-old man with AF (anticoagulation stopped after a fall) and severe periumbilical pain out of proportion, then maroon stools; lactate 4.1; CT shows right colonic wall thickening. ACG 2015: isolated right colon ischaemia → CT angiography to exclude acute mesenteric ischaemia (SMA embolus).

Permutation of `ischaemic-colitis-left`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-ami | mustNotMiss | critical | not run | FAIL (known gap) | ACG clinical guideline 2015; ESVS clinical practice guidelines 2017 | Add acute mesenteric ischaemia to PANE (AF/embolic source, pain out of proportion, lactate) and a CTA-first protocol (ESVS 2017). |
| level-emergency | emergencyLevel | critical | not run | PASS | ESVS clinical practice guidelines 2017 |  |
| inv-cta | investigationInclude | critical | not run | FAIL (known gap) | ACG clinical guideline 2015; ESVS clinical practice guidelines 2017 | In the ischaemic colitis protocol add: isolated right colon ischaemia, AF or lactate rise → CT angiography to exclude AMI (ACG 2015). |
| mgmt-vascular | managementInclude | quality | not run | PASS | ESVS clinical practice guidelines 2017 |  |

Failure details:

- **mnm-ami** (web): not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Inguinal / Femoral Hernia \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#2 [known gap: Acute mesenteric ischaemia is not a PANE disease (top 3: appendicitis, hernia, cholecystitis); symptom inference ranks it #1. Same gap as the appendicitis seed vignettes.]
- **inv-cta** (web): no investigation matched among 41 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: K55.0 maps to the ischaemic_colitis protocol, whose imaging is "CT abdomen/pelvis with IV contrast"; nothing asks for CT angiography when the ischaemia is right-sided or embolic.]

Guidelines:

- **acg-ci-2015** — ACG clinical guideline — colon ischaemia (2015), Isolated right colon ischaemia: evaluate the mesenteric vasculature (CTA) — higher mortality and association with AMI. Brandt LJ, Feuerstadt P, Longstreth GF, Boley SJ. ACG clinical guideline: epidemiology, risk factors, patterns of presentation, diagnosis, and management of colon ischemia (CI). Am J Gastroenterol. 2015;110:18–44. *(statement wording/numbering not yet verified against the source)*
- **esvs-2017** — ESVS clinical practice guidelines — diseases of the mesenteric arteries and veins (2017), Suspected acute mesenteric ischaemia: CT angiography without delay; revascularisation. Björck M, Koelemay M, Acosta S, et al. Management of the diseases of mesenteric arteries and veins: clinical practice guidelines of the European Society of Vascular Surgery (ESVS). Eur J Vasc Endovasc Surg. 2017;53:460–510. *(statement wording/numbering not yet verified against the source)*

### Large bowel obstruction

#### `lbo-obstructing-sigmoid-cancer` — Obstructing sigmoid cancer, no perforation (base case)

72-year-old man, 6 weeks of change in bowel habit with blood and weight loss, then 4 days of absolute constipation and distension; CT: obstructing sigmoid tumour, caecum 10 cm, no perforation.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-colorectal-or-obstruction-top3 | mustRankTopK | critical | not run | PASS | WSES guidelines 2018 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES guidelines 2018 |  |
| inv-ct | investigationInclude | critical | not run | PASS | WSES guidelines 2018 |  |
| mgmt-decompression-or-resection | managementInclude | critical | not run | PASS | WSES guidelines 2018 |  |
| inv-staging-chest | investigationInclude | quality | not run | PASS | WSES guidelines 2018 |  |
| inv-cea | investigationInclude | quality | not run | PASS |  |  |
| mgmt-primary-anastomosis-option | managementInclude | quality | not run | PASS | WSES guidelines 2018 |  |
| mgmt-mdt | managementInclude | quality | not run | PASS | WSES guidelines 2018 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-lbo-malignant | dxVariant | quality | not run | PASS | WSES guidelines 2018 |  |

Guidelines:

- **wses-lbo-2018** — WSES guidelines — colon and rectal cancer emergencies: obstruction and perforation (2017) (2018), CT for diagnosis; left-sided obstruction (Hartmann's vs resection with primary anastomosis ± stoma; SEMS as a bridge in selected patients); right-sided obstruction (right colectomy with primary anastomosis); caecal distension and perforation (emergency surgery, no stent). Pisano M, Zorcolo L, Merli C, et al. 2017 WSES guidelines on colon and rectal cancer emergencies: obstruction and perforation. World J Emerg Surg. 2018;13:36. *(statement wording/numbering not yet verified against the source)*

#### `lbo-cancer-impending-caecal-perforation` — Impending caecal perforation (closed loop, 13.5 cm, pneumatosis), sepsis

79-year-old woman with heart failure, 5 days of LBO from sigmoid cancer, now RIF peritonism, T 38.2 °C, HR 122, BP 96/58, lactate 3.6; CT: competent ileocaecal valve, caecum 13.5 cm with pneumatosis.

Permutation of `lbo-obstructing-sigmoid-cancer`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | PASS | WSES guidelines 2018 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-emergency-surgery | managementInclude | critical | not run | PASS | WSES guidelines 2018 |  |
| mgmt-no-stent-with-impending-perforation | managementExclude | critical | not run | FAIL (known gap) | WSES guidelines 2018 | State the stent contraindications in the prompt and the lbo_malignant prefix (perforation, peritonitis, caecal ischaemia/pneumatosis, closed loop ≥12 cm with tenderness) and suppress the stent option when they are present. |
| variant-lbo-malignant | dxVariant | quality | not run | FAIL (known gap) | WSES guidelines 2018 |  |

Failure details:

- **mgmt-no-stent-with-impending-perforation** (web): forbidden management item present in web.clinicalPrompts: "• if lbo due to colonic malignancy: colonic stent as bridge to elective resection (vs emergency hartmann's)." [known gap: Web: Bowel-obstruction prompt step: 'If LBO due to colonic malignancy: colonic stent as bridge to elective resection' is shown with no contraindication for caecal pneumatosis/closed loop (the dx-variant note mentions perforation only as 'If unavailable or perforated').]
- **variant-lbo-malignant** (web): detected sbo_strangulation in group Bowel Obstruction; expected lbo_malignant [known gap: Web: The word 'closed-loop' selects sbo_strangulation (a small-bowel variant) before lbo_malignant.]
...
#### `lbo-right-colon-cancer` — Right-sided (hepatic flexure) obstructing cancer

68-year-old woman with iron-deficiency anaemia, 3 days of obstruction; CT: obstructing hepatic flexure tumour, no perforation.
...
|---|---|---|---|---|---|---|
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES guidelines 2018 |  |
| mgmt-right-hemicolectomy | managementInclude | quality | not run | FAIL (known gap) | WSES guidelines 2018 | Split lbo_malignant into left- and right-sided variants; right-sided = right colectomy with primary anastomosis. |
| mgmt-no-left-sided-plan-for-right-lesion | managementExclude | quality | not run | FAIL (known gap) | WSES guidelines 2018 |  |
| variant-lbo-malignant | dxVariant | quality | not run | PASS | WSES guidelines 2018 |  |

Failure details:

- **mgmt-right-hemicolectomy** (web): no management item matched among 48 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: Plan offers the left-sided LBO options only (SEMS, Hartmann's, colostomy); no right colectomy with primary anastomosis.]
...
### Colonic angiodysplasia with iron-deficiency anaemia

#### `lgib-angiodysplasia-aspirin` — Recurrent occult/overt bleeding, aortic stenosis, aspirin

76-year-old woman with aortic stenosis, CKD and aspirin for coronary disease; recurrent iron-deficiency anaemia (Hb 8.6, ferritin 8) with intermittent dark red bleeding. Colorectal cancer must be excluded; angiodysplasia is the working diagnosis; aspirin for secondary prevention is continued.

Permutation of `lgib-oakland-low-risk-discharge`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-crc | mustNotMiss | critical | not run | PASS | BSG guideline 2021; NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | not run | PASS | BSG guideline 2021; BSG guideline 2019 |  |
| mgmt-no-heparin | managementExclude | critical | not run | FAIL (known gap) | BSG guideline 2019 | Exclude K55.2x (angiodysplasia) from the ischaemic_colitis protocol prefixes; add an angiodysplasia/LGIB protocol (colonoscopy + APC, iron, continue secondary-prevention aspirin). |
| mgmt-no-stop-aspirin | managementExclude | critical | not run | PASS | BSG guideline 2019 |  |
| mnm-angiodysplasia | mustNotMiss | quality | not run | FAIL (known gap) | BSG guideline 2019 |  |
| inv-iron-studies | investigationInclude | quality | not run | FAIL (known gap) | BSG guideline 2021 |  |
| mgmt-iron | managementInclude | quality | not run | FAIL (known gap) | BSG guideline 2021 |  |
| mgmt-apc | managementInclude | quality | not run | FAIL (known gap) | BSG guideline 2019 |  |
| mgmt-no-empirical-antibiotics | managementExclude | quality | not run | FAIL (known gap) | BSG guideline 2019 |  |
...
- **mgmt-apc** (web): no management item matched among 39 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No endoscopic therapy (argon plasma coagulation) — there is no angiodysplasia protocol.]
- **mgmt-no-heparin** (web): forbidden management item present in web.protocol.medications: "heparin weight-based per local protocol iv (intravenous) continuous infusion - mesenter..." [known gap: ICD K55.21 (angiodysplasia of colon with haemorrhage) matches the ischaemic_colitis protocol (prefix K55), whose medications include a therapeutic heparin infusion (for mesenteric venous thrombosis) — offered to a bleeding patient.]
...
- **bsg-lgib-2019** — BSG guideline — diagnosis and management of acute lower gastrointestinal bleeding (2019), Angiodysplasia: endoscopic therapy (argon plasma coagulation); antiplatelets for secondary prevention continued. Oakland K, Chadwick G, East JE, et al. Diagnosis and management of acute lower gastrointestinal bleeding: guidelines from the British Society of Gastroenterology. Gut. 2019;68:776–789. *(statement wording/numbering not yet verified against the source)*
- **bsg-ida-2021** — BSG guideline — management of iron deficiency anaemia in adults (2021), IDA in men and post-menopausal women: bidirectional endoscopy (colonoscopy if OGD negative); iron replacement. Snook J, Bhala N, Beales ILP, et al. British Society of Gastroenterology guidelines for the management of iron deficiency anaemia in adults. Gut. 2021;70:2030–2051. *(statement wording/numbering not yet verified against the source)*
- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI: age ≥ 60 with iron-deficiency anaemia → suspected colorectal cancer pathway. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*

### Diverticular haemorrhage

#### `lgib-diverticular-apixaban` — Stable major bleed (Oakland > 8), DOAC

79-year-old man on apixaban with painless large-volume fresh and maroon rectal bleeding, HR 96, SBP 124, Hb 10.9: Oakland 23, stable major bleed → admit, hold the DOAC, colonoscopy on the next available list. Antibiotics for diverticulitis are not indicated.

Permutation of `lgib-oakland-low-risk-discharge`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-admit | emergencyLevel | critical | not run | PASS | BSG guideline 2019 |  |
| flag-doac | redFlags | critical | not run | PASS | BSG guideline 2019 |  |
| mgmt-hold-doac | managementInclude | critical | not run | FAIL (known gap) | BSG guideline 2019 | In the GI-bleed prompt, add "interrupt DOAC/warfarin at presentation; reversal agent only for life-threatening bleeding" when an anticoagulant is recorded. |
| mnm-crc | mustNotMiss | quality | not run | PASS | BSG guideline 2019 |  |
| score-rec-oakland | scoreRecommended | quality | not run | FAIL (known gap) | Oakland score 2017; BSG guideline 2019 |  |
| inv-colonoscopy | investigationInclude | quality | not run | PASS | BSG guideline 2019 |  |
| mgmt-no-diverticulitis-antibiotics | managementExclude | quality | not run | FAIL (known gap) | BSG guideline 2019 | Route K57.x1 (with bleeding) to the lower GI bleeding protocol; keep K57.x2/x3 (diverticulitis/abscess) on the diverticulitis protocol. |
...
- **mgmt-hold-doac** (web): no management item matched among 37 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: The only DOAC text is the generic peri-operative bridging prompt ("hold DOAC 48–72 h pre-op"); nothing says to interrupt the DOAC at presentation of a bleed.]
...
- **bsg-lgib-2019** — BSG guideline — diagnosis and management of acute lower gastrointestinal bleeding (2019), Stable major bleed (Oakland > 8): admit, colonoscopy on the next available list; DOACs interrupted at presentation; aspirin for secondary prevention not stopped. Oakland K, Chadwick G, East JE, et al. Diagnosis and management of acute lower gastrointestinal bleeding: guidelines from the British Society of Gastroenterology. Gut. 2019;68:776–789. *(statement wording/numbering not yet verified against the source)*
- **oakland-2017** — Oakland score — derivation and validation (safe discharge after acute LGIB) (2017), Score items; > 8 points = not suitable for discharge. Oakland K, Jairath V, Uberoi R, et al. Derivation and validation of a novel risk score for safe discharge after acute lower gastrointestinal bleeding: a modelling study. Lancet Gastroenterol Hepatol. 2017;2:635–643. *(statement wording/numbering not yet verified against the source)*

### Acute lower gastrointestinal bleeding — minor, low risk (Oakland ≤ 8)

#### `lgib-oakland-low-risk-discharge` — 

36-year-old woman in the emergency department with two small episodes of fresh red rectal bleeding, stable observations, Hb 14.6 g/dL and blood on the glove: Oakland score 8, so BSG 2019 supports discharge with outpatient investigation.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-haemorrhoids-top3 | mustRankTopK | quality | not run | PASS | BSG guideline 2019 |  |
| level-not-emergency | emergencyLevel | quality | not run | FAIL (known gap) | BSG guideline 2019; Oakland score 2017 | Grade rectal bleeding by volume/haemodynamics (and an Oakland score when Hb and DRE are recorded) instead of the word "bleed". |
| score-rec-oakland | scoreRecommended | quality | not run | FAIL (known gap) | Oakland score 2017; BSG guideline 2019 | Add the Oakland score (age, sex, previous LGIB admission, DRE blood, HR, SBP, Hb) to clinical-scales and a CDS rule for rectal bleeding; ≤ 8 → discharge with outpatient investigation (BSG 2019). |
| inv-no-cta | investigationExclude | quality | not run | PASS | BSG guideline 2019 |  |
| mgmt-discharge-outpatient | managementInclude | quality | not run | PASS | BSG guideline 2019 |  |
| mgmt-no-transfusion | managementExclude | quality | not run | FAIL (known gap) | BSG guideline 2019 | Condition the resuscitation/cross-match actions on instability (shock index > 1, SBP < 90, Hb < 80 g/L) or a large-volume bleed. |

Failure details:

- **level-not-emergency** (web): web.triage: emergency (acuity=urgent, action=emergency_now, score=127); expected ≤ urgent [known gap: Web adaptiveTriage has no negation handling and treats any "bleed/bleeding" as an urgent red flag (RED_FLAGS "GI or other bleeding" → emergency_now), so every rectal bleed — including minor outlet bleeding — is "emergency".]
...
- **bsg-lgib-2019** — BSG guideline — diagnosis and management of acute lower gastrointestinal bleeding (2019), Risk assessment: Oakland score ≤ 8 with no other indication for admission → discharge for outpatient investigation; restrictive red-cell transfusion. Oakland K, Chadwick G, East JE, et al. Diagnosis and management of acute lower gastrointestinal bleeding: guidelines from the British Society of Gastroenterology. Gut. 2019;68:776–789. *(statement wording/numbering not yet verified against the source)*
- **oakland-2017** — Oakland score — derivation and validation (safe discharge after acute LGIB) (2017), Score items: age, sex, previous LGIB admission, DRE blood, heart rate, systolic BP, haemoglobin; ≤ 8 points = safe discharge. Oakland K, Jairath V, Uberoi R, et al. Derivation and validation of a novel risk score for safe discharge after acute lower gastrointestinal bleeding: a modelling study. Lancet Gastroenterol Hepatol. 2017;2:635–643. *(statement wording/numbering not yet verified against the source)*

### Delayed post-polypectomy bleeding

#### `lgib-post-polypectomy` — Day 6 after EMR, clopidogrel restarted

66-year-old man 6 days after endoscopic mucosal resection of a 30 mm ascending colon polyp, clopidogrel restarted on day 2, now with four episodes of fresh and maroon blood, HR 98, Hb 11.2 (baseline 13.8). Needs admission and repeat colonoscopy with endoscopic haemostasis (clips).

Permutation of `lgib-oakland-low-risk-discharge`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-admit | emergencyLevel | critical | not run | PASS | BSG guideline 2019; ESGE guideline 2017 |  |
| mgmt-repeat-colonoscopy | managementInclude | critical | not run | PASS | ESGE guideline 2017; BSG guideline 2019 |  |
| flag-antiplatelet | redFlags | quality | not run | PASS | BSG guideline 2019 |  |
| mgmt-endoscopic-haemostasis | managementInclude | quality | not run | FAIL (known gap) | ESGE guideline 2017 | Add a post-polypectomy bleed rule (post-procedure + rectal bleeding): repeat colonoscopy with endoscopic haemostasis (ESGE). |
| mgmt-antiplatelet-plan | managementInclude | quality | not run | FAIL (known gap) | BSG guideline 2019 |  |

Failure details:

- **mgmt-endoscopic-haemostasis** (web): no management item matched among 15 (web.clinicalPrompts) [known gap: No post-polypectomy bleeding protocol (K91.840 has none); the only plan is the generic GI-bleed prompt without endoscopic haemostasis/clips.]
- **mgmt-antiplatelet-plan** (web): no management item matched among 15 (web.clinicalPrompts) [known gap: The anticoagulant prompt lists warfarin/DOACs/heparins only; clopidogrel (and other antiplatelets) are not handled in the bleed plan.]

Guidelines:

- **bsg-lgib-2019** — BSG guideline — diagnosis and management of acute lower gastrointestinal bleeding (2019), Stable bleeding requiring admission; antiplatelet management. Oakland K, Chadwick G, East JE, et al. Diagnosis and management of acute lower gastrointestinal bleeding: guidelines from the British Society of Gastroenterology. Gut. 2019;68:776–789. *(statement wording/numbering not yet verified against the source)*
- **esge-polypectomy-2017** — ESGE guideline — colorectal polypectomy and endoscopic mucosal resection (2017), Delayed post-polypectomy bleeding: colonoscopy with endoscopic haemostasis; resumption of antithrombotics. Ferlitsch M, Moss A, Hassan C, et al. Colorectal polypectomy and endoscopic mucosal resection (EMR): European Society of Gastrointestinal Endoscopy (ESGE) Clinical Guideline. Endoscopy. 2017;49:270–297. *(statement wording/numbering not yet verified against the source)*

### Acute lower gastrointestinal bleeding — haemodynamically unstable

#### `lgib-unstable-cta-first` — Unstable (shock index > 1 after resuscitation), elderly

74-year-old man with three large maroon and fresh bloody stools, pre-syncope, HR 118 and SBP 88 after 1 L of crystalloid (shock index 1.3), Hb 8.4. BSG 2019: CT angiography first, then catheter angiography/embolisation; consider an upper GI source.

Permutation of `lgib-oakland-low-risk-discharge`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | PASS | BSG guideline 2019 |  |
| alarm-instability | mustAlarm | critical | not run | PASS | BSG guideline 2019 |  |
| inv-cta-first | investigationInclude | critical | not run | FAIL (known gap) | BSG guideline 2019; ACG clinical guideline 2023 | Add a lower GI bleeding protocol and dx-variant group (keywords "lower gi bleed", "haematochezia", "diverticular bleed", ICD K62.5/K57.x1/K55.2x/K92.1–2 with lower-GI text): unstable → CTA first, then embolisation; stable major → admit + colonoscopy; minor (Oakland ≤ 8) → discharge (BSG 2019). |
| mgmt-resuscitation | managementInclude | critical | not run | PASS | BSG guideline 2019 |  |
| mgmt-no-terlipressin | managementExclude | critical | not run | FAIL (known gap) | BSG guideline 2019 | Remove K92 from the upper_gi_bleed protocol/dx-variant ICD prefixes (or require upper-GI words) and route lower GI bleeding to its own protocol. |
| score-rec-shock-index | scoreRecommended | quality | not run | FAIL (known gap) | BSG guideline 2019 |  |
| inv-upper-source | investigationInclude | quality | not run | PASS | BSG guideline 2019 |  |
| inv-group-crossmatch | investigationInclude | quality | not run | PASS | BSG guideline 2019 |  |
| mgmt-embolisation | managementInclude | quality | not run | PASS | BSG guideline 2019 |  |
...
- **inv-cta-first** (web): no investigation matched among 28 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: No output recommends CT angiography for unstable haematochezia: the plan is the UGIB protocol (OGD) and the GI-bleed prompt offers "urgent OGD / colonoscopy". The confirmed ICD K92.2 (GI haemorrhage, unspecified) matches the upper_gi_bleed protocol (icd10Prefixes K92) and the "Upper GI Bleed" dx-variant group; there is no lower GI bleeding protocol, so the plan is the variceal/non-variceal UGIB plan.]
- **mgmt-no-terlipressin** (web): forbidden management item present in web.plan: "[immediate] suspected varices: terlipressin 2 mg qds + prophylactic iv ceftriaxone." (+1 more) [known gap: The confirmed ICD K92.2 (GI haemorrhage, unspecified) matches the upper_gi_bleed protocol (icd10Prefixes K92) and the "Upper GI Bleed" dx-variant group; there is no lower GI bleeding protocol, so the plan is the variceal/non-variceal UGIB plan. The plan text includes "Suspected varices: terlipressin" and variceal steps for a patient without liver disease.]

Guidelines:

- **bsg-lgib-2019** — BSG guideline — diagnosis and management of acute lower gastrointestinal bleeding (2019), Unstable bleeding (shock index > 1): CT angiography first; catheter angiography and embolisation if positive; OGD if no source; restrictive transfusion. Oakland K, Chadwick G, East JE, et al. Diagnosis and management of acute lower gastrointestinal bleeding: guidelines from the British Society of Gastroenterology. Gut. 2019;68:776–789. *(statement wording/numbering not yet verified against the source)*
- **acg-lgib-2023** — ACG clinical guideline — management of patients with acute lower gastrointestinal bleeding (update) (2023), CTA as the initial diagnostic test in patients with ongoing haemodynamically significant haematochezia. Sengupta N, Feuerstein JD, Jairath V, et al. Management of patients with acute lower gastrointestinal bleeding: an updated ACG guideline. Am J Gastroenterol. 2023;118:208–231. *(statement wording/numbering not yet verified against the source)*

### Acute lower gastrointestinal bleeding — unstable, on warfarin

#### `lgib-unstable-warfarin` — Anticoagulated (warfarin, INR 4.6)

81-year-old woman with atrial fibrillation on warfarin (INR 4.6) with heavy fresh and dark rectal bleeding, HR 112 and SBP 86: interrupt warfarin and reverse with prothrombin complex concentrate and IV vitamin K, then CT angiography.

Permutation of `lgib-unstable-cta-first`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | PASS | BSG guideline 2019 |  |
| flag-warfarin | redFlags | critical | not run | PASS | BSG guideline 2019 |  |
| inv-cta-first | investigationInclude | critical | not run | FAIL (known gap) | BSG guideline 2019 |  |
| mgmt-reverse-warfarin | managementInclude | critical | not run | PASS | BSG guideline 2019 |  |
| mgmt-restart-anticoag-plan | managementInclude | quality | not run | FAIL (known gap) | BSG guideline 2019 |  |
...
- **bsg-lgib-2019** — BSG guideline — diagnosis and management of acute lower gastrointestinal bleeding (2019), Anticoagulants: interrupt warfarin; reverse with PCC and vitamin K in unstable haemorrhage; restart after the bleed; CTA first when unstable. Oakland K, Chadwick G, East JE, et al. Diagnosis and management of acute lower gastrointestinal bleeding: guidelines from the British Society of Gastroenterology. Gut. 2019;68:776–789. *(statement wording/numbering not yet verified against the source)*
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-ugib-top3 | mustRankTopK | critical | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | PASS | ESGE Guideline 2021; HALT-IT randomised trial 2020 |  |
| dx-mallory-weiss-top3 | mustRankTopK | quality | not run | FAIL (known gap) | ESGE Guideline 2021 | socrates-to-features.ts: add ASSOC/CC rules haematemesis\|vomiting blood\|coffee.?ground → haematemesis and melaena\|black\|tarry → melaena; also seed PANE from SmartSymptomPicker chips (HpiTab.reseedPane), not only the SOCRATES answers. |
| level-not-emergency | emergencyLevel | quality | not run | FAIL (known gap) | ESGE Guideline 2021; ACG Clinical Guideline 2021 | adaptive-triage: grade GI bleeding by haemodynamics/GBS instead of the word; add negation handling ("no …", "denies …") before RED_FLAGS matching. |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-outpatient | managementInclude | quality | not run | PASS | ESGE Guideline 2021; ACG Clinical Guideline 2021 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-acs | mustNotMiss | critical | not run | FAIL (known gap) | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 | Add an ACS "must-not-miss" node or a cross-check prompt for epigastric pain + diaphoresis + cardiovascular risk (diabetes, age, smoking). |
| level-emergency | emergencyLevel | critical | not run | FAIL (known gap) | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 | rules.ts: add an atypical-ACS rule (epigastric pain/indigestion + sweating/diaphoresis, or + diabetes/age ≥50) → urgent with "ECG now". |
| alarm-cardiac | mustAlarm | critical | not run | FAIL (known gap) | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 | As level-emergency. |
| inv-ecg | investigationInclude | critical | not run | FAIL (known gap) | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 | As level-emergency; chest-pain/ACS prompt with ECG + troponin. |
| inv-troponin | investigationInclude | critical | not run | FAIL (known gap) | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 | As inv-ecg. |
| mnm-acs-symptom-inference | mustNotMiss | quality | not run | FAIL (known gap) | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 |  |
| mgmt-no-gi-only-plan | managementExclude | quality | not run | PASS | 2023 ESC Guidelines for the management of acute coronary syndromes 2023 |  |
...
### Symptomatic abdominal aortic aneurysm (GI emergency mimic)

#### `mimic-aaa-symptomatic-renal-colic-label` — Stable symptomatic AAA presenting as 'renal colic'

69-year-old smoker with a known 5.4 cm AAA (missed surveillance), 12 h right loin pain to the groin, microscopic haematuria, tender pulsatile mass; haemodynamically stable.

Permutation of `mimic-ruptured-aaa`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-aaa | mustNotMiss | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2024 | Age/sex prior and pulsatile-mass weighting for aortic_aneurysm; a prompt for 'loin pain + known AAA'. |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | ESVS clinical practice guidelines 2024 |  |
| inv-cta | investigationInclude | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2024 | Same ICD prefix fix (I71). |
| mgmt-vascular-referral | managementInclude | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2024 |  |
| mgmt-no-renal-colic-nsaid | managementExclude | quality | not run | PASS | ESVS clinical practice guidelines 2024 |  |
...
- **mgmt-vascular-referral** (web): no management item matched among 10 (web.clinicalPrompts) [known gap: Web: No vascular referral: no protocol for I71.4.]

Guidelines:

- **esvs-aaa-2024** — ESVS clinical practice guidelines — abdominal aorto-iliac artery aneurysms (2024) (2024), Ruptured AAA: immediate transfer to vascular surgery, permissive hypotension, CT angiography only if haemodynamically stable enough; symptomatic intact AAA: urgent CTA and repair. Wanhainen A, Van Herzeele I, Bastos Goncalves F, et al. European Society for Vascular Surgery (ESVS) 2024 clinical practice guidelines on the management of abdominal aorto-iliac artery aneurysms. Eur J Vasc Endovasc Surg. 2024;67:192–331. *(statement wording/numbering not yet verified against the source)*

### Diabetic ketoacidosis (GI emergency mimic)

#### `mimic-dka-abdominal-pain` — Type 1 diabetic, severe DKA with abdominal pain and guarding

19-year-old with type 1 diabetes, missed insulin, 1 day of diffuse abdominal pain and vomiting, Kussmaul breathing, glucose 29.4, ketones 5.6, pH 7.08, WBC 19.8, amylase 210, voluntary guarding.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-dka | mustNotMiss | critical | not run | FAIL (known gap) | Hyperglycaemic crises in adults with diabetes 2024 | Add a DKA node (or a medical-mimic layer) to PANE driven by glucose/ketones/pH, or surface the symptom-inference DKA result when glucose > 20. |
| level-emergency | emergencyLevel | critical | not run | PASS | Hyperglycaemic crises in adults with diabetes 2024 |  |
| alarm-dka | mustAlarm | critical | not run | PASS | Hyperglycaemic crises in adults with diabetes 2024 |  |
| inv-ketones-gas | investigationInclude | critical | not run | PASS | Hyperglycaemic crises in adults with diabetes 2024 |  |
| mgmt-insulin | managementInclude | critical | not run | PASS | Hyperglycaemic crises in adults with diabetes 2024 |  |
| mgmt-no-laparotomy-for-dka-pain | managementExclude | critical | not run | FAIL (known gap) | Hyperglycaemic crises in adults with diabetes 2024 | Negation-aware exam matching, and suppress operative templates while a DKA prompt is active (reassess the abdomen after correction). |
| mnm-dka-symptom-engine | mustNotMiss | quality | not run | PASS |  |  |
| mgmt-fluids | managementInclude | quality | not run | PASS | Hyperglycaemic crises in adults with diabetes 2024 |  |
| mgmt-potassium | managementInclude | quality | not run | FAIL (known gap) | Hyperglycaemic crises in adults with diabetes 2024 |  |

Failure details:

- **mnm-dka** (web): not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Peptic Ulcer Disease \| 3. Acute Pancreatitis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE has no DKA disease node, so it can never appear in the PANE top 3 (appendicitis, peptic ulcer, pancreatitis). Symptom inference ranks DKA #1.]
- **mgmt-potassium** (web): no management item matched among 32 (web.clinicalPrompts) [known gap: Web: The hyperglycaemia prompt mentions monitoring K+ only as part of the insulin line; no potassium replacement plan.]
- **mgmt-no-laparotomy-for-dka-pain** (web): forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." [known gap: Web: 'no rigidity, no rebound' triggers the peritonism prompt ('Emergency laparotomy consent — source control') and 'guarding' triggers the appendicectomy template in DKA.]

Guidelines:

- **ada-hhc-2024** — Hyperglycaemic crises in adults with diabetes — consensus report (ADA/EASD/JBDS/AACE/DTS) (2024), DKA diagnosis (glucose, ketones, pH/bicarbonate); abdominal pain common and resolves with treatment; IV fluids, fixed-rate insulin, potassium; search for precipitant. Umpierrez GE, Davis GM, ElSayed NA, et al. Hyperglycemic crises in adults with diabetes: a consensus report. Diabetes Care. 2024;47:1257–75. *(statement wording/numbering not yet verified against the source)*

### Ectopic pregnancy (GI emergency mimic)

#### `mimic-ectopic-pregnancy` — RIF pain labelled appendicitis, pregnancy status unknown (base case)

27-year-old woman, 20 h RIF pain referred as '?appendicitis', LMP 7 weeks ago, spotting, right shoulder-tip pain, pre-syncope, HR 112, BP 102/64; no pregnancy test yet.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-ectopic-top3 | mustRankTopK | critical | not run | FAIL (known gap) | NICE NG126 2019 | Map the CC template's 'lmp' answer (missed/late period, weeks since LMP) and 'spotting' to missed_period/abnormal_uterine_bleeding PANE features. |
| level-emergency | emergencyLevel | critical | not run | PASS | NICE NG126 2019 |  |
| inv-pregnancy-test | investigationInclude | critical | not run | PASS | NICE NG126 2019 |  |
| inv-transvaginal-us | investigationInclude | critical | not run | PASS | NICE NG126 2019 |  |
| mgmt-gynaecology | managementInclude | critical | not run | PASS | NICE NG126 2019 |  |
| mgmt-no-assumed-negative-hcg | managementExclude | critical | not run | FAIL (known gap) | NICE NG126 2019 | Replace 'β-HCG confirmed negative' in the template with 'β-HCG result: [ ]' and block the operative template until a negative result is recorded. |
| mgmt-no-appendicectomy-booked | managementExclude | quality | not run | PASS | NICE NG126 2019 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
...
#### `mimic-ectopic-ruptured-shock` — Ruptured, haemorrhagic shock (positive hCG)

31-year-old woman ~6 weeks pregnant (positive home test), sudden lower abdominal pain and collapse, HR 134, BP 78/40; FAST: haemoperitoneum.

Permutation of `mimic-ectopic-pregnancy`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-ectopic-top3 | mustRankTopK | critical | not run | FAIL (known gap) | NICE NG126 2019 |  |
| level-emergency | emergencyLevel | critical | not run | PASS | NICE NG126 2019 |  |
| alarm-shock | mustAlarm | critical | not run | PASS | NICE NG126 2019 |  |
| alarm-ectopic | mustAlarm | critical | not run | PASS | NICE NG126 2019 |  |
| inv-crossmatch | investigationInclude | critical | not run | PASS | NICE NG126 2019 |  |
| mgmt-emergency-surgery | managementInclude | critical | not run | PASS | NICE NG126 2019 |  |
| mgmt-no-medical-management-when-ruptured | managementExclude | critical | not run | FAIL (known gap) | NICE NG126 2019 | Add ectopic dx-variants (ruptured/unstable → immediate + surgical; unruptured stable → conservative options). |
...
### Inferior myocardial infarction (GI emergency mimic)

#### `mimic-inferior-mi` — Epigastric 'indigestion', no ECG yet (base case)

63-year-old diabetic smoker, 2 h epigastric 'indigestion' with sweating and vomiting, HR 52, BP 98/60, soft non-tender abdomen; no ECG recorded yet.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-acs | mustNotMiss | critical | not run | FAIL (known gap) | ESC guidelines 2023 | Add a cardiac mimic node to PANE for epigastric pain with diaphoresis/bradycardia/hypotension in patients with vascular risk factors. |
| level-emergency | emergencyLevel | critical | not run | PASS | ESC guidelines 2023 |  |
| inv-ecg | investigationInclude | critical | not run | FAIL (known gap) | ESC guidelines 2023 | Prompt: epigastric/upper abdominal pain + (age ≥50 or diabetes) + diaphoresis or HR <60 or SBP <100 → 12-lead ECG within 10 min and troponin. |
| inv-troponin | investigationInclude | critical | not run | FAIL (known gap) | ESC guidelines 2023 |  |
| mnm-acs-symptom-engine | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| mgmt-cardiology-or-ems | managementInclude | quality | not run | FAIL (known gap) | ESC guidelines 2023 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |

Failure details:

- **mnm-acs** (web): not in top 3 of web.pane: 1. GORD / Reflux Oesophagitis \| 2. Acute Cholecystitis \| 3. Peptic Ulcer Disease [known gap: Web: PANE has no cardiac (ACS/MI) disease node, so it can never appear in the PANE top 3 (GORD, cholecystitis, peptic ulcer).]
- **mnm-acs-symptom-engine** (web): not in top 5 of web.symptomInference: 1. Acute alcoholic pancreatitis \| 2. Gallstone pancreatitis \| 3. Perforated peptic ulcer \| 4. Acute gastroenteritis \| 5. Gastric carcinoma [known gap: Web: Symptom inference top 5 has no ACS/STEMI (pancreatitis ×2, perforated ulcer, gastroenteritis, gastric carcinoma): epigastric pain, sweating and vomiting do not weight the cardiac entries.]
- **inv-ecg** (web): no investigation matched among 25 (web.pane.seeded, web.clinicalPrompts) [known gap: Web: No ECG suggested; the bradycardia prompt needs HR <50 (HR 52 here).]
- **inv-troponin** (web): no investigation matched among 25 (web.pane.seeded, web.clinicalPrompts) [known gap: Web: No troponin suggested.]
- **mgmt-cardiology-or-ems** (web): no management item matched among 12 (web.clinicalPrompts) [known gap: Web: No cardiology/PCI/emergency-services action.]

Guidelines:

- **esc-acs-2023** — ESC guidelines — acute coronary syndromes (2023) (2023), 12-lead ECG within 10 minutes of first medical contact; hs-troponin; inferior STEMI (right-sided leads); primary PCI. Byrne RA, Rossello X, Coughlan JJ, et al. 2023 ESC guidelines for the management of acute coronary syndromes. Eur Heart J. 2023;44:3720–826. *(statement wording/numbering not yet verified against the source)*

#### `mimic-inferior-mi-ecg-confirmed` — Elderly diabetic woman, ECG shows inferior STEMI

71-year-old diabetic woman with CKD, 6 h upper abdominal discomfort and nausea, HR 48, BP 92/58; ECG: ST elevation II, III, aVF; troponin 412.

Permutation of `mimic-inferior-mi`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-acs | mustNotMiss | critical | not run | FAIL (known gap) | ESC guidelines 2023 |  |
| level-emergency | emergencyLevel | critical | not run | FAIL (known gap) | ESC guidelines 2023 | Feed resulted ECG/troponin into triage and prompts ('ST elevation', troponin above the 99th centile → emergency, STEMI pathway). |
| alarm-stemi | mustAlarm | critical | not run | FAIL (known gap) | ESC guidelines 2023 | Same: an ECG/troponin rule in computeClinicalPrompts. |
| mgmt-reperfusion | managementInclude | critical | not run | FAIL (known gap) | ESC guidelines 2023 | Add an I21 protocol (primary PCI, antiplatelets, cardiology) for the plan tab. |
| mgmt-no-gi-endoscopy | managementExclude | quality | not run | PASS | ESC guidelines 2023 |  |

Failure details:

- **mnm-acs** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Peptic Ulcer Disease \| 3. GORD / Reflux Oesophagitis [known gap: Web: PANE has no cardiac (ACS/MI) disease node, so it can never appear in the PANE top 3 (cholecystitis, peptic ulcer, GORD).]
- **level-emergency** (web): web.triage: urgent (acuity=priority, action=same_day_call, score=30); expected ≥ emergency [known gap: Web: adaptiveTriage: 'same_day_call' (score 30); the resulted ECG (ST elevation) and troponin 412 are not triage inputs, and HR 48/SBP 92 are inside the vital thresholds. iOS: ClinicalPathwayEngine reads only CC/PMH keywords; CC 'Upper abdominal discomfort and nausea' gives 'routine'.]
- **alarm-stemi** (web): no alarm matched among 4 (web.clinicalPrompts.safety) [known gap: Web: No prompt reads ECG results or troponin; the only safety prompt is bradycardia.]
- **mgmt-reperfusion** (web): no management item matched among 16 (web.clinicalPrompts) [known gap: Web: No reperfusion/PCI action; ICD I21.19 has no protocol.]

Guidelines:

- **esc-acs-2023** — ESC guidelines — acute coronary syndromes (2023) (2023), 12-lead ECG within 10 minutes of first medical contact; hs-troponin; inferior STEMI (right-sided leads); primary PCI. Byrne RA, Rossello X, Coughlan JJ, et al. 2023 ESC guidelines for the management of acute coronary syndromes. Eur Heart J. 2023;44:3720–826. *(statement wording/numbering not yet verified against the source)*

### Ruptured abdominal aortic aneurysm (GI emergency mimic)

#### `mimic-ruptured-aaa` — Flank pain labelled renal colic, shocked (base case)

74-year-old smoker, sudden left flank/back pain to the groin, collapse, HR 122, BP 84/50, pulsatile expansile mass, microscopic haematuria; POCUS aorta 7.1 cm. Referred as '?renal colic'.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-aaa-top3 | mustRankTopK | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2024 | Raise the pulsatile_mass and haemodynamic_instability likelihoods for aortic_aneurysm in PANE and add an age/sex prior; add CC_HINTS for collapse + flank/back pain. |
| level-emergency | emergencyLevel | critical | not run | PASS | ESVS clinical practice guidelines 2024 |  |
| alarm-shock | mustAlarm | critical | not run | PASS | ESVS clinical practice guidelines 2024 |  |
| alarm-aaa | mustAlarm | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2024 | Add a prompt: pulsatile/expansile mass or known AAA + pain + hypotension → 'Suspected ruptured AAA — vascular surgery now, permissive hypotension'. |
| mgmt-vascular-repair | managementInclude | critical | not run | FAIL (known gap) | ESVS clinical practice guidelines 2024 | Map the whole I71 family (I71.3, I71.4, I71.9) to the aortic protocol (getProtocolByIcd prefix 'I71'). |
| mgmt-no-nsaid-renal-colic | managementExclude | critical | not run | PASS | ESVS clinical practice guidelines 2024 |  |
| mnm-aaa-symptom-engine | mustNotMiss | quality | not run | PASS |  |  |
| inv-crossmatch | investigationInclude | quality | not run | PASS | ESVS clinical practice guidelines 2024 |  |
| mgmt-permissive-hypotension | managementInclude | quality | not run | FAIL (known gap) | ESVS clinical practice guidelines 2024 |  |
| mgmt-no-large-fluid-bolus | managementExclude | quality | not run | FAIL (known gap) | ESVS clinical practice guidelines 2024 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
...
- **mgmt-vascular-repair** (web): no management item matched among 22 (web.clinicalPrompts) [known gap: Web: No protocol reaches the plan: ICD I71.3 does not start with the aortic protocol's only prefix 'I71.9', and PANE does not select aortic_aneurysm. Only prompts remain (no vascular surgery).]
- **mgmt-permissive-hypotension** (web): no management item matched among 22 (web.clinicalPrompts) [known gap: Web: No permissive hypotension (the aortic protocol has it, but is not reached).]
- **mgmt-no-large-fluid-bolus** (web): forbidden management item present in web.clinicalPrompts: "• 2 × large-bore iv cannulae, hartmann's 1l bolus - reassess bp and hr at 15 min." [known gap: Web: Shock prompt: 'Hartmann's 1L bolus — reassess BP and HR at 15 min' for a ruptured AAA.]

Guidelines:

- **esvs-aaa-2024** — ESVS clinical practice guidelines — abdominal aorto-iliac artery aneurysms (2024) (2024), Ruptured AAA: immediate transfer to vascular surgery, permissive hypotension, CT angiography only if haemodynamically stable enough; symptomatic intact AAA: urgent CTA and repair. Wanhainen A, Van Herzeele I, Bastos Goncalves F, et al. European Society for Vascular Surgery (ESVS) 2024 clinical practice guidelines on the management of abdominal aorto-iliac artery aneurysms. Eur J Vasc Endovasc Surg. 2024;67:192–331. *(statement wording/numbering not yet verified against the source)*

### Testicular torsion (GI emergency mimic)

#### `mimic-testicular-torsion` — Adolescent with lower abdominal pain and vomiting

14-year-old boy, sudden right lower abdominal pain and vomiting for 6 h; on examination a high-riding, horizontal, exquisitely tender right testis with absent cremasteric reflex.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-torsion-top3 | mustRankTopK | critical | not run | FAIL (known gap) | EAU guidelines on paediatric urology 2024 | Read the genital examination and the scrotal chip into PANE (testicular_pain, absent_cremasteric). |
| level-emergency | emergencyLevel | critical | not run | FAIL (known gap) | EAU guidelines on paediatric urology 2024 | Add a triage red flag: male + sudden testicular/scrotal pain (or scrotal-swelling chip) → emergency. |
| alarm-torsion | mustAlarm | critical | not run | PASS | EAU guidelines on paediatric urology 2024 |  |
| mgmt-scrotal-exploration | managementInclude | critical | not run | PASS | EAU guidelines on paediatric urology 2024 |  |
| mgmt-no-doppler-delay | managementExclude | quality | not run | PASS | EAU guidelines on paediatric urology 2024 |  |

Failure details:

- **dx-torsion-top3** (web): not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Inguinal / Femoral Hernia \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE top 3: appendicitis, inguinal/femoral hernia, cholecystitis; the SOCRATES site text 'right testicle (scrotal)' adds testicular features but not enough. Symptom inference ranks torsion #1.]
- **level-emergency** (web): web.triage: urgent (acuity=priority, action=same_day_call, score=35); expected ≥ emergency [known gap: Web: adaptiveTriage: 'same_day_call' (score 35). No torsion/testicular rule; the scrotal-swelling chip does not raise acuity. iOS: ClinicalPathwayEngine reads only CC/PMH keywords; CC 'Right lower abdominal pain and vomiting' gives 'routine'.]
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| flag-nsaid | redFlags | critical | not run | PASS | NICE CG184 2014 |  |
| mgmt-stop-nsaid | managementInclude | critical | not run | PASS | NICE CG184 2014 |  |
| mgmt-no-blanket-stop-aspirin | managementExclude | critical | not run | PASS | NICE CG184 2014 |  |
| level-not-emergency | emergencyLevel | quality | not run | FAIL (known gap) | NICE CG184 2014 | Negation handling in adaptive-triage and computeClinicalPrompts exam-text rules. |
| inv-hpylori | investigationInclude | quality | not run | PASS | NICE CG184 2014; Maastricht VI/Florence consensus report 2022 |  |
| mgmt-ppi-8-weeks | managementInclude | quality | not run | FAIL (known gap) | NICE CG184 2014 |  |
| mgmt-repeat-ogd-gastric-ulcer | managementInclude | quality | not run | PASS | NICE CG184 2014 |  |
| mgmt-no-patient-hold-advice | managementExclude | quality | not run | PASS | NICE CG184 2014 |  |
...
58-year-old man with poorly controlled type 2 diabetes, five days of perianal pain, 6 cm of surrounding cellulitis, T 38.4, HR 104, glucose 19. Drain today and give antibiotics; glycaemic control; examine for necrotising infection.

Permutation of `perianal-abscess-simple`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-abscess-top3 | mustRankTopK | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| level-same-day | emergencyLevel | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-drainage | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mnm-nsti | mustNotMiss | quality | not run | FAIL (known gap) | WSES/SIS-E consensus 2018 |  |
| flag-diabetes | redFlags | quality | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-glycaemic | managementInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
...
- **ascrs-abscess-2022** — ASCRS clinical practice guidelines — anorectal abscess, fistula-in-ano and rectovaginal fistula (2022), Antibiotics after drainage for surrounding cellulitis, systemic infection, diabetes/immunosuppression. Gaertner WB, Burgess PL, Davids JS, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of anorectal abscess, fistula-in-ano, and rectovaginal fistula. Dis Colon Rectum. 2022;65:964–985. *(statement wording/numbering not yet verified against the source)*
- **wses-ssti-2018** — WSES/SIS-E consensus — management of skin and soft-tissue infections (incl. necrotising soft-tissue infection, Fournier’s gangrene) (2018), Necrotising soft-tissue infection: suspect in diabetics with perineal infection; early surgical exploration. Sartelli M, Guirao X, Hardcastle TC, et al. 2018 WSES/SIS-E consensus conference: recommendations for the management of skin and soft-tissue infections. World J Emerg Surg. 2018;13:58. *(statement wording/numbering not yet verified against the source)*

### Perianal abscess in advanced HIV

#### `perianal-abscess-hiv` — Immunosuppressed (HIV, CD4 140)

41-year-old man with HIV (CD4 140, detectable viral load, poor ART adherence) and a perianal abscess. Drain; antibiotics are indicated in immunosuppression; send pus for culture and tissue for histology (atypical infection, anal neoplasia); re-engage HIV care.
...
|---|---|---|---|---|---|---|
| dx-abscess-top3 | mustRankTopK | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| level-same-day | emergencyLevel | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2022 | Add an anorectal-sepsis triage rule (perianal/perineal pain + swelling/lump, or "abscess") → at least same_day_call, and emergency_now with fever + SIRS, diabetes, immunosuppression or spreading erythema. |
| flag-hiv | redFlags | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2022 | Surface HIV/low CD4/biologics/chemotherapy as an immunosuppression flag (triage comorbidity regex + a clinical prompt). |
| mgmt-drainage | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mnm-anal-neoplasia | mustNotMiss | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2018 |  |
| inv-pus-culture | investigationInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2022 |  |

Failure details:

- **mnm-anal-neoplasia** (web): not in top 3 of web.pane: 1. Perianal Abscess / Fistula \| 2. Pilonidal Disease \| 3. Inguinal / Femoral Hernia; also in web.symptomInference#2, web.passive#2 [known gap: Anal cancer is not a PANE disease; symptom inference ranks anal SCC #2.]
- **level-same-day** (web): web.triage: routine (acuity=routine, action=routine_booking, score=8); expected ≥ urgent [known gap: Web adaptiveTriage has no perianal abscess/anorectal sepsis rule: the level depends on the pain score and incidental words (the base abscess reaches "emergency" only via the negated "no weight loss" plus pain 8/10; with pain 6/10 it is routine).]
- **flag-hiv** (web): no red flag matched among 5 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety) [known gap: HIV/immunosuppression in the comorbidity list is not surfaced by triage, prompts or the perianal_abscess protocol (whose IV antibiotic line mentions "immunocompromised" only as an indication).]

Guidelines:

- **ascrs-abscess-2022** — ASCRS clinical practice guidelines — anorectal abscess, fistula-in-ano and rectovaginal fistula (2022), Antibiotics after drainage in immunosuppressed patients; cultures in atypical/immunosuppressed cases. Gaertner WB, Burgess PL, Davids JS, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of anorectal abscess, fistula-in-ano, and rectovaginal fistula. Dis Colon Rectum. 2022;65:964–985. *(statement wording/numbering not yet verified against the source)*
- **ascrs-anal-scc-2018** — ASCRS clinical practice guidelines — anal squamous cell cancers (revised 2018) (2018), People living with HIV are at high risk of anal squamous neoplasia. Stewart DB, Gaertner WB, Glasgow SC, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for anal squamous cell cancers (revised 2018). Dis Colon Rectum. 2018;61:755–774. *(statement wording/numbering not yet verified against the source)*

### Perianal abscess

#### `perianal-abscess-simple` — 

36-year-old man with three days of throbbing perianal pain and a fluctuant tender swelling at 5 o’clock, afebrile, not diabetic or immunosuppressed. ASCRS 2022: prompt incision and drainage; routine antibiotics are not needed after drainage of an uncomplicated abscess.
...
| level-same-day | emergencyLevel | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-drainage | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-no-routine-antibiotics | managementExclude | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2022 |  |
...
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2015 |  |
| flag-dysphagia | redFlags | critical | not run | PASS | NICE NG12 2015 |  |
| inv-imaging-or-endoscopy | investigationInclude | critical | not run | PASS | NICE NG12 2015; ESGE Guideline 2020 |  |
| mnm-pouch | mustNotMiss | quality | not run | FAIL (known gap) | ESGE Guideline 2020 | Add a pharyngeal pouch node (high dysphagia, regurgitation of undigested food, halitosis, gurgling, aspiration) and a K22.5 protocol. |
| inv-barium-first | investigationInclude | quality | not run | FAIL (known gap) | ESGE Guideline 2020 |  |
| mgmt-pouch-treatment-options | managementInclude | quality | not run | FAIL (known gap) | ESGE Guideline 2020 |  |
...
#### `pilonidal-abscess-acute` — 

21-year-old man with a hot, fluctuant swelling in the natal cleft with midline pits. ASCRS 2019: incision and drainage (off-midline), definitive surgery later; no excision in the acute phase.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mgmt-drainage | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2019 |  |
| dx-pilonidal-top3 | mustRankTopK | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2019 |  |
| level-soon | emergencyLevel | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2019 | Add an anorectal-sepsis triage rule (perianal/perineal pain + swelling/lump, or "abscess") → at least same_day_call, and emergency_now with fever + SIRS, diabetes, immunosuppression or spreading erythema. |
| mgmt-no-acute-excision | managementExclude | quality | not run | PASS | ASCRS clinical practice guidelines 2019 |  |

Failure details:

- **dx-pilonidal-top3** (web): not in top 3 of web.pane: 1. Skin Abscess / Furuncle \| 2. Inguinal / Femoral Hernia \| 3. Acute Appendicitis; also in web.symptomInference#1, web.passive#3 [known gap: PANE ranks skin abscess, hernia and appendicitis: the "Posterior midline" site chip is not mapped to a PANE feature and there is no pilonidal CC hint for a presentation template. Symptom inference ranks pilonidal #1.]
- **level-soon** (web): web.triage: routine (acuity=routine, action=routine_booking, score=8); expected ≥ priority [known gap: Web adaptiveTriage has no pilonidal/perianal abscess rule: the level depends on the pain score and incidental words (the base abscess reaches "emergency" only via the negated "no weight loss" plus pain 8/10; with pain 6/10 it is routine).]

Guidelines:

- **ascrs-pilonidal-2019** — ASCRS clinical practice guidelines — management of pilonidal disease (2019), Acute abscess: incision and drainage; definitive excision/flap for chronic disease; hair removal adjunct. Johnson EK, Vogel JD, Cowan ML, et al. The American Society of Colon and Rectal Surgeons’ clinical practice guidelines for the management of pilonidal disease. Dis Colon Rectum. 2019;62:146–157. *(statement wording/numbering not yet verified against the source)*

### Post-polypectomy surveillance — high-risk findings

#### `polyp-surveillance-high-risk-3y` — BSG 2020 high-risk findings (advanced adenoma)

61-year-old woman two weeks after colonoscopy with complete removal of three adenomas, one 14 mm (advanced). BSG/ACPGBI/PHE 2020: one-off surveillance colonoscopy at 3 years.

Permutation of `crc-lynch-surveillance-overdue`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mgmt-3-year-surveillance | managementInclude | quality | not run | PASS | BSG/ACPGBI/PHE post-polypectomy and post-colorectal cancer resection surveillance guidelines 2020 |  |
| mgmt-no-annual-colonoscopy | managementExclude | quality | not run | PASS | BSG/ACPGBI/PHE post-polypectomy and post-colorectal cancer resection surveillance guidelines 2020 |  |

Guidelines:

- **bsg-surv-2020** — BSG/ACPGBI/PHE post-polypectomy and post-colorectal cancer resection surveillance guidelines (2020), High-risk findings → one-off surveillance colonoscopy at 3 years; low-risk findings → no surveillance, return to screening. Rutter MD, East J, Rees CJ, et al. British Society of Gastroenterology/Association of Coloproctology of Great Britain and Ireland/Public Health England post-polypectomy and post-colorectal cancer resection surveillance guidelines. Gut. 2020;69:201–223. *(statement wording/numbering not yet verified against the source)*

### Perforated peptic ulcer

#### `ppu-perforated-peptic-ulcer` — NSAID-related perforation, generalised peritonitis (base case)

47-year-old smoker on regular ibuprofen, sudden severe epigastric pain now generalised, board-like rigidity, HR 112; erect CXR free air.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-perforation-top3 | mustRankTopK | critical | not run | PASS | WSES guidelines 2020 |  |
| level-emergency | emergencyLevel | critical | not run | FAIL (known gap) | WSES guidelines 2020 | Broaden the 'Acute abdominal pain' red flag to allow a site word ('severe upper/lower/central abdominal pain') and add 'sudden severe', 'rigid', 'board-like' and imaging 'free air' as emergency triggers. |
| alarm-perforation | mustAlarm | critical | not run | PASS | WSES guidelines 2020 |  |
| mgmt-surgical-repair | managementInclude | critical | not run | PASS | WSES guidelines 2020 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | WSES guidelines 2020 |  |
| flag-nsaid | redFlags | quality | not run | PASS | WSES guidelines 2020 |  |
| score-rec-boey | scoreRecommended | quality | not run | FAIL (known gap) | WSES guidelines 2020; Boey score (perforated peptic ulcer) 1987 |  |
| inv-group-and-save | investigationInclude | quality | not run | PASS |  |  |
| inv-h-pylori | investigationInclude | quality | not run | PASS | WSES guidelines 2020 |  |
| inv-no-urgent-ogd-in-perforation | investigationExclude | quality | not run | FAIL (known gap) | WSES guidelines 2020 | Add a perforated-ulcer variant (K25–K28 .1/.2/.5/.6) to a peptic-ulcer group separate from 'Upper GI Bleed'; defer OGD to follow-up. |
| mgmt-ppi | managementInclude | quality | not run | PASS | WSES guidelines 2020 |  |
| mgmt-stop-nsaid | managementInclude | quality | not run | PASS | WSES guidelines 2020 |  |
| mgmt-h-pylori-eradication | managementInclude | quality | not run | PASS | WSES guidelines 2020 |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |

Failure details:

- **level-emergency** (web): web.triage: urgent (acuity=priority, action=same_day_call, score=35); expected ≥ emergency [known gap: Web: adaptiveTriage: 'same_day_call' (score 35). The CC 'Sudden severe upper abdominal pain' misses the red-flag regex 'severe (abdominal\|belly\|stomach)? pain' because of the word 'upper'; HR 112 is below the >120 vital flag; rigidity/free air are not read by triage. iOS: ClinicalPathwayEngine reads only CC/PMH keywords; CC 'Sudden severe upper abdominal pain' gives 'routine'.]
...
- **boey-1987** — Boey score (perforated peptic ulcer) (1987), Major medical illness, pre-operative shock (SBP <100 mmHg), perforation >24 h: 0–3. Boey J, Choi SK, Poon A, Alagaratnam TT. Risk stratification in perforated duodenal ulcers. A prospective validation of predictive factors. Ann Surg. 1987;205:22–6. *(statement wording/numbering not yet verified against the source)*

#### `ppu-elderly-steroids-masked` — Elderly on steroids + NSAIDs: signs masked, afebrile sepsis

81-year-old woman on prednisolone and naproxen, 26 h vague abdominal discomfort, new confusion, afebrile, HR 106, BP 96/58, RR 22, WBC 6.1, lactate 3.1, AKI; soft abdomen; CT pneumoperitoneum from a duodenal perforation.

Permutation of `ppu-perforated-peptic-ulcer`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-perforation-top3 | mustRankTopK | critical | not run | PASS | WSES guidelines 2020 |  |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES guidelines 2020; Surviving Sepsis Campaign 2021 |  |
| alarm-perforation | mustAlarm | critical | not run | PASS | WSES guidelines 2020 |  |
| alarm-sepsis | mustAlarm | critical | not run | FAIL (known gap) | Surviving Sepsis Campaign 2021; Third international consensus definitions for sepsis and septic shock (Sepsis-3) 2016 | Add a qSOFA/lactate sepsis rule that does not require fever (RR ≥22, SBP ≤100, altered mentation, lactate ≥2) and treat steroid use/age ≥75 as masking factors. |
| mgmt-surgical-repair | managementInclude | critical | not run | PASS | WSES guidelines 2020 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | WSES guidelines 2020; Surviving Sepsis Campaign 2021 |  |
| flag-steroids-masking | redFlags | quality | not run | FAIL (known gap) |  |  |
| score-rec-qsofa | scoreRecommended | quality | not run | PASS | Third international consensus definitions for sepsis and septic shock (Sepsis-3) 2016 |  |
| score-qsofa-calculator | scoreValue | quality | not run | n/a | Third international consensus definitions for sepsis and septic shock (Sepsis-3) 2016 |  |
| score-qsofa-autofill | scoreValue | quality | not run | n/a | Third international consensus definitions for sepsis and septic shock (Sepsis-3) 2016 |  |
| inv-blood-cultures | investigationInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-steroid-cover | managementInclude | quality | not run | FAIL (known gap) |  |  |
...
- **alarm-sepsis** (web): no alarm matched among 11 (web.triage.vitalRedFlags, web.triage.emergency, web.clinicalPrompts.safety) [known gap: Web: Sepsis prompts need temperature ≥38 °C with HR >100 (or SBP <90 for the shock prompt); an afebrile patient with qSOFA 3, lactate 3.1 and AKI raises no sepsis alarm.]
- **flag-steroids-masking** (web): no red flag matched among 33 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative, web.triage.vitalRedFlags, web.triage.emergency) [known gap: Web: No flag that long-term steroids mask peritonism and fever.]
- **mgmt-steroid-cover** (web): no management item matched among 70 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No steroid-cover prompt.]
...
#### `ppu-septic-shock-delayed` — Delayed presentation with septic shock

58-year-old heavy drinker, 2 days of generalised peritonitis, T 38.8 °C, HR 128, BP 82/50, RR 28, confused, lactate 5.6, AKI; CT pneumoperitoneum.

Permutation of `ppu-perforated-peptic-ulcer`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-perforation-top3 | mustRankTopK | critical | not run | FAIL (known gap) | WSES guidelines 2020 | Add a perforated-viscus node to PANE with rigidity/board-like abdomen, sudden onset and imaging free gas as features (the 'Perforated viscus' CC template exists but has no CC_HINTS entry). |
| level-emergency | emergencyLevel | critical | not run | PASS | Surviving Sepsis Campaign 2021; WSES guidelines 2020 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| alarm-shock | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| alarm-perforation | mustAlarm | critical | not run | PASS | WSES guidelines 2020 |  |
| inv-blood-cultures | investigationInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021; WSES guidelines 2020 |  |
| mgmt-fluids-vasopressor | managementInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-source-control | managementInclude | critical | not run | PASS | WSES guidelines 2020 |  |
| inv-lactate | investigationInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-icu | managementInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |

Failure details:

- **dx-perforation-top3** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Inguinal / Femoral Hernia \| 3. Acute Pancreatitis; also in web.symptomInference#2, web.passive#1 [known gap: Web: PANE top 3: cholecystitis, inguinal/femoral hernia, pancreatitis (alcohol history). PANE has no perforation node and no feature for rigidity/free gas; symptom inference ranks perforated peptic ulcer #2.]
...
### Haemorrhoidal outlet bleeding in a young adult

#### `rectal-bleeding-young-haemorrhoidal` — Clinic, 24-year-old, no red flags

24-year-old woman with three months of intermittent bright red blood on the paper after hard stools; no change in bowel habit, weight loss or anaemia; grade I haemorrhoids on proctoscopy. Outpatient management; no suspected-cancer pathway and no resuscitation.
...
|---|---|---|---|---|---|---|
| dx-haemorrhoids-top3 | mustRankTopK | quality | not run | PASS | ASCRS clinical practice guidelines 2024 |  |
| level-routine-or-priority | emergencyLevel | quality | not run | FAIL (known gap) | NICE NG12 2023 |  |
| mgmt-fibre | managementInclude | quality | not run | PASS | ASCRS clinical practice guidelines 2024 |  |
| mgmt-no-resuscitation | managementExclude | quality | not run | FAIL (known gap) | BSG guideline 2019 |  |
| mgmt-no-2ww | managementExclude | quality | not run | PASS | NICE NG12 2023 |  |
...
- **nice-ng12** — NICE NG12 — suspected cancer: recognition and referral (lower gastrointestinal tract cancers) (2023), Lower GI: rectal bleeding under 50 → consider referral only with abdominal pain, change in bowel habit, weight loss or iron-deficiency anaemia. National Institute for Health and Care Excellence. Suspected cancer: recognition and referral (NG12). First published 2015; lower GI recommendations updated 2023 to incorporate DG56. *(statement wording/numbering not yet verified against the source)*
- **ascrs-haem-2024** — ASCRS clinical practice guidelines — management of hemorrhoids (2024), Dietary fibre first-line; office procedures for grade I–III. Hawkins AT, Davis BR, Bhama AR, et al. The American Society of Colon and Rectal Surgeons clinical practice guidelines for the management of hemorrhoids. Dis Colon Rectum. 2024;67:614–623. *(statement wording/numbering not yet verified against the source)*
- **bsg-lgib-2019** — BSG guideline — diagnosis and management of acute lower gastrointestinal bleeding (2019), Minor outlet bleeding is managed as an outpatient. Oakland K, Chadwick G, East JE, et al. Diagnosis and management of acute lower gastrointestinal bleeding: guidelines from the British Society of Gastroenterology. Gut. 2019;68:776–789. *(statement wording/numbering not yet verified against the source)*

### Incarcerated full-thickness rectal prolapse

#### `rectal-prolapse-incarcerated` — 

79-year-old frail woman with a full-thickness rectal prolapse that has been out and irreducible for 6 hours, oedematous with a dusky segment. Emergency: attempt reduction (sedation, sugar/osmotic), emergency perineal rectosigmoidectomy (Altemeier) if non-viable or irreducible.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | PASS | ASCRS clinical practice guidelines 2017 |  |
| flag-strangulation | redFlags | critical | not run | PASS | ASCRS clinical practice guidelines 2017 |  |
| mgmt-emergency-perineal | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2017 |  |
| dx-prolapse-top3 | mustRankTopK | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2017 |  |
...
#### `sbo-adhesive-base` — Adhesive SBO, no strangulation (base case)

58-year-old woman after open hysterectomy/appendicectomy, 36 h colicky pain, bilious vomiting, distension, no flatus; CT: single transition point, no strangulation features. Stable.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-obstruction-top3 | mustRankTopK | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| inv-ct | investigationInclude | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| no-false-peritonism-alarm | mustNotAlarm | quality | not run | FAIL (known gap) |  | Negation-aware exam() matching ('no peritonism', 'no guarding', 'no rigidity'). |
| inv-lactate | investigationInclude | quality | not run | PASS | WSES Bologna guidelines 2018 |  |
| inv-electrolytes | investigationInclude | quality | not run | PASS |  |  |
| mgmt-ngt | managementInclude | quality | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-iv-fluids | managementInclude | quality | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-water-soluble-contrast | managementInclude | quality | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-surgery-if-nom-fails | managementInclude | quality | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-potassium | managementInclude | quality | not run | FAIL (known gap) |  |  |
| mgmt-no-unrelated-operative-template | managementExclude | quality | not run | FAIL (known gap) |  |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-sbo-adhesional | dxVariant | quality | not run | PASS | WSES Bologna guidelines 2018 |  |

Failure details:

- **no-false-peritonism-alarm** (web): forbidden alarm present in web.clinicalPrompts.safety: "generalised peritonism (guarding / rigidity) - peritonism → perforated viscus / peritonitis" [known gap: Web: computeClinicalPrompts fires 'Generalised peritonism → Perforated viscus' on the substring 'peritonism' in 'no peritonism'.]
- **mgmt-potassium** (web): no management item matched among 58 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No potassium replacement despite K 3.3: getProtocolByIcd('K56.50') returns the generic bowel_obstruction protocol (prefix K56), not adhesion_obstruction, whose medications include KCl.]
- **mgmt-no-unrelated-operative-template** (web): forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." (+1 more) [known gap: Web: Negated exam text ('No guarding, no rebound, no peritonism') triggers both the peritonism prompt ('Emergency laparotomy consent') and the appendicectomy operative-plan prompt.]
...
#### `sbo-gastrografin-failed` — Failed Gastrografin challenge (contrast not in colon at 24 h), day 3

71-year-old woman on day 3 of NOM for adhesive SBO; contrast has not reached the colon at 24 h, NG output 1.6 L/day, no flatus, no strangulation signs.

Permutation of `sbo-adhesive-base`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-surgery | managementInclude | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-surgery-in-documented-plan | managementInclude | quality | not run | FAIL (known gap) | WSES Bologna guidelines 2018 | Add a 'failed NOM' variant (contrast not in colon at 24 h, no resolution by 72 h) with immediate + surgical phases. |
| mgmt-no-repeat-contrast-challenge | managementExclude | quality | not run | FAIL (known gap) | WSES Bologna guidelines 2018 |  |
| mgmt-no-appendicectomy-template | managementExclude | quality | not run | FAIL (known gap) |  |  |
...
- **mgmt-no-appendicectomy-template** (web): forbidden management item present in web.clinicalPrompts: "laparoscopic appendicectomy - operative plan ───────────────────────────────────────────── pre-operative: •..." [known gap: Web: 'no guarding or rebound' in the exam triggers the appendicectomy operative-plan prompt in an SBO patient.]

Guidelines:

- **wses-sbo-2018** — WSES Bologna guidelines — adhesive small bowel obstruction (2017 update) (2018), CT with IV contrast for strangulation signs; non-operative management (NGT, fluids) up to 72 h without strangulation; water-soluble contrast challenge (colon within 24 h predicts success); surgery for strangulation, peritonitis or failed NOM; virgin abdomen and hernia causes. ten Broek RPG, Krielen P, Di Saverio S, et al. Bologna guidelines for diagnosis and management of adhesive small bowel obstruction (ASBO): 2017 update of the evidence-based guidelines from the WSES ASBO working group. World J Emerg Surg. 2018;13:24. *(statement wording/numbering not yet verified against the source)*

#### `sbo-malignant-carcinomatosis` — Malignant (peritoneal carcinomatosis), palliative goals

61-year-old woman with stage IV ovarian cancer and carcinomatosis, 4 days of vomiting and distension; CT: multiple transition points, ascites. Goals: comfort and home.
...
|---|---|---|---|---|---|---|
| dx-obstruction-top3 | mustRankTopK | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | MASCC guidelines 2021 |  |
| mgmt-palliative-mdt | managementInclude | quality | not run | FAIL (known gap) | MASCC guidelines 2021 | Add a malignant-SBO variant (carcinomatosis, multiple transition points) with palliative/oncology MDT and MASCC medical management. |
| mgmt-medical-mbo | managementInclude | quality | not run | FAIL (known gap) | MASCC guidelines 2021 |  |
| mgmt-no-routine-laparotomy | managementExclude | quality | not run | FAIL (known gap) | MASCC guidelines 2021 |  |

Failure details:

- **mgmt-palliative-mdt** (web): no management item matched among 48 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No palliative, oncology or goals-of-care step for malignant obstruction; the plan is the generic bowel-obstruction protocol.]
- **mgmt-medical-mbo** (web): no management item matched among 48 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No antisecretory/antiemetic/steroid or venting-gastrostomy option.]
- **mgmt-no-routine-laparotomy** (web): forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." [known gap: Web: 'no peritonism' in the exam triggers the peritonism prompt: 'Emergency laparotomy consent — source control' for a palliative patient.]

Guidelines:

- **wses-sbo-2018** — WSES Bologna guidelines — adhesive small bowel obstruction (2017 update) (2018), CT with IV contrast for strangulation signs; non-operative management (NGT, fluids) up to 72 h without strangulation; water-soluble contrast challenge (colon within 24 h predicts success); surgery for strangulation, peritonitis or failed NOM; virgin abdomen and hernia causes. ten Broek RPG, Krielen P, Di Saverio S, et al. Bologna guidelines for diagnosis and management of adhesive small bowel obstruction (ASBO): 2017 update of the evidence-based guidelines from the WSES ASBO working group. World J Emerg Surg. 2018;13:24. *(statement wording/numbering not yet verified against the source)*
- **mascc-mbo-2021** — MASCC guidelines — malignant bowel obstruction (2021), Individualised, palliative-focused decision-making; medical management (antisecretory, antiemetic); venting gastrostomy; selective surgery. Davis M, Hui D, Davies A, et al. Medical management of malignant bowel obstruction in patients with advanced cancer: 2021 MASCC guideline update. Support Care Cancer. 2021;29:8089–96. *(statement wording/numbering not yet verified against the source)*

#### `sbo-strangulated-femoral-hernia` — Hernia cause: strangulated femoral hernia (elderly, anticoagulated)

83-year-old woman on apixaban, 2 days of SBO and a tense, tender, irreducible right femoral lump with erythema; T 37.9 °C, HR 112, lactate 2.9; CT: incarcerated femoral hernia with a poorly enhancing loop.

Permutation of `sbo-adhesive-base`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-hernia-top3 | mustRankTopK | critical | not run | FAIL (known gap) | WSES guidelines 2017 | Let PANE read the hernia symptom branch ('Irreducible', 'Femoral') and exam chip 'Hernia present' as hernia_irreducible/groin_swelling evidence. |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES guidelines 2017 |  |
| mgmt-emergency-repair | managementInclude | critical | not run | PASS | WSES guidelines 2017 |  |
| mgmt-no-manual-reduction | managementExclude | critical | not run | PASS | WSES guidelines 2017 |  |
| mgmt-anticoagulant-plan | managementInclude | quality | not run | PASS |  |  |
| variant-hernia-strangulated | dxVariant | quality | not run | PASS | WSES guidelines 2017 |  |

Failure details:

- **dx-hernia-top3** (web): not in top 3 of web.pane: 1. Bowel Obstruction \| 2. Small Bowel Obstruction — Adhesions \| 3. Post-operative Ileus; also in web.triageSurgical#1 [known gap: Web: PANE top 3: bowel obstruction, adhesive SBO, post-operative ileus. The SOCRATES site text 'Right groin lump' maps to groin_swelling but the obstruction features dominate; hernia appears only in the triage surgical match list. The 'hernia' symptom-branch details are not read by PANE.]

Guidelines:

- **wses-sbo-2018** — WSES Bologna guidelines — adhesive small bowel obstruction (2017 update) (2018), CT with IV contrast for strangulation signs; non-operative management (NGT, fluids) up to 72 h without strangulation; water-soluble contrast challenge (colon within 24 h predicts success); surgery for strangulation, peritonitis or failed NOM; virgin abdomen and hernia causes. ten Broek RPG, Krielen P, Di Saverio S, et al. Bologna guidelines for diagnosis and management of adhesive small bowel obstruction (ASBO): 2017 update of the evidence-based guidelines from the WSES ASBO working group. World J Emerg Surg. 2018;13:24. *(statement wording/numbering not yet verified against the source)*
- **wses-hernia-2017** — WSES guidelines — emergency repair of complicated abdominal wall hernias (2017 update) (2017), Strangulation signs; emergency repair; manual reduction not attempted when strangulation is suspected. Birindelli A, Sartelli M, Di Saverio S, et al. 2017 update of the WSES guidelines for emergency repair of complicated abdominal wall hernias. World J Emerg Surg. 2017;12:37. *(statement wording/numbering not yet verified against the source)*

#### `sbo-strangulation` — Strangulation (fever, tachycardia, peritonism, lactate, CT signs)

67-year-old man, previous laparotomy, pain now constant, T 38.4 °C, HR 118, localised peritonism, WBC 19.4, lactate 4.1; CT: closed loop with reduced wall enhancement.
...
|---|---|---|---|---|---|---|
| dx-obstruction-top3 | mustRankTopK | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| level-emergency | emergencyLevel | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| alarm-strangulation | mustAlarm | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-emergency-surgery | managementInclude | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-emergency-surgery-in-documented-plan | managementInclude | critical | not run | FAIL (known gap) | WSES Bologna guidelines 2018 | Same ordering fix; the strangulation variant's surgical phase then carries the operation into the documented plan. |
| mgmt-no-nom-trial-with-strangulation | managementExclude | critical | not run | FAIL (known gap) | WSES Bologna guidelines 2018 | Check sbo_strangulation before sbo_adhesional (specific-first) and drop the conservative phase whenever strangulation words, lactate > 2 with peritonism, or closed-loop appear. |
| inv-lactate | investigationInclude | quality | not run | PASS | WSES Bologna guidelines 2018 |  |
| inv-group-and-save | investigationInclude | quality | not run | PASS |  |  |
| mgmt-antibiotics | managementInclude | quality | not run | PASS | WSES Bologna guidelines 2018 |  |
| variant-sbo-strangulation | dxVariant | quality | not run | FAIL (known gap) | WSES Bologna guidelines 2018 |  |

Failure details:

- **mgmt-emergency-surgery-in-documented-plan** (web): no management item matched among 14 (web.plan) [known gap: Web: detectDxVariants picks 'sbo_adhesional' (keyword 'small bowel obstruction' is checked before 'strangulation'), whose allowed phases exclude 'surgical'; the documented plan has no operation.]
- **mgmt-no-nom-trial-with-strangulation** (web): forbidden management item present in web.plan: "small bowel obstruction - non-operative trial (drip and suck)" (+1 more) [known gap: Web: Documented plan = 'Small Bowel Obstruction — Non-Operative Trial (Drip and Suck)' and the Gastrografin step, for CT-proven strangulation with lactate 4.1.]
- **variant-sbo-strangulation** (web): detected sbo_adhesional in group Bowel Obstruction; expected sbo_strangulation [known gap: Web: First-match order: sbo_adhesional ('small bowel obstruction', 'adhesion') is tested before sbo_strangulation.]
...
#### `sbo-virgin-abdomen` — Virgin abdomen, CT mass lesion (elderly, weight loss)

74-year-old woman with no previous surgery, 2 days of SBO, 3 kg weight loss, no hernia palpable; CT: transition point at a short-segment ileal lesion.
...
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| inv-ct | investigationInclude | critical | not run | PASS | WSES Bologna guidelines 2018 |  |
| mnm-neoplasm | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| mnm-hernia | mustNotMiss | quality | not run | FAIL (known gap) |  |  |
| mgmt-surgical-exploration | managementInclude | quality | not run | PASS | WSES Bologna guidelines 2018 |  |
| mgmt-no-adhesion-label-in-plan | managementExclude | quality | not run | FAIL (known gap) | WSES Bologna guidelines 2018 |  |

Failure details:

- **mnm-neoplasm** (web): not in top 3 of web.pane: 1. Bowel Obstruction \| 2. Acute Cholecystitis \| 3. Acute Appendicitis [known gap: Web: PANE top 3: bowel obstruction, cholecystitis, appendicitis, although weight_loss was extracted; PANE has no small-bowel neoplasm node (colorectal cancer only), and the trigger answer 'After meals' is read as fatty_food_trigger, which lifts cholecystitis.]
- **mnm-hernia** (web): not in top 3 of web.pane: 1. Bowel Obstruction \| 2. Acute Cholecystitis \| 3. Acute Appendicitis [known gap: Web: PANE top 3 has no hernia (no groin feature because no lump was found).]
...
81-year-old nursing-home resident with Parkinson's and chronic constipation, 2 days of massive distension; AXR coffee-bean sign, CT whirl without ischaemia.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-obstruction-top3 | mustRankTopK | critical | not run | PASS | ASCRS clinical practice guidelines 2021 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2021 | Add obstruction red-flag phrases to RULES ('no flatus', 'not passed wind', 'massive/increasing distension') and a volvulus term. |
| mgmt-endoscopic-decompression | managementInclude | critical | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2021; WSES consensus guidelines 2023 | Give lbo_volvulus a real plan prefix: sigmoid — endoscopic detorsion + flatus tube if no peritonitis/ischaemia, then sigmoid colectomy in the same admission; caecal — right hemicolectomy; gangrene/peritonitis — Hartmann's. Split into sigmoid and caecal variants. |
| mnm-volvulus | mustNotMiss | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2021 |  |
| mgmt-same-admission-resection | managementInclude | quality | not run | FAIL (known gap) | ASCRS clinical practice guidelines 2021; WSES consensus guidelines 2023 |  |
| mgmt-potassium | managementInclude | quality | not run | FAIL (known gap) |  |  |
| pathway-first-visit | pathway | quality | not run | n/a |  |  |
| variant-lbo-volvulus | dxVariant | quality | not run | PASS | ASCRS clinical practice guidelines 2021 |  |
...
- **mnm-volvulus** (web): not in top 3 of web.pane: 1. Bowel Obstruction \| 2. Small Bowel Obstruction — Adhesions \| 3. Inguinal / Femoral Hernia; also in web.symptomInference#2, web.passive#3 [known gap: Web: PANE has no volvulus disease node, so it can never appear in the PANE top 3 (bowel obstruction, adhesive SBO, inguinal/femoral hernia). Symptom inference ranks sigmoid volvulus #2.]
- **level-at-least-urgent** (web): web.triage: priority (acuity=review, action=priority_24_48h, score=27); expected ≥ urgent [known gap: Web: adaptiveTriage: 'priority_24_48h' (score 27: age ≥70, vomiting). 'Massive distension' and 'no flatus or stool' are not red-flag phrases ('unable to pass gas/stool' is).]
- **mgmt-endoscopic-decompression** (web): no management item matched among 48 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No endoscopic decompression step in any management output; the lbo_volvulus plan prefix is only a heading ('Sigmoid/Caecal Volvulus — Management:') followed by bowel-obstruction steps. Decompression appears only in the dx-variant urgency note.]
- **mgmt-same-admission-resection** (web): no management item matched among 48 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No sigmoid colectomy after decompression.]
- **mgmt-potassium** (web): no management item matched among 48 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No potassium replacement despite K 3.2.]
...
#### `sigmoid-volvulus-gangrenous` — Gangrene and peritonitis, septic shock

76-year-old man with recurrent sigmoid volvulus, now peritonism, T 38.6 °C, HR 124, BP 88/54, drowsy, lactate 5.2; CT: non-enhancing sigmoid wall, pneumatosis, free gas.

Permutation of `sigmoid-volvulus-base`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | PASS | WSES consensus guidelines 2023; Surviving Sepsis Campaign 2021 |  |
| alarm-sepsis | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| alarm-shock | mustAlarm | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-emergency-resection | managementInclude | critical | not run | PASS | ASCRS clinical practice guidelines 2021; WSES consensus guidelines 2023 |  |
| mgmt-antibiotics | managementInclude | critical | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-no-endoscopic-detorsion-with-gangrene | managementExclude | critical | not run | PASS | ASCRS clinical practice guidelines 2021; WSES consensus guidelines 2023 |  |
| inv-blood-cultures | investigationInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| mgmt-icu | managementInclude | quality | not run | PASS | Surviving Sepsis Campaign 2021 |  |
| variant-lbo-volvulus | dxVariant | quality | not run | PASS | ASCRS clinical practice guidelines 2021 |  |
...
#### `uc-acute-severe-truelove-witts` — 

29-year-old woman with known left-sided UC: 9 bloody stools/day, HR 104, T 37.9 °C, Hb 10.1, ESR 42, CRP 68 — Truelove and Witts acute severe colitis. Admit, IV corticosteroids, stool culture and C. difficile, flexible sigmoidoscopy with biopsies (CMV), VTE prophylaxis, avoid antimotility drugs/opioids/NSAIDs, day-3 assessment.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-admit | emergencyLevel | critical | not run | PASS | BSG consensus guidelines 2019 |  |
| inv-cdiff | investigationInclude | critical | not run | PASS | BSG consensus guidelines 2019; ECCO guidelines 2021 |  |
| mgmt-iv-steroids | managementInclude | critical | not run | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022; BSG consensus guidelines 2019 |  |
| mgmt-vte-prophylaxis | managementInclude | critical | not run | PASS | BSG consensus guidelines 2019 |  |
| mgmt-no-appendicectomy | managementExclude | critical | not run | FAIL (known gap) | BSG consensus guidelines 2019 | Gate the appendicectomy operative-plan prompt on the confirmed working diagnosis (appendicitis) or imaging, not on the words "guarding"/"rebound"; add negation handling (no/without/absent) to exam() matching. |
| mgmt-no-antimotility | managementExclude | critical | not run | PASS | BSG consensus guidelines 2019 |  |
| dx-uc-top3 | mustRankTopK | quality | not run | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022 |  |
| mnm-infective | mustNotMiss | quality | not run | FAIL (known gap) | BSG consensus guidelines 2019 |  |
| score-rec-truelove-witts | scoreRecommended | quality | not run | FAIL (known gap) | BSG consensus guidelines 2019 | Add Truelove and Witts (≥ 6 bloody stools + HR > 90, T > 37.8, Hb < 10.5 g/dL, ESR > 30) and the Oxford day-3 rule (> 8 stools, or 3–8 with CRP > 45) to clinical-scales with a CDS trigger on UC. |
| inv-stool-culture | investigationInclude | quality | not run | PASS | BSG consensus guidelines 2019 |  |
| inv-flexi-biopsy | investigationInclude | quality | not run | PASS | BSG consensus guidelines 2019; ECCO guidelines 2021 |  |
| inv-axr | investigationInclude | quality | not run | PASS | BSG consensus guidelines 2019 |  |
| mgmt-day3-assessment | managementInclude | quality | not run | PASS | Oxford (Travis) criteria 1996; BSG consensus guidelines 2019 |  |
| mgmt-truelove-criteria-correct | managementExclude | quality | not run | FAIL (known gap) | BSG consensus guidelines 2019 | Correct the key point in lib/pane-engine management protocols (colorectalHerniaBreast.ts, ulcerative_colitis): "≥ 6 bloody stools/day plus HR > 90, T > 37.8 °C, Hb < 10.5 g/dL or ESR > 30 mm/h". |

Failure details:

- **mnm-infective** (web): not in top 3 of web.pane: 1. Ulcerative Colitis \| 2. Acute Cholecystitis \| 3. Acute Appendicitis; also in web.symptomInference#4, web.passive#2 [known gap: PANE has no infective colitis or C. difficile disease (see uc-flare-cdiff); symptom inference ranks IBD, not infection, and gastroenteritis only #4 in the passive view.]
...
- **bsg-ibd-2019** — BSG consensus guidelines — management of inflammatory bowel disease in adults (2019), ASUC defined by the Truelove and Witts criteria (Truelove SC, Witts LJ. Br Med J 1955;2:1041–8): ≥ 6 bloody stools daily plus any of fever > 37.8 °C, pulse > 90, Hb < 10.5 g/dL, ESR > 30 mm/h. ASUC: admission, stool culture and C. difficile, flexible sigmoidoscopy with biopsies, IV corticosteroids, VTE prophylaxis, avoid antimotility/opioids/NSAIDs, day-3 assessment. Lamb CA, Kennedy NA, Raine T, et al. British Society of Gastroenterology consensus guidelines on the management of inflammatory bowel disease in adults. Gut. 2019;68(Suppl 3):s1–s106. *(statement wording/numbering not yet verified against the source)*
- **ecco-uc-2022** — ECCO guidelines on therapeutics in ulcerative colitis — medical treatment (2022), Intravenous corticosteroids first-line for acute severe UC. Raine T, Bonovas S, Burisch J, et al. ECCO guidelines on therapeutics in ulcerative colitis: medical treatment. J Crohns Colitis. 2022;16:2–17. *(statement wording/numbering not yet verified against the source)*
- **travis-1996** — Oxford (Travis) criteria — predicting outcome in severe ulcerative colitis (1996), Day 3: > 8 stools/day, or 3–8 stools/day with CRP > 45 mg/L, predicts colectomy. Travis SP, Farrant JM, Ricketts C, et al. Predicting outcome in severe ulcerative colitis. Gut. 1996;38:905–910. *(statement wording/numbering not yet verified against the source)*
- **ecco-infections-2021** — ECCO guidelines — prevention, diagnosis and management of infections in IBD (2021), Exclude C. difficile in every flare; CMV in steroid-refractory colitis. Kucharzik T, Ellul P, Greuter T, et al. ECCO guidelines on the prevention, diagnosis, and management of infections in inflammatory bowel disease. J Crohns Colitis. 2021;15:879–913. *(statement wording/numbering not yet verified against the source)*

### Acute severe ulcerative colitis — steroid-refractory (day 3)

#### `uc-asuc-day3-nonresponse` — Day 3, Oxford/Travis criteria met

Same patient on day 3 of IV hydrocortisone: 10 stools/day, CRP 52 — Travis criteria predict colectomy. Rescue therapy (infliximab or ciclosporin) or colectomy after joint gastroenterology–colorectal review; CMV on biopsies.

Permutation of `uc-acute-severe-truelove-witts`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-inpatient | emergencyLevel | critical | not run | PASS | BSG consensus guidelines 2019 |  |
| mgmt-rescue-therapy | managementInclude | critical | not run | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022; BSG consensus guidelines 2019 |  |
| mgmt-colectomy-option | managementInclude | critical | not run | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022; BSG consensus guidelines 2019 |  |
| inv-cmv | investigationInclude | quality | not run | FAIL (known gap) | ECCO guidelines 2021 | Add "flexible sigmoidoscopy with biopsies incl. CMV (IHC/PCR)" to the ASUC/steroid-refractory steps (ECCO 2021). |
| mgmt-joint-review | managementInclude | quality | not run | PASS | BSG consensus guidelines 2019 |  |

Failure details:

- **inv-cmv** (web): no investigation matched among 44 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: No CMV testing anywhere (UC protocol investigations: bloods, AXR, stool C&S + C. difficile, sigmoidoscopy/colonoscopy, CT).]

Guidelines:

- **travis-1996** — Oxford (Travis) criteria — predicting outcome in severe ulcerative colitis (1996), Day-3 predictors of colectomy: > 8 stools, or 3–8 stools with CRP > 45. Travis SP, Farrant JM, Ricketts C, et al. Predicting outcome in severe ulcerative colitis. Gut. 1996;38:905–910. *(statement wording/numbering not yet verified against the source)*
- **ecco-uc-2022** — ECCO guidelines on therapeutics in ulcerative colitis — medical treatment (2022), Rescue therapy with infliximab or ciclosporin for steroid-refractory ASUC. Raine T, Bonovas S, Burisch J, et al. ECCO guidelines on therapeutics in ulcerative colitis: medical treatment. J Crohns Colitis. 2022;16:2–17. *(statement wording/numbering not yet verified against the source)*
- **ecco-uc-surg-2022** — ECCO guidelines on therapeutics in ulcerative colitis — surgical treatment (2022), Subtotal colectomy with end ileostomy when medical therapy fails; do not delay surgery. Spinelli A, Bonovas S, Burisch J, et al. ECCO guidelines on therapeutics in ulcerative colitis: surgical treatment. J Crohns Colitis. 2022;16:179–189. *(statement wording/numbering not yet verified against the source)*
- **bsg-ibd-2019** — BSG consensus guidelines — management of inflammatory bowel disease in adults (2019), Day-3 assessment; joint medical–surgical care. Lamb CA, Kennedy NA, Raine T, et al. British Society of Gastroenterology consensus guidelines on the management of inflammatory bowel disease in adults. Gut. 2019;68(Suppl 3):s1–s106. *(statement wording/numbering not yet verified against the source)*
- **ecco-infections-2021** — ECCO guidelines — prevention, diagnosis and management of infections in IBD (2021), Exclude CMV in steroid-refractory colitis. Kucharzik T, Ellul P, Greuter T, et al. ECCO guidelines on the prevention, diagnosis, and management of infections in inflammatory bowel disease. J Crohns Colitis. 2021;15:879–913. *(statement wording/numbering not yet verified against the source)*

### Clostridioides difficile infection complicating a UC flare

#### `uc-flare-cdiff` — C. difficile positive, on azathioprine, recent antibiotics

52-year-old woman with UC on azathioprine, 8 loose bloody stools/day after ciprofloxacin for a UTI; C. difficile GDH and toxin positive. Treat CDI (oral vancomycin or fidaxomicin); do not escalate immunosuppression on the assumption of a simple flare.

Permutation of `uc-acute-severe-truelove-witts`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mnm-cdiff | mustNotMiss | critical | not run | FAIL (known gap) | ECCO guidelines 2021; IDSA/SHEA focused update 2021 | Add a C. difficile disease/protocol (triggers: recent antibiotics, hospital/care-home exposure, toxin-positive result): oral vancomycin or fidaxomicin; fulminant: oral/rectal vancomycin + IV metronidazole, surgical consultation (IDSA/SHEA 2017/2021, WSES 2019). Read a toxin-positive lab result. |
| mgmt-cdi-treatment | managementInclude | critical | not run | FAIL (known gap) | IDSA/SHEA focused update 2021; ECCO guidelines 2021 | Add a C. difficile disease/protocol (triggers: recent antibiotics, hospital/care-home exposure, toxin-positive result): oral vancomycin or fidaxomicin; fulminant: oral/rectal vancomycin + IV metronidazole, surgical consultation (IDSA/SHEA 2017/2021, WSES 2019). Read a toxin-positive lab result. |
| level-at-least-priority | emergencyLevel | quality | not run | PASS | IDSA/SHEA focused update 2021 |  |

Failure details:

- **mnm-cdiff** (web): not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Haemorrhoids \| 3. Acute Appendicitis [known gap: C. difficile infection does not exist in PANE (no disease) or in the management protocols (A04.7 → no protocol); web symptom inference has only "Acute gastroenteritis".]
- **mgmt-cdi-treatment** (web): no management item matched among 28 (web.clinicalPrompts) [known gap: C. difficile infection does not exist in PANE (no disease) or in the management protocols (A04.7 → no protocol); web symptom inference has only "Acute gastroenteritis". No output treats CDI (no vancomycin/fidaxomicin).]

Guidelines:

- **ecco-infections-2021** — ECCO guidelines — prevention, diagnosis and management of infections in IBD (2021), Test for C. difficile in every flare; treat with vancomycin or fidaxomicin; immunosuppression decisions individualised. Kucharzik T, Ellul P, Greuter T, et al. ECCO guidelines on the prevention, diagnosis, and management of infections in inflammatory bowel disease. J Crohns Colitis. 2021;15:879–913. *(statement wording/numbering not yet verified against the source)*
- **idsa-cdi-2021** — IDSA/SHEA focused update — management of Clostridioides difficile infection in adults (2021), Initial CDI episode: fidaxomicin preferred, oral vancomycin acceptable. Johnson S, Lavergne V, Skinner AM, et al. Clinical practice guideline by the Infectious Diseases Society of America (IDSA) and Society for Healthcare Epidemiology of America (SHEA): 2021 focused update guidelines on management of Clostridioides difficile infection in adults. Clin Infect Dis. 2021;73:e1029–e1044. *(statement wording/numbering not yet verified against the source)*

### Steroid-refractory ulcerative colitis with CMV colitis

#### `uc-steroid-refractory-cmv` — Immunosuppressed (azathioprine + infliximab), CMV on biopsy

45-year-old man on azathioprine and infliximab, day 5 of IV steroids without response; flexible sigmoidoscopy biopsies show CMV inclusions on immunohistochemistry. ECCO 2021: antiviral therapy (IV ganciclovir) for steroid-refractory colitis with CMV; colectomy discussion if no response.

Permutation of `uc-acute-severe-truelove-witts`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| inv-cmv | investigationInclude | critical | not run | FAIL (known gap) | ECCO guidelines 2021 | Read biopsy/IHC results for CMV in UC; steroid-refractory UC → CMV testing prompt (ECCO 2021). |
| mgmt-antiviral | managementInclude | critical | not run | FAIL (known gap) | ECCO guidelines 2021 | Add a CMV-colitis branch: CMV on biopsy in steroid-refractory UC → IV ganciclovir, review immunomodulators (ECCO 2021). |
| mgmt-colectomy-option | managementInclude | quality | not run | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022 |  |

Failure details:

- **inv-cmv** (web): no investigation matched among 36 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: The CMV-positive biopsy result is not read and no output mentions CMV.]
- **mgmt-antiviral** (web): no management item matched among 45 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No antiviral (ganciclovir) anywhere; the UC plan escalates immunosuppression (infliximab, ciclosporin, tofacitinib) regardless of CMV.]

Guidelines:

- **ecco-infections-2021** — ECCO guidelines — prevention, diagnosis and management of infections in IBD (2021), CMV: test tissue (IHC/PCR) in steroid-refractory colitis; antiviral therapy (ganciclovir) when CMV colitis is present; review immunomodulators. Kucharzik T, Ellul P, Greuter T, et al. ECCO guidelines on the prevention, diagnosis, and management of infections in inflammatory bowel disease. J Crohns Colitis. 2021;15:879–913. *(statement wording/numbering not yet verified against the source)*
- **ecco-uc-surg-2022** — ECCO guidelines on therapeutics in ulcerative colitis — surgical treatment (2022), Colectomy when medical therapy fails. Spinelli A, Bonovas S, Burisch J, et al. ECCO guidelines on therapeutics in ulcerative colitis: surgical treatment. J Crohns Colitis. 2022;16:179–189. *(statement wording/numbering not yet verified against the source)*

### Toxic megacolon complicating ulcerative colitis

#### `uc-toxic-megacolon` — Toxic megacolon (colonic dilatation with systemic toxicity)

34-year-old man with a UC flare now distended with fewer stools, T 38.9, HR 126, BP 94/58; AXR transverse colon 7.8 cm with mucosal islands. Emergency: resuscitation, IV steroids and antibiotics, urgent colorectal surgery (subtotal colectomy); colonoscopy and antimotility drugs contraindicated.

Permutation of `uc-acute-severe-truelove-witts`.

| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | not run | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022; BSG consensus guidelines 2019 |  |
| alarm-toxic | mustAlarm | critical | not run | PASS | BSG consensus guidelines 2019 |  |
| flag-megacolon | redFlags | critical | not run | PASS | BSG consensus guidelines 2019 |  |
| inv-no-colonoscopy | investigationExclude | critical | not run | FAIL (known gap) | BSG consensus guidelines 2019 | Mark the UC colonoscopy investigation conditional ("not in acute severe colitis/toxic megacolon — limited unprepared flexible sigmoidoscopy only") and add a toxic-megacolon dx-variant that drops endoscopy. |
| mgmt-colectomy | managementInclude | critical | not run | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022 |  |
| mgmt-no-antimotility | managementExclude | critical | not run | PASS | BSG consensus guidelines 2019 |  |
| mnm-perforation | mustNotMiss | quality | not run | FAIL (known gap) | ECCO guidelines on therapeutics in ulcerative colitis 2022 |  |
| mgmt-iv-steroids | managementInclude | quality | not run | PASS | BSG consensus guidelines 2019 |  |

Failure details:

- **mnm-perforation** (web): not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Acute Cholangitis \| 3. Acute Cholecystitis [known gap: PANE top 3 is appendicitis/cholangitis/cholecystitis for a distended toxic colitis; no toxic megacolon/perforation disease and the UC prior is not reached from "Acute abdominal pain".]
- **inv-no-colonoscopy** (web): forbidden investigation present in web.plan.investigations: "flexible sigmoidoscopy / colonoscopy + biopsies" [known gap: The ulcerative_colitis protocol lists "Flexible sigmoidoscopy / colonoscopy + biopsies" as an urgent investigation with no severity condition, so the documented plan orders a colonoscopy in toxic megacolon.]

Guidelines:

- **bsg-ibd-2019** — BSG consensus guidelines — management of inflammatory bowel disease in adults (2019), Toxic megacolon: colonic dilatation with systemic toxicity; stop antimotility/opioids/anticholinergics; urgent surgical opinion. Lamb CA, Kennedy NA, Raine T, et al. British Society of Gastroenterology consensus guidelines on the management of inflammatory bowel disease in adults. Gut. 2019;68(Suppl 3):s1–s106. *(statement wording/numbering not yet verified against the source)*
- **ecco-uc-surg-2022** — ECCO guidelines on therapeutics in ulcerative colitis — surgical treatment (2022), Emergency subtotal colectomy with end ileostomy for toxic megacolon, perforation or haemorrhage. Spinelli A, Bonovas S, Burisch J, et al. ECCO guidelines on therapeutics in ulcerative colitis: surgical treatment. J Crohns Colitis. 2022;16:179–189. *(statement wording/numbering not yet verified against the source)*
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-ugib-top3 | mustRankTopK | critical | not run | FAIL (known gap) | ESGE Guideline 2021 | socrates-to-features.ts: add ASSOC/CC rules haematemesis\|vomiting blood\|coffee.?ground → haematemesis and melaena\|black\|tarry → melaena; also seed PANE from SmartSymptomPicker chips (HpiTab.reseedPane), not only the SOCRATES answers. |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| alarm-gi-bleed | mustAlarm | critical | not run | PASS | ESGE Guideline 2021 |  |
| inv-group-save | investigationInclude | critical | not run | PASS | BSG-led multisociety consensus care bundle 2020 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| mgmt-ogd-within-24h | managementInclude | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012; ACG Clinical Guideline 2021 |  |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021; HALT-IT randomised trial 2020 | Remove tranexamic acid from the upper_gi_bleed protocol medications (ESGE 2021 recommends against it; HALT-IT). Surgeon sign-off needed. |
| flag-nsaid | redFlags | quality | not run | PASS | ESGE Guideline 2021 |  |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021; Glasgow-Blatchford score 2000 |  |
| inv-fbc-urea | investigationInclude | quality | not run | PASS | NICE CG141 2012 |  |
| mgmt-restrictive-transfusion | managementInclude | quality | not run | PASS | ESGE Guideline 2021; BSG-led multisociety consensus care bundle 2020 |  |
| mgmt-ppi | managementInclude | quality | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| mgmt-stop-nsaid | managementInclude | quality | not run | FAIL (known gap) | ESGE Guideline 2021; NICE CG184 2014 |  |
| mgmt-hpylori | managementInclude | quality | not run | PASS | ESGE Guideline 2021; Maastricht VI/Florence consensus report 2022 |  |
| variant-nonvariceal | dxVariant | quality | not run | PASS | ESGE Guideline 2021 |  |
...
|---|---|---|---|---|---|---|
| dx-ugib-top3 | mustRankTopK | critical | not run | FAIL (known gap) | ESGE Guideline 2021 | socrates-to-features.ts: add ASSOC/CC rules haematemesis\|vomiting blood\|coffee.?ground → haematemesis and melaena\|black\|tarry → melaena; also seed PANE from SmartSymptomPicker chips (HpiTab.reseedPane), not only the SOCRATES answers. |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | ESGE Guideline 2021 |  |
| flag-antiplatelet | redFlags | critical | not run | PASS | ESGE Guideline 2021 |  |
| inv-group-save | investigationInclude | critical | not run | PASS | BSG-led multisociety consensus care bundle 2020 |  |
| mgmt-ogd-within-24h | managementInclude | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| mgmt-no-blanket-stop-aspirin | managementExclude | critical | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021; HALT-IT randomised trial 2020 | Remove tranexamic acid from the upper_gi_bleed protocol medications (ESGE 2021 recommends against it; HALT-IT). Surgeon sign-off needed. |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-transfusion-threshold-8 | managementInclude | quality | not run | PASS | ESGE Guideline 2021; BSG-led multisociety consensus care bundle 2020 |  |
| mgmt-cardiology-antiplatelet-decision | managementInclude | quality | not run | FAIL (known gap) | ESGE Guideline 2021 | Add an antiplatelet-in-GI-bleed prompt (aspirin/clopidogrel/ticagrelor/prasugrel): "Clinician/cardiology decision — ESGE: do not interrupt low-dose aspirin for secondary prevention; P2Y12 with cardiology". |
| mgmt-no-patient-hold-advice | managementExclude | quality | not run | PASS | ESGE Guideline 2021 |  |
...
| dx-ugib-top3 | mustRankTopK | critical | not run | PASS | ESGE Guideline 2021 |  |
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | ESGE Guideline 2021 |  |
| flag-anticoagulant | redFlags | critical | not run | PASS | ESGE Guideline 2021 |  |
| inv-group-save | investigationInclude | critical | not run | PASS | BSG-led multisociety consensus care bundle 2020 |  |
| mgmt-ogd-within-24h | managementInclude | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| mgmt-no-lmwh-bridging | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021 | clinical-inference.ts anticoag_check: suppress the bridging template when GI haemorrhage is present (gi_bleed_panel fired) and replace it with "Anticoagulant: withhold/reversal decision by clinician (ESGE 2021)". |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021; HALT-IT randomised trial 2020 | Remove tranexamic acid from the upper_gi_bleed protocol medications (ESGE 2021 recommends against it; HALT-IT). Surgeon sign-off needed. |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021; Glasgow-Blatchford score 2000 |  |
| score-rec-rockall | scoreRecommended | quality | not run | PASS | Rockall score 1996; NICE CG141 2012 |  |
| inv-renal-function | investigationInclude | quality | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-transfusion-threshold-8 | managementInclude | quality | not run | FAIL (known gap) | ESGE Guideline 2021 | upper_gi_bleed protocol: add the ESGE cardiovascular threshold (Hb ≤8 g/dL, target ≥10) and key it on cardiac comorbidity. |
...
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | ESGE Guideline 2021 |  |
| alarm-gi-bleed | mustAlarm | critical | not run | PASS | ESGE Guideline 2021 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-ogd-within-24h | managementInclude | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021; HALT-IT randomised trial 2020 | Remove tranexamic acid from the upper_gi_bleed protocol medications (ESGE 2021 recommends against it; HALT-IT). Surgeon sign-off needed. |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021 |  |
| variant-nonvariceal | dxVariant | quality | not run | PASS | ESGE Guideline 2021 |  |
...
| dx-ugib-top3 | mustRankTopK | critical | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021; HALT-IT randomised trial 2020 | Remove tranexamic acid from the upper_gi_bleed protocol medications (ESGE 2021 recommends against it; HALT-IT). Surgeon sign-off needed. |
| level-not-emergency | emergencyLevel | quality | not run | PASS | ESGE Guideline 2021; ACG Clinical Guideline 2021 |  |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021; Glasgow-Blatchford score 2000 |  |
| inv-ogd | investigationInclude | quality | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-outpatient | managementInclude | quality | not run | FAIL (known gap) | ESGE Guideline 2021; ACG Clinical Guideline 2021; BSG-led multisociety consensus care bundle 2020 | upper_gi_bleed protocol / gi_bleed_panel prompt: add "GBS ≤1 — outpatient endoscopy, no admission (ESGE 2021, ACG 2021)" keyed on the calculated GBS. |
| mgmt-no-transfusion | managementExclude | quality | not run | FAIL (known gap) | ESGE Guideline 2021 | gi_bleed_panel: make the resuscitation/crossmatch line conditional on instability, Hb or GBS. |
...
|---|---|---|---|---|---|---|
| dx-ugib-top3 | mustRankTopK | critical | not run | FAIL (known gap) | ESGE Guideline 2021 | socrates-to-features.ts: add ASSOC/CC rules haematemesis\|vomiting blood\|coffee.?ground → haematemesis and melaena\|black\|tarry → melaena; also seed PANE from SmartSymptomPicker chips (HpiTab.reseedPane), not only the SOCRATES answers. |
| level-emergency | emergencyLevel | critical | not run | PASS | NICE CG141 2012; ESGE Guideline 2021 |  |
| alarm-haemodynamic | mustAlarm | critical | not run | PASS | ESGE Guideline 2021 |  |
| alarm-gi-bleed | mustAlarm | critical | not run | PASS | ESGE Guideline 2021 |  |
| inv-group-crossmatch | investigationInclude | critical | not run | PASS | BSG-led multisociety consensus care bundle 2020 |  |
| mgmt-resuscitation | managementInclude | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| mgmt-transfusion | managementInclude | critical | not run | PASS | ESGE Guideline 2021; BSG-led multisociety consensus care bundle 2020 |  |
| mgmt-endoscopy-after-resus | managementInclude | critical | not run | PASS | NICE CG141 2012; ESGE Guideline 2021 |  |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021; HALT-IT randomised trial 2020 | Remove tranexamic acid from the upper_gi_bleed protocol medications (ESGE 2021 recommends against it; HALT-IT). Surgeon sign-off needed. |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021; Glasgow-Blatchford score 2000 |  |
| inv-coagulation | investigationInclude | quality | not run | PASS | BSG-led multisociety consensus care bundle 2020 |  |
| mgmt-critical-care | managementInclude | quality | not run | FAIL (known gap) | BSG-led multisociety consensus care bundle 2020 | dx-variants.ts: order ugib_variceal before ugib_nonvariceal_stable (most specific first) and add an unstable variant; keep lint:dx-phases in step. |
| mgmt-escalation-ir-surgery | managementInclude | quality | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
...
| level-at-least-urgent | emergencyLevel | critical | not run | PASS | ESGE Guideline 2021 |  |
| flag-anticoagulant | redFlags | critical | not run | PASS | ESGE Guideline 2021 |  |
| inv-inr | investigationInclude | critical | not run | PASS | ESGE Guideline 2021 |  |
| inv-group-save | investigationInclude | critical | not run | PASS | BSG-led multisociety consensus care bundle 2020 |  |
| mgmt-ogd-within-24h | managementInclude | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| mgmt-no-lmwh-bridging | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021 | clinical-inference.ts anticoag_check: suppress the bridging template when GI haemorrhage is present (gi_bleed_panel fired) and replace it with "Anticoagulant: withhold/reversal decision by clinician (ESGE 2021)". |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | FAIL (known gap) | ESGE Guideline 2021; HALT-IT randomised trial 2020 | Remove tranexamic acid from the upper_gi_bleed protocol medications (ESGE 2021 recommends against it; HALT-IT). Surgeon sign-off needed. |
| flag-coagulopathy | redFlags | quality | not run | PASS | ESGE Guideline 2021 |  |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-reversal-considered | managementInclude | quality | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-no-patient-hold-advice | managementExclude | quality | not run | PASS | ESGE Guideline 2021 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| mgmt-high-dose-ppi-72h | managementInclude | critical | not run | PASS | ESGE Guideline 2021; NICE CG141 2012 |  |
| mgmt-no-tranexamic-acid | managementExclude | critical | not run | PASS | ESGE Guideline 2021; HALT-IT randomised trial 2020 |  |
| score-rec-rockall | scoreRecommended | quality | not run | PASS | Rockall score 1996; NICE CG141 2012 |  |
| score-rec-forrest | scoreRecommended | quality | not run | PASS | ESGE Guideline 2021 |  |
| inv-hpylori | investigationInclude | quality | not run | PASS | ESGE Guideline 2021; Maastricht VI/Florence consensus report 2022 |  |
| mgmt-hpylori-eradication | managementInclude | quality | not run | PASS | ESGE Guideline 2021; Maastricht VI/Florence consensus report 2022 |  |
| mgmt-oral-ppi-continuation | managementInclude | quality | not run | PASS | ESGE Guideline 2021 |  |
| mgmt-no-routine-second-look | managementExclude | quality | not run | PASS | ESGE Guideline 2021 |  |
| variant-nonvariceal | dxVariant | quality | not run | PASS | ESGE Guideline 2021 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-gastric-cancer-top3 | mustRankTopK | critical | not run | FAIL (known gap) | NICE NG12 2015 | pane-engine modifiers: age ≥55 multiplier for gastric/oesophageal carcinoma (as colorectal has); consider weight_loss likelihoods. |
| level-at-least-priority | emergencyLevel | critical | not run | PASS | NICE NG12 2015 |  |
| flag-cancer-weight-loss | redFlags | critical | not run | PASS | NICE NG12 2015 |  |
| inv-ogd | investigationInclude | critical | not run | PASS | NICE NG12 2015 |  |
| inv-fbc | investigationInclude | quality | not run | PASS | NICE NG12 2015 |  |
| mgmt-urgent-two-week-ogd | managementInclude | quality | not run | PASS | NICE NG12 2015 |  |
...
| Expectation | Kind | Severity | ios | web | Guideline | Proposed fix |
|---|---|---|---|---|---|---|
| dx-ugib-top3 | mustRankTopK | critical | not run | FAIL (known gap) | Baveno VII 2022 | socrates-to-features.ts: add ASSOC/CC rules haematemesis\|vomiting blood\|coffee.?ground → haematemesis and melaena\|black\|tarry → melaena; also seed PANE from SmartSymptomPicker chips (HpiTab.reseedPane), not only the SOCRATES answers. |
| level-emergency | emergencyLevel | critical | not run | PASS | Baveno VII 2022 |  |
| alarm-haemodynamic | mustAlarm | critical | not run | PASS | Baveno VII 2022 |  |
| inv-group-crossmatch | investigationInclude | critical | not run | PASS | NICE CG141 2012 |  |
| mgmt-vasoactive | managementInclude | critical | not run | FAIL (known gap) | Baveno VII 2022; NICE CG141 2012 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| mgmt-antibiotic-prophylaxis | managementInclude | critical | not run | FAIL (known gap) | Baveno VII 2022; NICE CG141 2012 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| mgmt-endoscopy-12h | managementInclude | critical | not run | FAIL (known gap) | Baveno VII 2022 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| mgmt-band-ligation | managementInclude | critical | not run | FAIL (known gap) | Baveno VII 2022; NICE CG141 2012 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| mgmt-no-liberal-transfusion-varices | managementExclude | critical | not run | PASS | Baveno VII 2022; Restrictive vs liberal transfusion in acute upper GI bleeding (RCT) 2013 |  |
| mnm-variceal | mustNotMiss | quality | not run | FAIL (known gap) | Baveno VII 2022 | Add a variceal haemorrhage node to pane-engine (features: haematemesis, known cirrhosis/alcohol, ascites, splenomegaly, jaundice). |
| flag-cirrhosis | redFlags | quality | not run | PASS | Baveno VII 2022 |  |
| score-rec-child-pugh | scoreRecommended | quality | not run | PASS | Baveno VII 2022 |  |
| score-rec-gbs | scoreRecommended | quality | not run | PASS | NICE CG141 2012 |  |
| inv-inr-lfts | investigationInclude | quality | not run | PASS | Baveno VII 2022 |  |
| mgmt-restrictive-transfusion-varices | managementInclude | quality | not run | FAIL (known gap) | Baveno VII 2022; Restrictive vs liberal transfusion in acute upper GI bleeding (RCT) 2013 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| mgmt-pre-emptive-tips | managementInclude | quality | not run | FAIL (known gap) | Baveno VII 2022 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| mgmt-no-tranexamic-acid | managementExclude | quality | not run | PASS | HALT-IT randomised trial 2020 |  |
| variant-variceal | dxVariant | quality | not run | FAIL (known gap) | Baveno VII 2022 | dx-variants.ts: order ugib_variceal before ugib_nonvariceal_stable (most specific first) and add an unstable variant; keep lint:dx-phases in step. |
...
| level-emergency | emergencyLevel | critical | not run | PASS | Baveno VII 2022 |  |
| mgmt-vasoactive | managementInclude | critical | not run | FAIL (known gap) | Baveno VII 2022; NICE CG141 2012 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| mgmt-antibiotic-prophylaxis | managementInclude | critical | not run | FAIL (known gap) | Baveno VII 2022 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| mgmt-no-liberal-transfusion-varices | managementExclude | critical | not run | PASS | Baveno VII 2022; Restrictive vs liberal transfusion in acute upper GI bleeding (RCT) 2013 |  |
| mnm-variceal | mustNotMiss | quality | not run | FAIL (known gap) | Baveno VII 2022 |  |
| flag-liver-disease | redFlags | quality | not run | PASS | Baveno VII 2022 |  |
| score-rec-child-pugh | scoreRecommended | quality | not run | PASS | Baveno VII 2022 |  |
| inv-inr-lfts | investigationInclude | quality | not run | PASS | Baveno VII 2022 |  |
| mgmt-band-ligation | managementInclude | quality | not run | FAIL (known gap) | Baveno VII 2022 | Add I85 to the upper_gi_bleed protocol icd10Prefixes or add a dedicated variceal protocol (Baveno VII: vasoactive + ceftriaxone + EVL ≤12 h + restrictive Hb 7–8 + pre-emptive TIPS); fix its "80–100 in varices" transfusion target at the same time. |
| variant-variceal | dxVariant | quality | not run | FAIL (known gap) | Baveno VII 2022 | dx-variants.ts: order ugib_variceal before ugib_nonvariceal_stable (most specific first) and add an unstable variant; keep lint:dx-phases in step. |
...
| `ami-embolic-af` | mgmt-revascularisation | web | critical | known gap | no management item matched among 47 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: Ischaemic colitis protocol has no revascularisation or vascular-surgery step. |
| `ami-infarction-septic-shock` | mnm-mesenteric | web | critical | known gap | not in top 3 of web.pane: 1. Inguinal / Femoral Hernia \| 2. Acute Cholecystitis \| 3. Acute Cholangitis [known gap: Web: PANE has no acute mesenteric ischaemia disease node, so it can never appear in the PANE top 3 (inguinal/femoral hernia |
| `ami-infarction-septic-shock` | mgmt-revascularisation | web | critical | known gap | no management item matched among 62 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No revascularisation step; only laparotomy/resection templates.] |
| `ami-venous-thrombosis-ocp` | mnm-mesenteric | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Acute Appendicitis \| 3. Bowel Obstruction; also in web.symptomInference#4, web.passive#3 [known gap: Web: PANE has no mesenteric ischaemia / venous thrombosis disease node, so it can n |
| `ami-venous-thrombosis-ocp` | level-at-least-urgent | web | critical | known gap | web.triage: priority (acuity=review, action=priority_24_48h, score=20); expected ≥ urgent [known gap: Web: adaptiveTriage: 'priority_24_48h' (score 20); the only reasons are 'Pregnancy mentioned' (from 'pregnancy test negative') and pain sc |
| `ami-venous-thrombosis-ocp` | inv-thrombophilia | web | quality | known gap | no investigation matched among 34 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: Web: No thrombophilia work-up.] |
| `ami-venous-thrombosis-ocp` | mgmt-stop-cocp | web | quality | known gap | no management item matched among 38 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No prompt to stop the oestrogen-containing pill.] |
| `ami-venous-thrombosis-ocp` | mgmt-no-laparotomy-without-peritonitis | web | quality | known gap | forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." [known gap: Web: 'no guarding or peritonism' triggers the peritonism prompt ('Emergency laparotomy consent')  |
| `anal-cancer-red-flags` | mnm-anal-cancer | web | critical | known gap | not in top 3 of web.pane: 1. Haemorrhoids \| 2. Anal Fissure \| 3. Colorectal Cancer; also in web.symptomInference#2, web.passive#1 [known gap: Anal cancer is not a PANE disease (top 3: haemorrhoids, fissure, colorectal cancer); symptom inf |
| `anal-cancer-red-flags` | inv-biopsy | web | critical | known gap | no investigation matched among 20 (web.pane.seeded, web.clinicalPrompts) [known gap: No output asks for EUA/biopsy of the anal lesion: C21.0 has no protocol; the plan shown is the haemorrhoids protocol (PANE top) and colonoscopy + biopsy fr |
| `anal-cancer-red-flags` | inv-hiv-test | web | quality | known gap | no investigation matched among 20 (web.pane.seeded, web.clinicalPrompts) [known gap: No HIV test is suggested for anal cancer.] |
| `anal-cancer-red-flags` | mgmt-chemoradiotherapy | web | quality | known gap | no management item matched among 22 (web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No chemoradiotherapy/oncology output (no anal cancer protocol); the management panel shows the haemorrhoid protocol.] |
| `anal-fissure-acute-posterior` | level-routine | web | quality | known gap | web.triage: emergency (acuity=urgent, action=emergency_now, score=123); expected ≤ priority [known gap: Web adaptiveTriage has no negation handling and treats any "bleed/bleeding" as an urgent red flag (RED_FLAGS "GI or other bleeding" → em |
...
| `anal-fissure-atypical-lateral-hiv` | mnm-anal-cancer | web | critical | known gap | not in top 3 of web.pane: 1. Anal Fissure \| 2. Haemorrhoids \| 3. Inguinal / Femoral Hernia; also in web.symptomInference#5, web.passive#5 [known gap: Anal cancer is not a PANE disease (no disease, no ulcer feature used); symptom inference |
| `anal-fissure-atypical-lateral-hiv` | mnm-sti-crohn | web | quality | known gap | not in top 3 of web.pane: 1. Anal Fissure \| 2. Haemorrhoids \| 3. Inguinal / Femoral Hernia [known gap: Syphilis/HSV/TB/Crohn’s are not in the PANE top 3 for an atypical fissure (the protocol red flag mentions them).] |
| `anal-fissure-atypical-lateral-hiv` | inv-eua-biopsy | web | critical | known gap | no investigation matched among 11 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: The anal_fissure protocol has no EUA/biopsy investigation (only "biopsy if non-healing after 8 weeks" in red flags), and the atypi |
...
| `appendicitis-antibiotics-first-coda` | mnm-gynaecological | web | quality | known gap | not in top 5 of web.symptomInference: 1. Acute appendicitis \| 2. Acute appendicitis (paediatric) \| 3. Acute alcoholic pancreatitis \| 4. Acute gastroenteritis \| 5. Typhoid fever [known gap: Web: Symptom inference top 5: appendicitis ×2,  |
...
| `appendicitis-generalised-peritonitis-sepsis` | variant-generalised-peritonitis | web | quality | known gap | detected appendicitis_uncomplicated in group Acute Appendicitis; expected appendicitis_generalised_peritonitis [known gap: Web: Same first-match problem: 'appendicitis' in the uncomplicated variant wins over 'generalised peritonitis'; the p |
| `appendicitis-immunosuppressed-transplant` | flag-immunosuppression | web | quality | known gap | no red flag matched among 24 (web.triage.reasons, web.protocol.redFlags, web.dxVariant.urgencyNote, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: Web: Tria |
| `appendicitis-immunosuppressed-transplant` | mgmt-steroid-cover | web | quality | known gap | no management item matched among 59 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No peri-operative steroid-cover prompt for a patient on long-term prednisolon |
| `appendicitis-paediatric-9y` | mnm-mesenteric-adenitis | web | quality | known gap | not in top 5 of web.symptomInference: 1. Acute appendicitis (paediatric) \| 2. Acute appendicitis \| 3. Acute alcoholic pancreatitis \| 4. Acute gastroenteritis \| 5. Acute cholecystitis [known gap: Web: Symptom inference has a mesenteric a |
...
| `appendicitis-paediatric-9y` | mgmt-no-adult-fixed-doses | web | critical | known gap | forbidden management item present in web.plan: "[immediate] iv antibiotics: co-amoxiclav 1.2 g tds or cefuroxime 750 mg tds + metronidazole 500 mg tds." (+7 more) [known gap: Web: Protocol steps, protocol medications and the appendicectomy  |
| `appendicitis-paediatric-9y` | mgmt-no-routine-postop-antibiotics | web | quality | known gap | forbidden management item present in web.clinicalPrompts: "...l: [x] ml. swab count correct × 2. post-operative orders: • simple appendicitis: iv amoxiclav 1.2g tds × 24h → oral co-amoxiclav × 5 days. • perforated appendicitis: iv pip-tazo  |
| `appendicitis-perforated-abscess` | mgmt-percutaneous-drainage | web | quality | known gap | no management item matched among 58 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: PANE converges on 'Acute Appendicitis' (≥0.85), so PlanTab uses the appendici |
| `appendicitis-perforated-abscess` | mgmt-interval-colon-evaluation | web | quality | known gap | no management item matched among 58 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: Appendicitis protocol has no interval colonoscopy/CT; only the appendix_mass  |
| `appendicitis-perforated-abscess` | variant-abscess | web | quality | known gap | detected appendicitis_uncomplicated in group Acute Appendicitis; expected appendicitis_abscess [known gap: Web: detectDxVariants: 'appendicitis_uncomplicated' is checked first and its keyword list contains the bare word 'appendicitis', so a |
...
| `appendicitis-score-low-band` | mnm-gynaecological | web | quality | known gap | not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Acute Cholecystitis \| 3. Peptic Ulcer Disease [known gap: Web: PANE top 3: appendicitis, cholecystitis, peptic ulcer; no gynaecological node reaches the top 3 in a 22-year-old woman wit |
...
| `crc-fit-positive-abdominal-pain` | flag-fit-positive | web | critical | known gap | no red flag matched among 13 (web.triage.reasons, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: No engine reads a FIT result: the lab is recorded but neith |
| `crc-fit-positive-abdominal-pain` | inv-colonoscopy | web | critical | known gap | no investigation matched among 23 (web.pane.seeded, web.clinicalPrompts) [known gap: Nothing requests colonoscopy: R19.5 has no protocol and no rule reads the FIT. No engine reads a FIT result: the lab is recorded but neither the triage can |
| `crc-fit-positive-abdominal-pain` | mgmt-suspected-cancer-pathway | web | critical | known gap | no management item matched among 10 (web.clinicalPrompts) [known gap: No engine reads a FIT result: the lab is recorded but neither the triage cancer screen, clinical prompts nor PANE/CDS use it, and no rule implements the NICE DG56 thresho |
| `crc-ida-no-gi-symptoms` | mnm-crc | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. GORD / Reflux Oesophagitis \| 3. Acute Diverticulitis [known gap: PANE has no anaemia/IDA feature and reads no labs; with fatigue/breathlessness only, the top 3 is the default cholecyst |
| `crc-ida-no-gi-symptoms` | flag-ida | web | critical | known gap | no red flag matched among 13 (web.triage.reasons, web.clinicalPrompts.safety, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: No output mentions iron deficiency: the triage cancer screen’s IDA criterion looks for "anaemi |
| `crc-ida-no-gi-symptoms` | inv-colonoscopy | web | critical | known gap | no investigation matched among 22 (web.pane.seeded, web.clinicalPrompts) [known gap: No colonoscopy requested for IDA (D50.9 has no protocol; no lab-driven IDA rule).] |
| `crc-ida-no-gi-symptoms` | inv-coeliac | web | quality | known gap | no investigation matched among 22 (web.pane.seeded, web.clinicalPrompts) [known gap: No coeliac serology for IDA.] |
| `crc-ida-no-gi-symptoms` | mgmt-iron | web | quality | known gap | no management item matched among 9 (web.clinicalPrompts) [known gap: No iron replacement output.] |
| `crc-lynch-surveillance-overdue` | flag-lynch | web | critical | unverified | no red flag matched among 6 (web.triage.reasons, web.clinicalPrompts.safety, web.triage.emergency) |
| `crc-lynch-surveillance-overdue` | inv-colonoscopy | web | critical | unverified | no investigation matched among 13 (web.pane.seeded, web.clinicalPrompts) |
| `crc-lynch-surveillance-overdue` | mgmt-2-yearly | web | quality | known gap | no management item output on web [known gap: No Lynch-specific rule: Z15.09 has no protocol, and the only colorectal family-history prompt (age 35–49, dashboard Family History field) says "colonoscopy 10 years before youngest affected relat |
| `crc-lynch-surveillance-overdue` | mgmt-aspirin-discussion | web | quality | known gap | no management item output on web [known gap: No aspirin chemoprevention output for Lynch syndrome on any path.] |
| `crc-rectal-bleeding-weight-loss-52` | flag-ng12-cancer-screen | web | quality | known gap | no red flag matched among 3 (web.triage.reasons) [known gap: The triage cancer screen has no "age ≥ 50 with unexplained rectal bleeding" or "age ≥ 40 with weight loss + abdominal pain" rule; its rectal-bleeding rule needs a change in bowel  |
| `crc-rectal-mass-fit-negative` | dx-rectal-cancer-top3 | web | critical | known gap | not in top 3 of web.pane: 1. Inguinal / Femoral Hernia \| 2. GORD / Reflux Oesophagitis \| 3. Acute Cholecystitis [known gap: PANE top 3 is inguinal hernia/GORD/cholecystitis: the "Change in bowel habit" template has no CC_HINTS entry, the  |
...
| `crc-screening-african-caribbean-fhx` | mgmt-screening-offered | web | quality | unverified | no management item matched among 4 (web.clinicalPrompts) |
| `crohns-ileocaecal-abscess` | no-alarm-pneumoperitoneum | web | quality | known gap | forbidden alarm present in web.clinicalPrompts.safety: "pneumoperitoneum on imaging - pneumoperitoneum → emergency laparotomy" [known gap: computeClinicalPrompts "Pneumoperitoneum on imaging → emergency laparotomy" fires on the CT text "No  |
| `crohns-ileocaecal-abscess` | flag-immunosuppressed | web | quality | known gap | no red flag matched among 24 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety, web.triage.emergency) [known gap: Adalimumab/azathioprine are not surfaced as immunosuppression (the triage comorbidity regex looks for "im |
...
| `diverticulitis-immunosuppressed` | flag-immunosuppression | web | quality | known gap | no red flag matched among 21 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative) [known gap: Web: Triage counts 'Higher-risk comorbidity' but no red fl |
| `diverticulitis-purulent-peritonitis` | dx-diverticulitis-top3 | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Inguinal / Femoral Hernia \| 3. Acute Appendicitis; also in web.symptomInference#2, web.triageSurgical#1 [known gap: Web: PANE top 3: cholecystitis, inguinal/femoral hernia, appendiciti |
| `diverticulitis-purulent-peritonitis` | mgmt-emergency-surgery-in-documented-plan | web | critical | known gap | no management item matched among 14 (web.plan) [known gap: Web: 'hinchey iii' contains the abscess keyword 'hinchey i', and the abscess variant is checked before the peritonitis variant, so the documented plan (immediate/conservative/follow |
| `diverticulitis-purulent-peritonitis` | variant-peritonitis | web | quality | known gap | detected diverticulitis_abscess in group Diverticulitis; expected diverticulitis_peritonitis [known gap: Web: Substring 'hinchey i' ⊂ 'hinchey iii' selects diverticulitis_abscess.] |
| `diverticulitis-uncomplicated-outpatient` | dx-diverticulitis-top3 | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Inguinal / Femoral Hernia \| 3. Acute Appendicitis; also in web.symptomInference#2, web.triageSurgical#1 [known gap: Web: PANE top 3: cholecystitis (0.13), inguinal/femoral hernia, appe |
...
| `fournier-gangrene` | dx-nsti-top3 | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholangitis \| 2. Perianal Abscess / Fistula \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#1 [known gap: PANE’s necrotising_fasciitis disease is not reached from perineal presentat |
...
| `fournier-gangrene` | mgmt-debridement | web | critical | known gap | no management item matched among 27 (web.clinicalPrompts) [known gap: N49.3 (Fournier gangrene) has no protocol (necrotising_fasciitis is keyed to M72.6), so no plan contains debridement; the sepsis prompt gives antibiotics only.] |
| `fournier-sglt2-early-mimic` | mnm-nsti | web | critical | known gap | not in top 3 of web.pane: 1. Perianal Abscess / Fistula \| 2. Acute Cholecystitis \| 3. Pilonidal Disease; also in web.symptomInference#1, web.passive#1 [known gap: PANE’s necrotising_fasciitis disease is not reached from perineal presentat |
| `fournier-sglt2-early-mimic` | flag-sglt2 | web | quality | known gap | no red flag matched among 20 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative, web.triage.emergency) [known gap: SGLT2 inhibitors are not recognised  |
| `fournier-sglt2-early-mimic` | mgmt-exploration | web | critical | known gap | no management item matched among 45 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No output recommends surgical exploration/debridement: the plan is incision and dr |
...
| `infective-colitis-bloody-diarrhoea` | inv-stool-culture | web | critical | known gap | no investigation matched among 34 (web.pane.seeded, web.clinicalPrompts) [known gap: No stool culture/STEC testing output (A09 has no protocol; PANE-seeded tests are for appendicitis/biliary disease).] |
| `infective-colitis-bloody-diarrhoea` | mgmt-no-appendicectomy | web | critical | known gap | forbidden management item present in web.clinicalPrompts: "laparoscopic appendicectomy - operative plan ───────────────────────────────────────────── pre-operative: •..." [known gap: Web computeClinicalPrompts fires "Appendicitis — emergenc |
| `infective-colitis-bloody-diarrhoea` | mgmt-no-empirical-antibiotics-stec | web | quality | known gap | forbidden management item present in web.clinicalPrompts: "• iv pip-tazo 4.5g + metronidazole 500mg - antibiotic prophylaxis at induction." [known gap: The appendicectomy operative-plan prompt adds "IV Pip-Tazo + metronidazole" (see mgmt-no |
...
| `lgib-angiodysplasia-aspirin` | mnm-angiodysplasia | web | quality | known gap | not in top 3 of web.pane: 1. Haemorrhoids \| 2. Acute Cholecystitis \| 3. Colorectal Cancer [known gap: Angiodysplasia is not a PANE disease; only the iOS ClinicalPathwayEngine GI-haemorrhage list names it.] |
| `lgib-angiodysplasia-aspirin` | inv-iron-studies | web | quality | known gap | no investigation matched among 30 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: No output requests ferritin/iron studies for IDA with bleeding (the plan is the ischaemic-colitis protocol).] |
| `lgib-angiodysplasia-aspirin` | mgmt-iron | web | quality | known gap | no management item matched among 39 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No iron replacement anywhere in the plan (no IDA rule reads Hb/MCV/ferritin).] |
| `lgib-angiodysplasia-aspirin` | mgmt-apc | web | quality | known gap | no management item matched among 39 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No endoscopic therapy (argon plasma coagulation) — there is no angiodysplasia prot |
...
| `lgib-diverticular-apixaban` | mgmt-hold-doac | web | critical | known gap | no management item matched among 37 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: The only DOAC text is the generic peri-operative bridging prompt ("hold DOAC 48–72 |
| `lgib-diverticular-apixaban` | mgmt-no-diverticulitis-antibiotics | web | quality | known gap | forbidden management item present in web.plan: "[conservative] uncomplicated: oral co-amoxiclav 625 mg tds for 5-7 days; liquid diet." (+4 more) [known gap: ICD K57.31 (diverticulosis with bleeding) maps to the diverticulitis protocol and d |
| `lgib-oakland-low-risk-discharge` | level-not-emergency | web | quality | known gap | web.triage: emergency (acuity=urgent, action=emergency_now, score=127); expected ≤ urgent [known gap: Web adaptiveTriage has no negation handling and treats any "bleed/bleeding" as an urgent red flag (RED_FLAGS "GI or other bleeding" → emer |
...
| `lgib-post-polypectomy` | mgmt-endoscopic-haemostasis | web | quality | known gap | no management item matched among 15 (web.clinicalPrompts) [known gap: No post-polypectomy bleeding protocol (K91.840 has none); the only plan is the generic GI-bleed prompt without endoscopic haemostasis/clips.] |
| `lgib-post-polypectomy` | mgmt-antiplatelet-plan | web | quality | known gap | no management item matched among 15 (web.clinicalPrompts) [known gap: The anticoagulant prompt lists warfarin/DOACs/heparins only; clopidogrel (and other antiplatelets) are not handled in the bleed plan.] |
...
| `lgib-unstable-cta-first` | inv-cta-first | web | critical | known gap | no investigation matched among 28 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: No output recommends CT angiography for unstable haematochezia: the plan is the UGIB protocol (OGD) and the GI-bleed prompt offers |
...
| `mimic-aaa-symptomatic-renal-colic-label` | mnm-aaa | web | critical | known gap | not in top 3 of web.pane: 1. Renal Colic / Urolithiasis \| 2. Inguinal / Femoral Hernia \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE top 3: renal colic, inguinal/femoral hernia, cholecystiti |
| `mimic-aaa-symptomatic-renal-colic-label` | inv-cta | web | critical | known gap | no investigation matched among 24 (web.pane.seeded, web.clinicalPrompts) [known gap: Web: ICD I71.4 has no protocol (only 'I71.9' is mapped), so no CT angiography is suggested.] |
| `mimic-aaa-symptomatic-renal-colic-label` | mgmt-vascular-referral | web | critical | known gap | no management item matched among 10 (web.clinicalPrompts) [known gap: Web: No vascular referral: no protocol for I71.4.] |
| `mimic-dka-abdominal-pain` | mnm-dka | web | critical | known gap | not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Peptic Ulcer Disease \| 3. Acute Pancreatitis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE has no DKA disease node, so it can never appear in the PANE top 3 (appe |
| `mimic-dka-abdominal-pain` | mgmt-potassium | web | quality | known gap | no management item matched among 32 (web.clinicalPrompts) [known gap: Web: The hyperglycaemia prompt mentions monitoring K+ only as part of the insulin line; no potassium replacement plan.] |
| `mimic-dka-abdominal-pain` | mgmt-no-laparotomy-for-dka-pain | web | critical | known gap | forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." [known gap: Web: 'no rigidity, no rebound' triggers the peritonism prompt ('Emergency laparotomy consent — so |
| `mimic-ectopic-pregnancy` | dx-ectopic-top3 | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Acute Appendicitis \| 3. Choledocholithiasis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE top 3: cholecystitis, appendicitis, choledocholithiasis. The template's |
| `mimic-ectopic-pregnancy` | mgmt-no-assumed-negative-hcg | web | critical | known gap | forbidden management item present in web.clinicalPrompts: "...ak (< 1%), hartmann's pouch if appendix not identifiable. • β-hcg confirmed negative (female of reproductive age). • group & screen available; cross-match if perfor..." [known ga |
| `mimic-ectopic-ruptured-shock` | dx-ectopic-top3 | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Acute Appendicitis \| 3. Choledocholithiasis; also in web.symptomInference#2 [known gap: Web: PANE top 3: cholecystitis, appendicitis, choledocholithiasis despite a positive pregnancy t |
...
| `mimic-inferior-mi-ecg-confirmed` | mnm-acs | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Peptic Ulcer Disease \| 3. GORD / Reflux Oesophagitis [known gap: Web: PANE has no cardiac (ACS/MI) disease node, so it can never appear in the PANE top 3 (cholecystitis, peptic ulcer,  |
| `mimic-inferior-mi-ecg-confirmed` | level-emergency | web | critical | known gap | web.triage: urgent (acuity=priority, action=same_day_call, score=30); expected ≥ emergency [known gap: Web: adaptiveTriage: 'same_day_call' (score 30); the resulted ECG (ST elevation) and troponin 412 are not triage inputs, and HR 48/SBP 92 |
| `mimic-inferior-mi-ecg-confirmed` | alarm-stemi | web | critical | known gap | no alarm matched among 4 (web.clinicalPrompts.safety) [known gap: Web: No prompt reads ECG results or troponin; the only safety prompt is bradycardia.] |
| `mimic-inferior-mi-ecg-confirmed` | mgmt-reperfusion | web | critical | known gap | no management item matched among 16 (web.clinicalPrompts) [known gap: Web: No reperfusion/PCI action; ICD I21.19 has no protocol.] |
| `mimic-inferior-mi` | mnm-acs | web | critical | known gap | not in top 3 of web.pane: 1. GORD / Reflux Oesophagitis \| 2. Acute Cholecystitis \| 3. Peptic Ulcer Disease [known gap: Web: PANE has no cardiac (ACS/MI) disease node, so it can never appear in the PANE top 3 (GORD, cholecystitis, peptic u |
| `mimic-inferior-mi` | mnm-acs-symptom-engine | web | quality | known gap | not in top 5 of web.symptomInference: 1. Acute alcoholic pancreatitis \| 2. Gallstone pancreatitis \| 3. Perforated peptic ulcer \| 4. Acute gastroenteritis \| 5. Gastric carcinoma [known gap: Web: Symptom inference top 5 has no ACS/STEMI ( |
| `mimic-inferior-mi` | inv-ecg | web | critical | known gap | no investigation matched among 25 (web.pane.seeded, web.clinicalPrompts) [known gap: Web: No ECG suggested; the bradycardia prompt needs HR <50 (HR 52 here).] |
| `mimic-inferior-mi` | inv-troponin | web | critical | known gap | no investigation matched among 25 (web.pane.seeded, web.clinicalPrompts) [known gap: Web: No troponin suggested.] |
| `mimic-inferior-mi` | mgmt-cardiology-or-ems | web | quality | known gap | no management item matched among 12 (web.clinicalPrompts) [known gap: Web: No cardiology/PCI/emergency-services action.] |
| `mimic-ruptured-aaa` | dx-aaa-top3 | web | critical | known gap | not in top 3 of web.pane: 1. Inguinal / Femoral Hernia \| 2. Renal Colic / Urolithiasis \| 3. Acute Cholecystitis; also in web.symptomInference#1, web.passive#1 [known gap: Web: PANE top 3: inguinal/femoral hernia, renal colic, cholecystiti |
| `mimic-ruptured-aaa` | alarm-aaa | web | critical | known gap | no alarm matched among 8 (web.triage.vitalRedFlags, web.triage.emergency, web.clinicalPrompts.safety) [known gap: Web: Alarms are 'Hypotension', 'Tachycardia' and the generic 'SBP 84 → Shock Protocol'; none names the aneurysm.] |
| `mimic-ruptured-aaa` | mgmt-vascular-repair | web | critical | known gap | no management item matched among 22 (web.clinicalPrompts) [known gap: Web: No protocol reaches the plan: ICD I71.3 does not start with the aortic protocol's only prefix 'I71.9', and PANE does not select aortic_aneurysm. Only prompts remain  |
| `mimic-ruptured-aaa` | mgmt-permissive-hypotension | web | quality | known gap | no management item matched among 22 (web.clinicalPrompts) [known gap: Web: No permissive hypotension (the aortic protocol has it, but is not reached).] |
...
| `pilonidal-abscess-acute` | dx-pilonidal-top3 | web | quality | known gap | not in top 3 of web.pane: 1. Skin Abscess / Furuncle \| 2. Inguinal / Femoral Hernia \| 3. Acute Appendicitis; also in web.symptomInference#1, web.passive#3 [known gap: PANE ranks skin abscess, hernia and appendicitis: the "Posterior midlin |
| `pilonidal-abscess-acute` | level-soon | web | quality | known gap | web.triage: routine (acuity=routine, action=routine_booking, score=8); expected ≥ priority [known gap: Web adaptiveTriage has no pilonidal/perianal abscess rule: the level depends on the pain score and incidental words (the base abscess rea |
| `ppu-elderly-steroids-masked` | alarm-sepsis | web | critical | known gap | no alarm matched among 11 (web.triage.vitalRedFlags, web.triage.emergency, web.clinicalPrompts.safety) [known gap: Web: Sepsis prompts need temperature ≥38 °C with HR >100 (or SBP <90 for the shock prompt); an afebrile patient with qSOFA 3, |
| `ppu-elderly-steroids-masked` | flag-steroids-masking | web | quality | known gap | no red flag matched among 33 (web.triage.reasons, web.protocol.redFlags, web.clinicalPrompts.safety, web.clinicalPrompts.investigation, web.clinicalPrompts.preventative, web.triage.vitalRedFlags, web.triage.emergency) [known gap: Web: No fl |
| `ppu-elderly-steroids-masked` | mgmt-steroid-cover | web | quality | known gap | no management item matched among 70 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No steroid-cover prompt.] |
| `ppu-perforated-peptic-ulcer` | level-emergency | web | critical | known gap | web.triage: urgent (acuity=priority, action=same_day_call, score=35); expected ≥ emergency [known gap: Web: adaptiveTriage: 'same_day_call' (score 35). The CC 'Sudden severe upper abdominal pain' misses the red-flag regex 'severe (abdominal |
...
| `sbo-adhesive-base` | no-false-peritonism-alarm | web | quality | known gap | forbidden alarm present in web.clinicalPrompts.safety: "generalised peritonism (guarding / rigidity) - peritonism → perforated viscus / peritonitis" [known gap: Web: computeClinicalPrompts fires 'Generalised peritonism → Perforated viscus'  |
| `sbo-adhesive-base` | mgmt-potassium | web | quality | known gap | no management item matched among 58 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No potassium replacement despite K 3.3: getProtocolByIcd('K56.50') returns the generic bowel_obstructio |
| `sbo-adhesive-base` | mgmt-no-unrelated-operative-template | web | quality | known gap | forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." (+1 more) [known gap: Web: Negated exam text ('No guarding, no rebound, no peritonism') triggers both the per |
...
| `sbo-gastrografin-failed` | mgmt-no-repeat-contrast-challenge | web | quality | known gap | forbidden management item present in web.plan: "...ve] adhesive sbo: conservative 48 h trial if no peritonism; water-soluble contrast study at 24 h." [known gap: Web: Plan text still contains 'water-soluble contrast study at 24 h' after a f |
| `sbo-gastrografin-failed` | mgmt-no-appendicectomy-template | web | quality | known gap | forbidden management item present in web.clinicalPrompts: "laparoscopic appendicectomy - operative plan ───────────────────────────────────────────── pre-operative: •..." [known gap: Web: 'no guarding or rebound' in the exam triggers the ap |
| `sbo-malignant-carcinomatosis` | mgmt-palliative-mdt | web | quality | known gap | no management item matched among 48 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No palliative, oncology or goals-of-care step for malignant obstruction; the plan is the generic bowel- |
| `sbo-malignant-carcinomatosis` | mgmt-medical-mbo | web | quality | known gap | no management item matched among 48 (web.plan, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: Web: No antisecretory/antiemetic/steroid or venting-gastrostomy option.] |
| `sbo-malignant-carcinomatosis` | mgmt-no-routine-laparotomy | web | quality | known gap | forbidden management item present in web.clinicalPrompts: "• emergency laparotomy consent - source control; icu post-operatively." [known gap: Web: 'no peritonism' in the exam triggers the peritonism prompt: 'Emergency laparotomy consent —  |
| `sbo-strangulated-femoral-hernia` | dx-hernia-top3 | web | critical | known gap | not in top 3 of web.pane: 1. Bowel Obstruction \| 2. Small Bowel Obstruction — Adhesions \| 3. Post-operative Ileus; also in web.triageSurgical#1 [known gap: Web: PANE top 3: bowel obstruction, adhesive SBO, post-operative ileus. The SOCRAT |
| `sbo-strangulation` | mgmt-emergency-surgery-in-documented-plan | web | critical | known gap | no management item matched among 14 (web.plan) [known gap: Web: detectDxVariants picks 'sbo_adhesional' (keyword 'small bowel obstruction' is checked before 'strangulation'), whose allowed phases exclude 'surgical'; the documented plan has  |
| `sbo-strangulation` | mgmt-no-nom-trial-with-strangulation | web | critical | known gap | forbidden management item present in web.plan: "small bowel obstruction - non-operative trial (drip and suck)" (+1 more) [known gap: Web: Documented plan = 'Small Bowel Obstruction — Non-Operative Trial (Drip and Suck)' and the Gastrografin |
| `sbo-strangulation` | variant-sbo-strangulation | web | quality | known gap | detected sbo_adhesional in group Bowel Obstruction; expected sbo_strangulation [known gap: Web: First-match order: sbo_adhesional ('small bowel obstruction', 'adhesion') is tested before sbo_strangulation.] |
...
| `uc-asuc-day3-nonresponse` | inv-cmv | web | quality | known gap | no investigation matched among 44 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: No CMV testing anywhere (UC protocol investigations: bloods, AXR, stool C&S + C. difficile, sigmoidoscopy/colonoscopy, CT).] |
| `uc-flare-cdiff` | mnm-cdiff | web | critical | known gap | not in top 3 of web.pane: 1. Acute Cholecystitis \| 2. Haemorrhoids \| 3. Acute Appendicitis [known gap: C. difficile infection does not exist in PANE (no disease) or in the management protocols (A04.7 → no protocol); web symptom inference  |
| `uc-flare-cdiff` | mgmt-cdi-treatment | web | critical | known gap | no management item matched among 28 (web.clinicalPrompts) [known gap: C. difficile infection does not exist in PANE (no disease) or in the management protocols (A04.7 → no protocol); web symptom inference has only "Acute gastroenteritis". N |
| `uc-steroid-refractory-cmv` | inv-cmv | web | critical | known gap | no investigation matched among 36 (web.plan.investigations, web.pane.seeded, web.clinicalPrompts) [known gap: The CMV-positive biopsy result is not read and no output mentions CMV.] |
| `uc-steroid-refractory-cmv` | mgmt-antiviral | web | critical | known gap | no management item matched among 45 (web.plan, web.protocol.medications, web.managementPanel, web.managementPanel.keyPoints, web.clinicalPrompts) [known gap: No antiviral (ganciclovir) anywhere; the UC plan escalates immunosuppression (infl |
| `uc-toxic-megacolon` | mnm-perforation | web | quality | known gap | not in top 3 of web.pane: 1. Acute Appendicitis \| 2. Acute Cholangitis \| 3. Acute Cholecystitis [known gap: PANE top 3 is appendicitis/cholangitis/cholecystitis for a distended toxic colitis; no toxic megacolon/perforation disease and the |
| `uc-toxic-megacolon` | inv-no-colonoscopy | web | critical | known gap | forbidden investigation present in web.plan.investigations: "flexible sigmoidoscopy / colonoscopy + biopsies" [known gap: The ulcerative_colitis protocol lists "Flexible sigmoidoscopy / colonoscopy + biopsies" as an urgent investigation wit |

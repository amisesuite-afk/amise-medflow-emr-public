...
Generated 2026-09-25T14:21:50.412Z.

- Harness clinval-web/1; 131 vignettes from ios/AmiseMedFlowTests/ClinicalValidation/Vignettes/.
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mnm-anal-cancer | mustNotMiss | critical | FAIL (known gap) | NICE NG12 2023; ASCRS clinical practice guidelines 2018 | Add anal squamous cell carcinoma to PANE and a C21 protocol (EUA + biopsy, MRI pelvis, CT, HIV test, chemoradiotherapy — ASCRS 2018); NG12 anal-mass/ulcer prompt. |
...
| inv-hiv-test | investigationInclude | quality | FAIL (known gap) | ASCRS clinical practice guidelines 2018 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Haemorrhoids; 2. Anal Fissure; 3. Colorectal Cancer
- differential web.symptomInference: 1. Lower GI bleed / colorectal; 2. Squamous cell carcinoma of the anus; 3. Colorectal carcinoma; 4. Occult malignancy / systemic disease; 5. Haemorrhoids / anorectal disease
...
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Unintentional weight loss (alarm symptom) [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]
- recommended scores: news2, rockall, ecog
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain, pr_bleeding, weight_loss, pruritus
- note: AssessmentTab ManagementPanel protocol: haemorrhoids (from PANE top)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| dx-fissure-top3 | mustRankTopK | quality | PASS | ASCRS clinical practice guidelines 2023 |  |
| level-routine | emergencyLevel | quality | FAIL (known gap) | ASCRS clinical practice guidelines 2023 |  |
| mgmt-topical | managementInclude | quality | PASS | ASCRS clinical practice guidelines 2023 |  |
| mgmt-fibre | managementInclude | quality | PASS | ASCRS clinical practice guidelines 2023 |  |
| mgmt-no-resuscitation | managementExclude | quality | FAIL (known gap) | ASCRS clinical practice guidelines 2023 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Anal Fissure; 2. Haemorrhoids; 3. GORD / Reflux Oesophagitis
...
- emergency level: emergency (acuity=urgent, action=emergency_now, score=123)
...
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain, heartburn, pr_bleeding
- note: AssessmentTab ManagementPanel protocol: anal_fissure (from PANE top)
- note: PlanTab protocol: anal_fissure (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mnm-anal-cancer | mustNotMiss | critical | FAIL (known gap) | ASCRS clinical practice guidelines 2023; ASCRS clinical practice guidelines 2018 | Add anal squamous cell carcinoma to PANE (features: anal mass/ulcer, bleeding, HIV/HPV/CIN history, inguinal nodes) and a C21 protocol. |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Anal Fissure; 2. Haemorrhoids; 3. Inguinal / Femoral Hernia
...
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain, pr_bleeding
- note: AssessmentTab ManagementPanel protocol: anal_fissure (from PANE top)
- note: PlanTab protocol: anal_fissure (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mgmt-botox-or-lis | managementInclude | quality | PASS | ASCRS clinical practice guidelines 2023 |  |
| mgmt-continence-assessment | managementInclude | quality | PASS | ASCRS clinical practice guidelines 2023 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Anal Fissure; 2. Haemorrhoids; 3. Acute Cholecystitis
- differential web.symptomInference: 1. Haemorrhoids / anorectal disease; 2. Anal fissure; 3. Lower GI bleed / colorectal; 4. Meckel's diverticulum; 5. Intussusception
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Acute Diverticulitis; 2. Acute Cholecystitis; 3. Acute Cholangitis
- differential web.symptomInference: 1. Acute gastroenteritis; 2. Sigmoid volvulus; 3. Acute cholecystitis; 4. Acute mesenteric ischaemia; 5. Adhesive small bowel obstruction
...
- alarms: Hypotension [web.triage.vitalRedFlags]; Tachycardia [web.triage.vitalRedFlags]; Tachypnoea [web.triage.vitalRedFlags]; Emergency now [web.triage.emergency]; Pneumoperitoneum on imaging [web.clinicalPrompts.safety]; Fever 38.6°C + HR 122 bpm + SBP 84 mmHg — septic shock [web.clinicalPrompts.safety]; Appendicitis — emergency surgical indication [web.clinicalPrompts.safety]; Bowel obstruction — clinical or imaging evidence [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; WBC 32.4 × 10⁹/L — leucocytosis [web.clinicalPrompts.safety]; Creatinine 210 μmol/L — elevated [web.clinicalPrompts.safety]; Albumin 21 g/L — hypoalbuminaemia [web.clinicalPrompts.safety]
- recommended scores: alvarado, tg18-cholangitis, ranson, qsofa, gcs, news2, asa, rcri, cfs
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: fever, change_bowel_habit
- note: AssessmentTab ManagementPanel protocol: (none) (from ICD)
- note: PlanTab protocol: (none) (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| dx-crc-top3 | mustRankTopK | critical | PASS | NICE NG12 2023 |  |
| level-at-least-priority | emergencyLevel | critical | PASS | NICE NG12 2023 |  |
| flag-crc | redFlags | critical | PASS | NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | PASS | NICE NG12 2023; ACPGBI/BSG joint guideline 2022 |  |
| mgmt-suspected-cancer-pathway | managementInclude | critical | PASS | NICE NG12 2023; NICE DG56 2023 |  |
| flag-ng12-cancer-screen | redFlags | quality | PASS | NICE NG12 2023 |  |
| flag-fit-read | redFlags | quality | FAIL (known gap) | NICE DG56 2023; ACPGBI/BSG joint guideline 2022 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
| inv-ct-staging | investigationInclude | quality | PASS | NICE NG12 2023 |  |
| mgmt-iron | managementInclude | quality | FAIL (known gap) | BSG guideline 2021 |  |
...
- differential web.triageSurgical: 1. Colon cancer; 2. Change in bowel habit / lower GI bleed — investigation; 3. Unexplained weight loss / GI alarm symptoms — endoscopy workup
- emergency level: emergency (acuity=urgent, action=emergency_now, score=204)
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Unintentional weight loss (alarm symptom) [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; HbA1c 58% — poorly controlled diabetes [web.clinicalPrompts.safety]
- recommended scores: web:wagner, news2, rockall, caprini, asa, rcri, stop-bang, cfs, ecog, web:phq9
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: pr_bleeding, change_bowel_habit, weight_loss
- note: AssessmentTab ManagementPanel protocol: colorectal_cancer (from PANE top)
- note: PlanTab protocol: colorectal_cancer (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mnm-crc | mustNotMiss | critical | FAIL (known gap) | NICE DG56 2023 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
| level-at-least-priority | emergencyLevel | critical | PASS | NICE NG12 2023; NICE DG56 2023 |  |
| flag-fit-positive | redFlags | critical | FAIL (known gap) | NICE DG56 2023; ACPGBI/BSG joint guideline 2022 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
| inv-colonoscopy | investigationInclude | critical | FAIL (known gap) | ACPGBI/BSG joint guideline 2022 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
| mgmt-suspected-cancer-pathway | managementInclude | critical | FAIL (known gap) | NICE DG56 2023 | Add a FIT rule (lab "FIT"/"faecal immunochemical"): value ≥ 10 µg Hb/g → suspected colorectal cancer pathway prompt (colonoscopy/CTC), independent of symptoms (NICE DG56; BSG/ACPGBI 2022). Record < 10 as "does not exclude" when there is a mass, IDA or ongoing concern. |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Acute Cholecystitis; 2. GORD / Reflux Oesophagitis; 3. Peptic Ulcer Disease
- differential web.symptomInference: 1. Acute cholecystitis; 2. Diverticulitis; 3. Colorectal carcinoma; 4. Acute appendicitis (paediatric); 5. Peptic ulcer disease
...
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: suprapubic_pain
- note: AssessmentTab ManagementPanel protocol: (none) (from ICD)
- note: PlanTab protocol: (none) (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mnm-crc | mustNotMiss | critical | FAIL (known gap) | BSG guideline 2021; NICE NG12 2023 | Add an IDA rule reading Hb + MCV/ferritin (lab results): man or post-menopausal woman → bidirectional endoscopy + coeliac serology (BSG 2021), and age ≥ 60 → suspected colorectal cancer pathway (NG12). |
| flag-ida | redFlags | critical | FAIL (known gap) | BSG guideline 2021; NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | FAIL (known gap) | BSG guideline 2021 |  |
| inv-ogd | investigationInclude | critical | PASS | BSG guideline 2021 |  |
| inv-coeliac | investigationInclude | quality | FAIL (known gap) | BSG guideline 2021 |  |
| mgmt-iron | managementInclude | quality | FAIL (known gap) | BSG guideline 2021 |  |
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| flag-lynch | redFlags | critical | FAIL (unverified) | BSG/ACPGBI/UKCGG guidelines 2020 |  |
| inv-colonoscopy | investigationInclude | critical | FAIL (unverified) | BSG/ACPGBI/UKCGG guidelines 2020 |  |
| mgmt-2-yearly | managementInclude | quality | FAIL (known gap) | BSG/ACPGBI/UKCGG guidelines 2020 | Add a hereditary-CRC rule (Lynch/MLH1/MSH2/MSH6/PMS2/FAP in PMH or family history) → colonoscopy every 2 years from 25/35 per gene; aspirin discussion (BSG/ACPGBI/UKCGG 2020). |
| mgmt-aspirin-discussion | managementInclude | quality | FAIL (known gap) | BSG/ACPGBI/UKCGG guidelines 2020 |  |
...
| level-at-least-priority | emergencyLevel | critical | PASS | NICE NG12 2023 |  |
| flag-crc | redFlags | critical | PASS | NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | PASS | NICE NG12 2023 |  |
| mgmt-suspected-cancer-pathway | managementInclude | critical | PASS | NICE NG12 2023; NICE DG56 2023 |  |
| flag-ng12-cancer-screen | redFlags | quality | FAIL (known gap) | NICE NG12 2023 | Rewrite cancer-screening.ts lower-GI criteria to current NG12/DG56 (FIT-first; ≥ 50 rectal bleeding; ≥ 40 weight loss + abdominal pain; < 50 rectal bleeding + CIBH/weight loss/IDA; rectal/abdominal mass; IDA ≥ 60). |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Inguinal / Femoral Hernia; 2. Haemorrhoids; 3. Colorectal Cancer
- differential web.symptomInference: 1. Colorectal carcinoma; 2. Lower GI bleed / colorectal; 3. Occult malignancy / systemic disease; 4. Diverticulitis; 5. Squamous cell carcinoma of the anus
...
- differential web.triageSurgical: 1. Unexplained weight loss / GI alarm symptoms — endoscopy workup
- emergency level: emergency (acuity=urgent, action=emergency_now, score=90)
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Unintentional weight loss (alarm symptom) [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]
- recommended scores: ranson, news2, rockall, ecog
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: lif_pain, pr_bleeding, weight_loss
- note: AssessmentTab ManagementPanel protocol: colorectal_cancer (from ICD)
- note: PlanTab protocol: colorectal_cancer (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| dx-rectal-cancer-top3 | mustRankTopK | critical | FAIL (known gap) | NICE NG12 2023 | Add CC_HINTS for "Change in bowel habit" (change_bowel_habit) and "Rectal bleeding" (pr_bleeding), map the "Rectum"/"Anal canal" site chips, and add a rectal-mass feature fed by the examination. |
| level-at-least-priority | emergencyLevel | critical | PASS | ACPGBI/BSG joint guideline 2022 |  |
| flag-rectal-mass | redFlags | critical | PASS | ACPGBI/BSG joint guideline 2022; NICE NG12 2023 |  |
| inv-mri-pelvis | investigationInclude | critical | PASS | NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | quality | PASS | ACPGBI/BSG joint guideline 2022 |  |
| mgmt-mdt | managementInclude | quality | PASS | NICE NG12 2023 |  |
...
- differential web.triageSurgical: (empty)
- emergency level: urgent (acuity=priority, action=same_day_call, score=37)
- alarms: Rectal mass on PR examination [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; CEA 7.8 ng/mL — elevated [web.clinicalPrompts.safety]
- recommended scores: news2, caprini, asa, rcri, cfs, ecog
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: tenesmus
- note: AssessmentTab ManagementPanel protocol: colorectal_cancer (from ICD)
- note: PlanTab protocol: colorectal_cancer (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| level-routine | emergencyLevel | quality | FAIL (known gap) | USPSTF recommendation statement 2021 |  |
| mgmt-screening-offered | managementInclude | quality | FAIL (unverified) | USPSTF recommendation statement 2021; ACG clinical guidelines 2021 |  |
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mnm-crc | mustNotMiss | critical | PASS | NICE NG12 2023 |  |
| flag-crc | redFlags | critical | PASS | NICE NG12 2023 |  |
| inv-colonoscopy | investigationInclude | critical | PASS | NICE NG12 2023 |  |
| mnm-ibd | mustNotMiss | quality | PASS | NICE NG12 2023 |  |
| mgmt-suspected-cancer-pathway | managementInclude | quality | PASS | NICE NG12 2023 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Rectal Carcinoma; 2. Ulcerative Colitis; 3. Crohn's Disease
...
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Unintentional weight loss (alarm symptom) [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]
- recommended scores: news2, rockall
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: pr_bleeding, change_bowel_habit, weight_loss
- note: AssessmentTab ManagementPanel protocol: rectal_carcinoma (from PANE top)
- note: PlanTab protocol: (none) (from ICD)
...
| mgmt-no-appendicectomy | managementExclude | critical | FAIL (known gap) | ECCO guidelines on therapeutics in Crohn’s disease 2020 | Gate the appendicectomy operative-plan prompt on the confirmed working diagnosis (appendicitis) or imaging, not on the words "guarding"/"rebound"; add negation handling (no/without/absent) to exam() matching. |
...
| no-alarm-pneumoperitoneum | mustNotAlarm | quality | FAIL (known gap) | ECCO guidelines on therapeutics in Crohn’s disease 2020 | Add negation handling to hasRadResult (no/without/absent … free gas/free air). |
| flag-immunosuppressed | redFlags | quality | FAIL (known gap) | ECCO guidelines on therapeutics in Crohn’s disease 2020 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Acute Appendicitis; 2. Appendix Mass / Late Appendicitis; 3. Crohn's Disease
- differential web.symptomInference: 1. Acute appendicitis; 2. Acute appendicitis (paediatric); 3. HIV / AIDS presentation; 4. Acute gastroenteritis; 5. Typhoid fever
...
- differential web.triageSurgical: 1. Unexplained weight loss / GI alarm symptoms — endoscopy workup
- emergency level: emergency (acuity=urgent, action=emergency_now, score=73)
- alarms: Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; Pneumoperitoneum on imaging [web.clinicalPrompts.safety]; Appendicitis — emergency surgical indication [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Unintentional weight loss (alarm symptom) [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; WBC 16.2 × 10⁹/L — leucocytosis [web.clinicalPrompts.safety]; Fever 38.7°C + HR 108 bpm [web.clinicalPrompts.safety]
- recommended scores: alvarado, tg18-cholangitis, ranson, qsofa, news2, must
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: rlq_pain, fever, anorexia, weight_loss
- note: AssessmentTab ManagementPanel protocol: appendicitis (from PANE top)
- note: PlanTab protocol: crohns_disease (from ICD)
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Perianal Abscess / Fistula; 2. Pilonidal Disease; 3. Acute Cholecystitis
...
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain
- note: AssessmentTab ManagementPanel protocol: perianal_abscess (from PANE top)
- note: PlanTab protocol: crohns_disease (from ICD)
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Perianal Abscess / Fistula; 2. Acute Cholecystitis; 3. Pilonidal Disease
...
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain
- note: AssessmentTab ManagementPanel protocol: anal_fissure (from ICD)
- note: PlanTab protocol: anal_fissure (from ICD)
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Inguinal / Femoral Hernia; 2. Anal Fissure; 3. Perianal Abscess / Fistula
...
- differential web.passive: 1. Haemorrhoids / anorectal disease; 2. Fistula in ano; 3. Perianal abscess; 4. Pilonidal sinus / abscess; 5. Squamous cell carcinoma of the anus
- differential web.triageSurgical: 1. Perianal abscess; 2. Unexplained weight loss / GI alarm symptoms — endoscopy workup; 3. Skin / soft tissue abscess
- emergency level: urgent (acuity=priority, action=same_day_call, score=40)
- alarms: Pre-operative assessment [web.clinicalPrompts.safety]
- recommended scores: news2
- score values: (none)
...
| level-emergency | emergencyLevel | critical | PASS | WSES/SIS-E consensus 2018 |  |
| alarm-nsti-or-sepsis | mustAlarm | critical | PASS | WSES/SIS-E consensus 2018 |  |
| mgmt-debridement | managementInclude | critical | FAIL (known gap) | WSES/SIS-E consensus 2018 | Add Fournier’s gangrene as a PANE disease (or map perineal site + crepitus/necrosis/pain-out-of-proportion + SIRS to necrotising_fasciitis) and give N49.3/perineal NSTI the necrotising_fasciitis protocol; add a safety prompt for "perianal/perineal infection + pain out of proportion or spreading to scrotum/perineum + SIRS" → emergency surgical exploration. |
| mgmt-broad-abx | managementInclude | critical | PASS | WSES/SIS-E consensus 2018 |  |
| score-rec-lrinec | scoreRecommended | quality | FAIL (known gap) | LRINEC score (Laboratory Risk Indicator for Necrotizing Fasciitis) 2004; WSES/SIS-E consensus 2018 |  |
| score-qsofa-calculator | scoreValue | quality | n/a | WSES/SIS-E consensus 2018 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Acute Cholangitis; 2. Perianal Abscess / Fistula; 3. Acute Cholecystitis
...
- alarms: Tachypnoea [web.triage.vitalRedFlags]; Hyperglycaemia [web.triage.vitalRedFlags]; Emergency now [web.triage.emergency]; Testicular / scrotal signs [web.clinicalPrompts.safety]; BGL 24.1 mmol/L — severe hyperglycaemia [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; WBC 24.2 × 10⁹/L — leucocytosis [web.clinicalPrompts.safety]; Creatinine 160 μmol/L — elevated [web.clinicalPrompts.safety]; Fever 38.9°C + HR 118 bpm [web.clinicalPrompts.safety]
- recommended scores: qsofa, gcs, child-pugh, web:wagner, news2, caprini, asa, web:audit, rcri, stop-bang, cfs
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain, heartburn, fever, rigors
- note: AssessmentTab ManagementPanel protocol: (none) (from ICD)
- note: PlanTab protocol: (none) (from ICD)
- note: no web calculator for score form 'qsofa'
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mnm-nsti | mustNotMiss | critical | FAIL (known gap) | WSES/SIS-E consensus 2018 | Add Fournier’s gangrene as a PANE disease (or map perineal site + crepitus/necrosis/pain-out-of-proportion + SIRS to necrotising_fasciitis) and give N49.3/perineal NSTI the necrotising_fasciitis protocol; add a safety prompt for "perianal/perineal infection + pain out of proportion or spreading to scrotum/perineum + SIRS" → emergency surgical exploration. |
| level-emergency | emergencyLevel | critical | PASS | WSES/SIS-E consensus 2018 |  |
| mgmt-exploration | managementInclude | critical | FAIL (known gap) | WSES/SIS-E consensus 2018 | Add Fournier’s gangrene as a PANE disease (or map perineal site + crepitus/necrosis/pain-out-of-proportion + SIRS to necrotising_fasciitis) and give N49.3/perineal NSTI the necrotising_fasciitis protocol; add a safety prompt for "perianal/perineal infection + pain out of proportion or spreading to scrotum/perineum + SIRS" → emergency surgical exploration. |
| flag-sglt2 | redFlags | quality | FAIL (known gap) | MHRA Drug Safety Update 2019 | Add an SGLT2-inhibitor medication flag for perineal/genital infection (MHRA 2019). |
...
- alarms: Emergency now [web.triage.emergency]; Testicular / scrotal signs [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; WBC 21 × 10⁹/L — leucocytosis [web.clinicalPrompts.safety]; Fever 38.3°C + HR 114 bpm [web.clinicalPrompts.safety]
- recommended scores: qsofa, web:wagner, news2, caprini, asa, rcri
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain, heartburn, fever
- note: AssessmentTab ManagementPanel protocol: perianal_abscess (from PANE top)
- note: PlanTab protocol: perianal_abscess (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| flag-warfarin | redFlags | critical | PASS | ASCRS clinical practice guidelines 2024 |  |
| inv-colonic-evaluation | investigationInclude | critical | PASS | NICE NG12 2023; ASCRS clinical practice guidelines 2024 |  |
| inv-inr | investigationInclude | quality | PASS | ASCRS clinical practice guidelines 2024 |  |
| mgmt-anticoag-plan | managementInclude | quality | PASS | ASCRS clinical practice guidelines 2024 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Haemorrhoids; 2. Anal Fissure; 3. Acute Cholecystitis
- differential web.symptomInference: 1. Lower GI bleed / colorectal; 2. Colorectal carcinoma; 3. Haemorrhoids / anorectal disease; 4. Rectal prolapse; 5. Squamous cell carcinoma of the anus
...
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; INR 3.4 — coagulopathy [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; Anticoagulation therapy [web.clinicalPrompts.safety]
- recommended scores: cha2ds2-vasc, news2, rockall, caprini, has-bled, asa, rcri, cfs
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain, pr_bleeding
- note: AssessmentTab ManagementPanel protocol: haemorrhoids (from ICD)
- note: PlanTab protocol: haemorrhoids (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| inv-colonic-evaluation | investigationInclude | critical | PASS | ASCRS clinical practice guidelines 2024; NICE NG12 2023 |  |
| dx-haemorrhoids-top3 | mustRankTopK | quality | PASS | ASCRS clinical practice guidelines 2024 |  |
| mnm-crc | mustNotMiss | quality | FAIL (known gap) | NICE NG12 2023 |  |
| mgmt-grade3-treatment | managementInclude | quality | PASS | ASCRS clinical practice guidelines 2024 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Haemorrhoids; 2. Inguinal / Femoral Hernia; 3. Anal Fissure
...
- differential web.triageSurgical: 1. Unexplained weight loss / GI alarm symptoms — endoscopy workup; 2. Haemorrhoids (internal/external)
- emergency level: emergency (acuity=urgent, action=emergency_now, score=90)
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Perianal Abscess / Fistula; 2. Inguinal / Femoral Hernia; 3. Haemorrhoids
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| inv-stool-culture | investigationInclude | critical | FAIL (known gap) | IDSA clinical practice guidelines 2017 | Add an infective-colitis rule (bloody diarrhoea ± fever): stool culture incl. STEC/Shiga toxin, C. difficile if antibiotics/healthcare exposure; avoid antimotility agents and empirical antibiotics until STEC excluded (IDSA 2017). |
| mgmt-no-appendicectomy | managementExclude | critical | FAIL (known gap) | IDSA clinical practice guidelines 2017 | Gate the appendicectomy operative-plan prompt on the confirmed working diagnosis (appendicitis) or imaging, not on the words "guarding"/"rebound"; add negation handling (no/without/absent) to exam() matching. |
| mgmt-no-antimotility | managementExclude | critical | PASS | IDSA clinical practice guidelines 2017 |  |
| dx-infective-top3 | mustRankTopK | quality | FAIL (known gap) | IDSA clinical practice guidelines 2017 |  |
| mnm-ibd | mustNotMiss | quality | FAIL (known gap) | IDSA clinical practice guidelines 2017 |  |
| mgmt-no-empirical-antibiotics-stec | managementExclude | quality | FAIL (known gap) | IDSA clinical practice guidelines 2017 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Acute Appendicitis; 2. Acute Cholecystitis; 3. Acute Cholangitis
- differential web.symptomInference: 1. Acute gastroenteritis; 2. Lower GI bleed / colorectal; 3. Acute mesenteric ischaemia; 4. Acute appendicitis (paediatric); 5. Inflammatory bowel disease (Crohn's / UC)
...
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Appendicitis — emergency surgical indication [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; Fever 38.4°C + HR 102 bpm [web.clinicalPrompts.safety]
- recommended scores: alvarado, tg18-cholangitis, ranson, qsofa, news2, rockall
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: nausea_vomiting, fever, pr_bleeding
- note: AssessmentTab ManagementPanel protocol: appendicitis (from PANE top)
- note: PlanTab protocol: (none) (from ICD)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| dx-ischaemic-colitis-top3 | mustRankTopK | critical | PASS | ACG clinical guideline 2015 |  |
| level-admit | emergencyLevel | critical | PASS | ACG clinical guideline 2015 |  |
| mgmt-no-appendicectomy | managementExclude | critical | FAIL (known gap) | ACG clinical guideline 2015 | Gate the appendicectomy operative-plan prompt on the confirmed working diagnosis (appendicitis) or imaging, not on the words "guarding"/"rebound"; add negation handling (no/without/absent) to exam() matching. |
| inv-ct-contrast | investigationInclude | quality | PASS | ACG clinical guideline 2015 |  |
| inv-colonoscopy-48h | investigationInclude | quality | PASS | ACG clinical guideline 2015 |  |
| inv-stool-culture | investigationInclude | quality | PASS | ACG clinical guideline 2015 |  |
| mgmt-no-therapeutic-heparin | managementExclude | quality | PASS | ACG clinical guideline 2015 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Ulcerative Colitis; 2. Ischaemic Colitis; 3. Colorectal Cancer
- differential web.symptomInference: 1. Lower GI bleed / colorectal; 2. Colorectal carcinoma; 3. Inflammatory bowel disease (Crohn's / UC); 4. Diverticulitis; 5. Acute mesenteric ischaemia
...
- differential web.triageSurgical: (empty)
- emergency level: emergency (acuity=urgent, action=emergency_now, score=124)
- alarms: Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; GI haemorrhage [web.clinicalPrompts.safety]; Pneumoperitoneum on imaging [web.clinicalPrompts.safety]; Appendicitis — emergency surgical indication [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]
- recommended scores: alvarado, ranson, web:wagner, news2, rockall, caprini, asa, rcri, cfs
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: lif_pain, pr_bleeding, change_bowel_habit
- note: AssessmentTab ManagementPanel protocol: ischaemic_colitis (from ICD)
- note: PlanTab protocol: ischaemic_colitis (from ICD)
- note: matchPathways: Anorectal (Haemorrhoids / Fissure / Fistula / Abscess) (5), Colonoscopy Diagnostic (Rectal Bleeding / Bowel Habit Change / Iron Deficiency) (5), GI Bleeding (Upper and Lower) (5)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mnm-ami | mustNotMiss | critical | FAIL (known gap) | ACG clinical guideline 2015; ESVS clinical practice guidelines 2017 | Add acute mesenteric ischaemia to PANE (AF/embolic source, pain out of proportion, lactate) and a CTA-first protocol (ESVS 2017). |
| level-emergency | emergencyLevel | critical | PASS | ESVS clinical practice guidelines 2017 |  |
| inv-cta | investigationInclude | critical | FAIL (known gap) | ACG clinical guideline 2015; ESVS clinical practice guidelines 2017 | In the ischaemic colitis protocol add: isolated right colon ischaemia, AF or lactate rise → CT angiography to exclude AMI (ACG 2015). |
| mgmt-vascular | managementInclude | quality | PASS | ESVS clinical practice guidelines 2017 |  |
...
- differential web.symptomInference: 1. Acute mesenteric ischaemia; 2. Intussusception; 3. Lower GI bleed / colorectal; 4. Acute appendicitis; 5. Meckel's diverticulum
...
- differential web.triageSurgical: (empty)
- emergency level: emergency (acuity=urgent, action=emergency_now, score=124)
- alarms: Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; GI haemorrhage [web.clinicalPrompts.safety]; Pneumoperitoneum on imaging [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; WBC 19.6 × 10⁹/L — leucocytosis [web.clinicalPrompts.safety]; Creatinine 132 μmol/L — elevated [web.clinicalPrompts.safety]; HR 112 bpm — unexplained tachycardia [web.clinicalPrompts.safety]
- recommended scores: alvarado, ranson, cha2ds2-vasc, qsofa, news2, rockall, has-bled, rcri, cfs, web:gad7
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: rlq_pain, nausea_vomiting, pr_bleeding
- note: AssessmentTab ManagementPanel protocol: ischaemic_colitis (from ICD)
- note: PlanTab protocol: ischaemic_colitis (from ICD)
...
| mnm-angiodysplasia | mustNotMiss | quality | FAIL (known gap) | BSG guideline 2019 |  |
| inv-iron-studies | investigationInclude | quality | FAIL (known gap) | BSG guideline 2021 |  |
| mgmt-iron | managementInclude | quality | FAIL (known gap) | BSG guideline 2021 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Haemorrhoids; 2. Acute Cholecystitis; 3. Colorectal Cancer
- differential web.symptomInference: 1. Lower GI bleed / colorectal; 2. Colorectal carcinoma; 3. Heart failure; 4. Anaemia; 5. Meckel's diverticulum
...
- differential web.triageSurgical: 1. Change in bowel habit / lower GI bleed — investigation; 2. Unexplained weight loss / GI alarm symptoms — endoscopy workup
- emergency level: emergency (acuity=urgent, action=emergency_now, score=151)
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; Creatinine 132 μmol/L — elevated [web.clinicalPrompts.safety]
- recommended scores: news2, rockall, rcri, stop-bang, cfs, ecog, web:phq9
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: pr_bleeding
- note: AssessmentTab ManagementPanel protocol: ischaemic_colitis (from ICD)
- note: PlanTab protocol: ischaemic_colitis (from ICD)
- note: matchPathways: Colonoscopy Diagnostic (Rectal Bleeding / Bowel Habit Change / Iron Deficiency) (29), IBD — Surgical Complications (Crohn's / UC) (14), Cancer Screening (Age/Sex Appropriate) (7)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| level-admit | emergencyLevel | critical | PASS | BSG guideline 2019 |  |
| flag-doac | redFlags | critical | PASS | BSG guideline 2019 |  |
| mgmt-hold-doac | managementInclude | critical | FAIL (known gap) | BSG guideline 2019 | In the GI-bleed prompt, add "interrupt DOAC/warfarin at presentation; reversal agent only for life-threatening bleeding" when an anticoagulant is recorded. |
| mnm-crc | mustNotMiss | quality | PASS | BSG guideline 2019 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Inguinal / Femoral Hernia; 2. Haemorrhoids; 3. Colorectal Cancer
- differential web.symptomInference: 1. Lower GI bleed / colorectal; 2. Colorectal carcinoma; 3. Haemorrhoids / anorectal disease; 4. Squamous cell carcinoma of the anus; 5. Meckel's diverticulum
- differential web.passive: 1. Lower GI bleed / colorectal; 2. Haemorrhoids / anorectal disease; 3. Meckel's diverticulum; 4. Intussusception; 5. Colorectal carcinoma
...
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; Anticoagulation therapy [web.clinicalPrompts.safety]
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| dx-haemorrhoids-top3 | mustRankTopK | quality | PASS | BSG guideline 2019 |  |
| level-not-emergency | emergencyLevel | quality | FAIL (known gap) | BSG guideline 2019; Oakland score 2017 | Grade rectal bleeding by volume/haemodynamics (and an Oakland score when Hb and DRE are recorded) instead of the word "bleed". |
| score-rec-oakland | scoreRecommended | quality | FAIL (known gap) | Oakland score 2017; BSG guideline 2019 | Add the Oakland score (age, sex, previous LGIB admission, DRE blood, HR, SBP, Hb) to clinical-scales and a CDS rule for rectal bleeding; ≤ 8 → discharge with outpatient investigation (BSG 2019). |
| inv-no-cta | investigationExclude | quality | PASS | BSG guideline 2019 |  |
| mgmt-discharge-outpatient | managementInclude | quality | PASS | BSG guideline 2019 |  |
| mgmt-no-transfusion | managementExclude | quality | FAIL (known gap) | BSG guideline 2019 | Condition the resuscitation/cross-match actions on instability (shock index > 1, SBP < 90, Hb < 80 g/L) or a large-volume bleed. |
...
| mgmt-antiplatelet-plan | managementInclude | quality | FAIL (known gap) | BSG guideline 2019 |  |
...
- emergency level: emergency (acuity=urgent, action=emergency_now, score=186)
- alarms: Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; GI haemorrhage [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]
...
| mgmt-embolisation | managementInclude | quality | PASS | BSG guideline 2019 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Inguinal / Femoral Hernia; 2. Haemorrhoids; 3. Colorectal Cancer
- differential web.symptomInference: 1. Lower GI bleed / colorectal; 2. Colorectal carcinoma; 3. Haemorrhoids / anorectal disease; 4. Vasovagal / reflex syncope; 5. Squamous cell carcinoma of the anus
...
- differential web.triageSurgical: 1. Peptic ulcer with haemorrhage; 2. Diverticulitis of colon
- emergency level: emergency (acuity=urgent, action=emergency_now, score=192)
- alarms: Hypotension [web.triage.vitalRedFlags]; Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; GI haemorrhage [web.clinicalPrompts.safety]; SBP 88 mmHg — hypotension [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; HR 118 bpm — unexplained tachycardia [web.clinicalPrompts.safety]
...
| inv-cta-first | investigationInclude | critical | FAIL (known gap) | BSG guideline 2019 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Haemorrhoids; 2. Colorectal Cancer; 3. Acute Cholecystitis
...
- alarms: Hypotension [web.triage.vitalRedFlags]; Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; INR 4.6 — coagulopathy [web.clinicalPrompts.safety]; SBP 86 mmHg — hypotension [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; Anticoagulation therapy [web.clinicalPrompts.safety]; Haemoglobin 7.9 g/dL — severe anaemia [web.clinicalPrompts.safety]; HR 112 bpm — unexplained tachycardia [web.clinicalPrompts.safety]
...
| level-same-day | emergencyLevel | critical | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-drainage | managementInclude | critical | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-antibiotics | managementInclude | critical | PASS | ASCRS clinical practice guidelines 2022 |  |
| mnm-nsti | mustNotMiss | quality | FAIL (known gap) | WSES/SIS-E consensus 2018 |  |
| flag-diabetes | redFlags | quality | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-glycaemic | managementInclude | quality | PASS | ASCRS clinical practice guidelines 2022 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Perianal Abscess / Fistula; 2. Inguinal / Femoral Hernia; 3. Pilonidal Disease
...
|---|---|---|---|---|---|
| dx-abscess-top3 | mustRankTopK | critical | PASS | ASCRS clinical practice guidelines 2022 |  |
| level-same-day | emergencyLevel | critical | FAIL (known gap) | ASCRS clinical practice guidelines 2022 | Add an anorectal-sepsis triage rule (perianal/perineal pain + swelling/lump, or "abscess") → at least same_day_call, and emergency_now with fever + SIRS, diabetes, immunosuppression or spreading erythema. |
| flag-hiv | redFlags | critical | FAIL (known gap) | ASCRS clinical practice guidelines 2022 | Surface HIV/low CD4/biologics/chemotherapy as an immunosuppression flag (triage comorbidity regex + a clinical prompt). |
| mgmt-drainage | managementInclude | critical | PASS | ASCRS clinical practice guidelines 2022 |  |
| mgmt-antibiotics | managementInclude | critical | PASS | ASCRS clinical practice guidelines 2022 |  |
| mnm-anal-neoplasia | mustNotMiss | quality | FAIL (known gap) | ASCRS clinical practice guidelines 2018 |  |
| inv-pus-culture | investigationInclude | quality | PASS | ASCRS clinical practice guidelines 2022 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Perianal Abscess / Fistula; 2. Pilonidal Disease; 3. Inguinal / Femoral Hernia
...
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain
- note: AssessmentTab ManagementPanel protocol: perianal_abscess (from ICD)
- note: PlanTab protocol: perianal_abscess (from ICD)
- note: matchPathways: Anorectal (Haemorrhoids / Fissure / Fistula / Abscess) (5)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mgmt-drainage | managementInclude | critical | PASS | ASCRS clinical practice guidelines 2019 |  |
| dx-pilonidal-top3 | mustRankTopK | quality | FAIL (known gap) | ASCRS clinical practice guidelines 2019 |  |
| level-soon | emergencyLevel | quality | FAIL (known gap) | ASCRS clinical practice guidelines 2019 | Add an anorectal-sepsis triage rule (perianal/perineal pain + swelling/lump, or "abscess") → at least same_day_call, and emergency_now with fever + SIRS, diabetes, immunosuppression or spreading erythema. |
| mgmt-no-acute-excision | managementExclude | quality | PASS | ASCRS clinical practice guidelines 2019 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Skin Abscess / Furuncle; 2. Inguinal / Femoral Hernia; 3. Acute Appendicitis
...
- dx variant: (none) (no group)
- note: PANE features applied: (none)
- note: AssessmentTab ManagementPanel protocol: pilonidal_disease (from ICD)
- note: PlanTab protocol: pilonidal_disease (from ICD)
- note: matchPathways: Anorectal (Haemorrhoids / Fissure / Fistula / Abscess) (5)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mgmt-3-year-surveillance | managementInclude | quality | PASS | BSG/ACPGBI/PHE post-polypectomy and post-colorectal cancer resection surveillance guidelines 2020 |  |
| mgmt-no-annual-colonoscopy | managementExclude | quality | PASS | BSG/ACPGBI/PHE post-polypectomy and post-colorectal cancer resection surveillance guidelines 2020 |  |
...
|---|---|---|---|---|---|
| dx-haemorrhoids-top3 | mustRankTopK | quality | PASS | ASCRS clinical practice guidelines 2024 |  |
| level-routine-or-priority | emergencyLevel | quality | FAIL (known gap) | NICE NG12 2023 |  |
| mgmt-fibre | managementInclude | quality | PASS | ASCRS clinical practice guidelines 2024 |  |
| mgmt-no-resuscitation | managementExclude | quality | FAIL (known gap) | BSG guideline 2019 |  |
| mgmt-no-2ww | managementExclude | quality | PASS | NICE NG12 2023 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Haemorrhoids; 2. Acute Cholecystitis; 3. Acute Appendicitis
- differential web.symptomInference: 1. Lower GI bleed / colorectal; 2. Anal fissure; 3. Haemorrhoids / anorectal disease; 4. Large bowel obstruction; 5. Rectal prolapse
- differential web.passive: 1. Lower GI bleed / colorectal; 2. Anal fissure; 3. Haemorrhoids / anorectal disease; 4. Large bowel obstruction; 5. Hirschsprung's disease
- differential web.triageSurgical: 1. Colon cancer; 2. Change in bowel habit / lower GI bleed — investigation; 3. Unexplained weight loss / GI alarm symptoms — endoscopy workup
- emergency level: emergency (acuity=urgent, action=emergency_now, score=115)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| level-emergency | emergencyLevel | critical | PASS | ASCRS clinical practice guidelines 2017 |  |
| flag-strangulation | redFlags | critical | PASS | ASCRS clinical practice guidelines 2017 |  |
| mgmt-emergency-perineal | managementInclude | critical | PASS | ASCRS clinical practice guidelines 2017 |  |
| dx-prolapse-top3 | mustRankTopK | quality | FAIL (known gap) | ASCRS clinical practice guidelines 2017 |  |
...
- emergency level: emergency (acuity=urgent, action=emergency_now, score=109)
- alarms: Emergency now [web.triage.emergency]; GI haemorrhage [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]
- recommended scores: news2, rockall, asa, rcri, cfs
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: anal_pain, pr_bleeding
- note: AssessmentTab ManagementPanel protocol: rectal_prolapse (from ICD)
- note: PlanTab protocol: rectal_prolapse (from ICD)
- note: matchPathways: Anorectal (Haemorrhoids / Fissure / Fistula / Abscess) (10), Colonoscopy Diagnostic (Rectal Bleeding / Bowel Habit Change / Iron Deficiency) (5), GI Bleeding (Upper and Lower) (5)
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| level-admit | emergencyLevel | critical | PASS | BSG consensus guidelines 2019 |  |
| inv-cdiff | investigationInclude | critical | PASS | BSG consensus guidelines 2019; ECCO guidelines 2021 |  |
| mgmt-iv-steroids | managementInclude | critical | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022; BSG consensus guidelines 2019 |  |
| mgmt-vte-prophylaxis | managementInclude | critical | PASS | BSG consensus guidelines 2019 |  |
| mgmt-no-appendicectomy | managementExclude | critical | FAIL (known gap) | BSG consensus guidelines 2019 | Gate the appendicectomy operative-plan prompt on the confirmed working diagnosis (appendicitis) or imaging, not on the words "guarding"/"rebound"; add negation handling (no/without/absent) to exam() matching. |
| mgmt-no-antimotility | managementExclude | critical | PASS | BSG consensus guidelines 2019 |  |
| dx-uc-top3 | mustRankTopK | quality | PASS | ECCO guidelines on therapeutics in ulcerative colitis 2022 |  |
| mnm-infective | mustNotMiss | quality | FAIL (known gap) | BSG consensus guidelines 2019 |  |
| score-rec-truelove-witts | scoreRecommended | quality | FAIL (known gap) | BSG consensus guidelines 2019 | Add Truelove and Witts (≥ 6 bloody stools + HR > 90, T > 37.8, Hb < 10.5 g/dL, ESR > 30) and the Oxford day-3 rule (> 8 stools, or 3–8 with CRP > 45) to clinical-scales with a CDS trigger on UC. |
| inv-stool-culture | investigationInclude | quality | PASS | BSG consensus guidelines 2019 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Ulcerative Colitis; 2. Acute Cholecystitis; 3. Acute Appendicitis
- differential web.symptomInference: 1. Lower GI bleed / colorectal; 2. Irritable bowel syndrome (IBS); 3. Inflammatory bowel disease (Crohn's / UC); 4. Acute gastroenteritis; 5. Acute mesenteric ischaemia
...
- alarms: Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; Reproductive-age female with abdominal complaint [web.clinicalPrompts.safety]; GI haemorrhage [web.clinicalPrompts.safety]; Pneumoperitoneum on imaging [web.clinicalPrompts.safety]; Appendicitis — emergency surgical indication [web.clinicalPrompts.safety]; Bowel obstruction — clinical or imaging evidence [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; Albumin 29 g/L — hypoalbuminaemia [web.clinicalPrompts.safety]
- recommended scores: alvarado, tg18-cholangitis, ranson, qsofa, news2, rockall
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: fever, pr_bleeding, change_bowel_habit, nocturnal_pain
- note: AssessmentTab ManagementPanel protocol: ulcerative_colitis (from PANE top)
- note: PlanTab protocol: ulcerative_colitis (from ICD)
- note: matchPathways: Anorectal (Haemorrhoids / Fissure / Fistula / Abscess) (12), IBD — Surgical Complications (Crohn's / UC) (12), Acute Abdomen (7)
...
- differential web.triageSurgical: (empty)
- emergency level: emergency (acuity=urgent, action=emergency_now, score=110)
- alarms: Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; Reproductive-age female with abdominal complaint [web.clinicalPrompts.safety]; GI haemorrhage [web.clinicalPrompts.safety]; Pneumoperitoneum on imaging [web.clinicalPrompts.safety]; Appendicitis — emergency surgical indication [web.clinicalPrompts.safety]; Bowel obstruction — clinical or imaging evidence [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; Anticoagulation therapy [web.clinicalPrompts.safety]; Albumin 26 g/L — hypoalbuminaemia [web.clinicalPrompts.safety]
- recommended scores: alvarado, tg18-cholangitis, ranson, qsofa, news2, rockall
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: fever, pr_bleeding, change_bowel_habit, nocturnal_pain
...
| Expectation | Kind | Severity | web | Guideline | Proposed fix |
|---|---|---|---|---|---|
| mnm-cdiff | mustNotMiss | critical | FAIL (known gap) | ECCO guidelines 2021; IDSA/SHEA focused update 2021 | Add a C. difficile disease/protocol (triggers: recent antibiotics, hospital/care-home exposure, toxin-positive result): oral vancomycin or fidaxomicin; fulminant: oral/rectal vancomycin + IV metronidazole, surgical consultation (IDSA/SHEA 2017/2021, WSES 2019). Read a toxin-positive lab result. |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Acute Cholecystitis; 2. Haemorrhoids; 3. Acute Appendicitis
...
- differential web.triageSurgical: (empty)
- emergency level: emergency (acuity=urgent, action=emergency_now, score=90)
- alarms: Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; Reproductive-age female with abdominal complaint [web.clinicalPrompts.safety]; GI haemorrhage [web.clinicalPrompts.safety]; Bowel obstruction — clinical or imaging evidence [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Rectal bleeding, age ≥ 50 [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; WBC 15.9 × 10⁹/L — leucocytosis [web.clinicalPrompts.safety]
- recommended scores: alvarado, tg18-cholangitis, ranson, qsofa, news2, rockall
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: fever, pr_bleeding
- note: AssessmentTab ManagementPanel protocol: (none) (from ICD)
- note: PlanTab protocol: (none) (from ICD)
- note: matchPathways: Anorectal (Haemorrhoids / Fissure / Fistula / Abscess) (5), Colonoscopy Diagnostic (Rectal Bleeding / Bowel Habit Change / Iron Deficiency) (5), GI Bleeding (Upper and Lower) (5)
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Acute Cholecystitis; 2. Acute Appendicitis; 3. Haemorrhoids
...
- dx variant: (none) (no group)
- note: PANE features applied: fever, pr_bleeding
- note: AssessmentTab ManagementPanel protocol: ulcerative_colitis (from ICD)
- note: PlanTab protocol: ulcerative_colitis (from ICD)
- note: matchPathways: Anorectal (Haemorrhoids / Fissure / Fistula / Abscess) (5), Colonoscopy Diagnostic (Rectal Bleeding / Bowel Habit Change / Iron Deficiency) (5), Diverticular Disease / Diverticulitis (5)
...
| mgmt-no-antimotility | managementExclude | critical | PASS | BSG consensus guidelines 2019 |  |
| mnm-perforation | mustNotMiss | quality | FAIL (known gap) | ECCO guidelines on therapeutics in ulcerative colitis 2022 |  |
...
- engine: paneEngine=pane-engine (130 diseases, 135 features); triageRulesVersion=1.2.0
- differential web.pane: 1. Acute Appendicitis; 2. Acute Cholangitis; 3. Acute Cholecystitis
- differential web.symptomInference: 1. Inflammatory bowel disease (Crohn's / UC); 2. Schistosomiasis (S. mansoni); 3. Acute gastroenteritis; 4. Acute mesenteric ischaemia; 5. Typhoid fever
...
- alarms: Tachycardia [web.triage.vitalRedFlags]; Emergency now [web.triage.emergency]; Generalised peritonism (guarding / rigidity) [web.clinicalPrompts.safety]; GI haemorrhage [web.clinicalPrompts.safety]; Pneumoperitoneum on imaging [web.clinicalPrompts.safety]; Appendicitis — emergency surgical indication [web.clinicalPrompts.safety]; Bowel obstruction — clinical or imaging evidence [web.clinicalPrompts.safety]; Acute abdominal presentation [web.clinicalPrompts.safety]; Pre-operative assessment [web.clinicalPrompts.safety]; WBC 18.4 × 10⁹/L — leucocytosis [web.clinicalPrompts.safety]; Dilated common bile duct on imaging [web.clinicalPrompts.safety]; Fever 38.9°C + HR 126 bpm [web.clinicalPrompts.safety]; Albumin 22 g/L — hypoalbuminaemia [web.clinicalPrompts.safety]
- recommended scores: alvarado, tg18-cholangitis, ranson, qsofa, news2, rockall
- score values: (none)
- dx variant: (none) (no group)
- note: PANE features applied: fever, pr_bleeding, rigors
- note: AssessmentTab ManagementPanel protocol: ulcerative_colitis (from ICD)
- note: PlanTab protocol: ulcerative_colitis (from ICD)
